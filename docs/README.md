...
| [wp18-stage0-retirement.md](wp18-stage0-retirement.md) | The plan for the day stage0 is deleted rather than frozen: how rustc, Go, GCC and Zig each answered "what compiles the compiler", the four things stage0 still owns, the six gates that must close first, the builtins they need, and what the retirement costs. |
