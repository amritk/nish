...
| [BENCHMARKS.md](BENCHMARKS.md) | Generated by `node bench/run.mjs`: wall time, binary size, and peak memory of six programs in StaticTS, C, and Rust, with checksums and the exact build commands. The programs and rules are in [bench/README.md](../bench/README.md). |
