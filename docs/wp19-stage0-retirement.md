...
- Installing the package keeps working: it becomes a thin installer that
  ...
  which answer, only on there being one, so what is left of this bullet is the
  installer itself — work, not a decision.
...
2. **The package becoming a thin installer** (G5's last bullet, R4). The
   registry name it waited on was answered on 2026-09-19 — `@amritk/nish`,
...
becoming a thin installer, which is now in the list above.
