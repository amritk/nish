...
Prints the C to stdout; paste it over the `AMRIT_POW5_INV_SPLIT` and
`AMRIT_POW5_SPLIT` definitions. The point of having this in the tree is that
...
print(emit("AMRIT_POW5_INV_SPLIT", inv))
print()
print(emit("AMRIT_POW5_SPLIT", spl))
