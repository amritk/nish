 ...
 *
 * Kept by hand since R6: a new rule takes its band's next free code, which `node scripts/gen-diagnostic-codes.mjs`
 * prints, in longest-fragment-first order; its `--check` (run by `npm test`) validates bands, order and uniqueness.
 *
...
export const diagnosticRules = (): string[] => [
  ...
  "NL2369",
  "` is a function parameter and can only be called or passed on as a function argument: a function is never a value in ",
  "NL2334",
  ...
  "NL2165",
  "`: a `Map` has size, get, set, has, delete and clear, and a `Set` has size, add, has, delete and clear",
  "NL2359",
  ...
  "NL2320",
  "` must be the name of a top-level function or an arrow written at the call, because `",
  "NL2339",
  ...
  "NL2150",
  "The right operand of `??` stands in for a missing value, so it must be `",
  "NL2370",
  ...
  "NL2005",
  "` is generic, so it names no one function to pass as argument ",
  "NL2341",
  ...
  "NL2275",
  "`; a function argument must have exactly its parameter's type",
  "NL2340",
