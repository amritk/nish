...
export const cResultWord = (table: TypeTable, t: i32): string => {
...
export const cParamName = (name: string): string => {
...
export const spaceAfter = (type: string): string => {
