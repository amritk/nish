...
declare noundef double @square(double noundef) #1
...
entry:
  ...
  call void @nish.mapRange$f64$f64$fn.6.square(%struct.nish_array* %2, %struct.nish_array* %4, i32 %5, i32 %6)
  ret void
}

define void @nish.parallelMapInto$f64$f64$fn.6.square(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) %src, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) %dst) #0 {
entry:
...
define internal void @nish.parallelMapInto$i32$f64$fn.16.nish_main$arrow0$chunk(i64 noundef %lo, i64 noundef %hi, i8* noundef %ctx) #0 {
entry:
  %0 = bitcast i8* %ctx to { %struct.nish_array*, %struct.nish_array* }*
  %1 = getelementptr inbounds { %struct.nish_array*, %struct.nish_array* }, { %struct.nish_array*, %struct.nish_array* }* %0, i32 0, i32 0
  %2 = load %struct.nish_array*, %struct.nish_array** %1
  ...
  %5 = trunc i64 %lo to i32
  %6 = trunc i64 %hi to i32
  call void @nish.mapRange$i32$f64$fn.16.nish_main$arrow0(%struct.nish_array* %2, %struct.nish_array* %4, i32 %5, i32 %6)
  ret void
}

define void @nish.parallelMapInto$i32$f64$fn.16.nish_main$arrow0(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) %src, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) %dst) #0 {
entry:
  %n.addr = alloca i32, align 4
  %par.ctx = alloca { %struct.nish_array*, %struct.nish_array* }, align 8
  %0 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %src, i64 0, i32 0
...
define internal void @nish.parallelMapInto$f64$f64$fn.16.nish_main$arrow1$chunk(i64 noundef %lo, i64 noundef %hi, i8* noundef %ctx) #0 {
entry:
  %0 = bitcast i8* %ctx to { %struct.nish_array*, %struct.nish_array* }*
  %1 = getelementptr inbounds { %struct.nish_array*, %struct.nish_array* }, { %struct.nish_array*, %struct.nish_array* }* %0, i32 0, i32 0
  %2 = load %struct.nish_array*, %struct.nish_array** %1
  ...
  %5 = trunc i64 %lo to i32
  %6 = trunc i64 %hi to i32
  call void @nish.mapRange$f64$f64$fn.16.nish_main$arrow1(%struct.nish_array* %2, %struct.nish_array* %4, i32 %5, i32 %6)
  ret void
}

define void @nish.parallelMapInto$f64$f64$fn.16.nish_main$arrow1(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) %src, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) %dst) #0 {
entry:
  %n.addr = alloca i32, align 4
  %par.ctx = alloca { %struct.nish_array*, %struct.nish_array* }, align 8
  %0 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %src, i64 0, i32 0
...
define internal void @nish.mapRange$f64$f64$fn.6.square(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %src, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %dst, i32 noundef %lo, i32 noundef %hi) #0 {
entry:
...
for.body:
  ...
  %19 = bitcast i8* %3 to double*
  %20 = getelementptr inbounds double, double* %19, i64 %18
  %21 = load double, double* %20, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %22 = call double @square(double %21)
  store double %22, double* %y.addr, align 8
...
if.then:
  ...
  %29 = bitcast i8* %7 to double*
  %30 = getelementptr inbounds double, double* %29, i64 %27
  store double %28, double* %30, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  br label %if.end
...
define internal void @nish.mapRange$i32$f64$fn.16.nish_main$arrow0(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %src, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %dst, i32 noundef %lo, i32 noundef %hi) #0 {
entry:
  %i.addr = alloca i32, align 4
  %y.addr = alloca double, align 8
  store i32 %lo, i32* %i.addr, align 4
...
for.body:
  ...
  %21 = load i32, i32* %20, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  %22 = call double @nish_main$arrow0(i32 %21)
  store double %22, double* %y.addr, align 8
  %23 = load i32, i32* %i.addr, align 4
  %24 = trunc i64 %5 to i32
  %25 = icmp slt i32 %23, %24
...
define internal void @nish.mapRange$f64$f64$fn.16.nish_main$arrow1(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %src, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %dst, i32 noundef %lo, i32 noundef %hi) #0 {
entry:
  %i.addr = alloca i32, align 4
  %y.addr = alloca double, align 8
  store i32 %lo, i32* %i.addr, align 4
...
for.body:
  ...
  %20 = getelementptr inbounds double, double* %19, i64 %18
  %21 = load double, double* %20, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %22 = call double @nish_main$arrow1(double %21)
  store double %22, double* %y.addr, align 8
  %23 = load i32, i32* %i.addr, align 4
  %24 = trunc i64 %5 to i32
  %25 = icmp slt i32 %23, %24
