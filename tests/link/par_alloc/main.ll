...
for.end:
  ...
  call void @nish.parallelMapInto$i32$i32$fn.5.label(%struct.nish_array* %33, %struct.nish_array* %34)
...
bounds.ok:
  ...
  %63 = call i8* @nish_str_concat(i8* %62, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
...
bounds.ok.1:
  ...
  %75 = call i8* @nish_str_concat(i8* %74, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  ...
  %79 = icmp ult i64 999999, %78
  br i1 %79, label %bounds.ok.2, label %bounds.fail.2

bounds.fail.2:
  call void @nish_panic_index(i64 999999, i64 %78)
  unreachable
...
bounds.ok.2:
  ...
  %83 = getelementptr inbounds i32, i32* %82, i64 999999
