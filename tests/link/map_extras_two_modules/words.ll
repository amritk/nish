...
define void @countInto(%struct.Map$str$i32* noundef nonnull align 8 dereferenceable(56) %counts, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %words) #0 {
entry:
  %w.addr = alloca i8*, align 8
  %forof.idx = alloca i64, align 8
  %0 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 0
  %1 = load i64, i64* %0, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %2 = trunc i64 %1 to i32
  call void @nish.Map$str$i32.reserveSlots(%struct.Map$str$i32* %counts, i32 %2)
  store i64 0, i64* %forof.idx, align 8
  br label %forof.cond

forof.cond:
  %3 = load i64, i64* %forof.idx, align 8
  %4 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 0
  %5 = load i64, i64* %4, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %6 = icmp ult i64 %3, %5
  br i1 %6, label %forof.body, label %forof.end

forof.body:
  %7 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 2
  %8 = load i8*, i8** %7, align 8, !alias.scope !3, !noalias !4, !tbaa !11
  %9 = bitcast i8* %8 to i8**
  %10 = getelementptr inbounds i8*, i8** %9, i64 %3
  %11 = load i8*, i8** %10, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  store i8* %11, i8** %w.addr, align 8
  %12 = load i8*, i8** %w.addr, align 8
  %13 = call i64 @nish.Map$str$i32.probe(%struct.Map$str$i32* %counts, i8* %12)
  %14 = icmp sge i64 %13, 0
  br i1 %14, label %nullish.value, label %nullish.default

nullish.value:
  %15 = trunc i64 %13 to i32
  %16 = call i32 @nish.Map$str$i32.valueAt(%struct.Map$str$i32* %counts, i32 %15)
...
nullish.end:
  %17 = phi i32 [ %16, %nullish.value ], [ 0, %nullish.default ]
  %18 = add nsw i32 %17, 1
  br i1 %14, label %set.found, label %set.insert

set.found:
  %19 = trunc i64 %13 to i32
  call void @nish.Map$str$i32.setValueAt(%struct.Map$str$i32* %counts, i32 %19, i32 %18)
  br label %set.end

set.insert:
  call void @nish.Map$str$i32.insertAt(%struct.Map$str$i32* %counts, i64 %13, i8* %12, i32 %18)
  br label %set.end
...
while.body:
  ...
  %16 = load i32, i32* %15, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  %17 = icmp eq i32 %16, 0
...
if.then:
  ...
  store i32 %20, i32* %22, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  ret void
...
for.body:
  ...
  %12 = load i32, i32* %11, align 4, !alias.scope !4, !noalias !3, !tbaa !15
...
if.then:
  ...
  store i32 %24, i32* %26, align 4, !alias.scope !4, !noalias !3, !tbaa !15
...
pop.ok:
  ...
  %44 = load i32, i32* %43, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  br label %while.cond
...
for.body:
  ...
  %15 = load i32, i32* %14, align 4, !alias.scope !4, !noalias !3, !tbaa !15
...
for.body:
  ...
  store i32 0, i32* %10, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  br label %for.inc
...
if.then:
  ...
  store i32 %8, i32* %12, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  br label %if.end
...
entry:
  ...
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !22
...
bounds.ok:
  ...
  %18 = load i32, i32* %17, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  ret i32 %18
}
...
if.then:
  ...
  store i32 %value, i32* %14, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  br label %if.end
...
if.end:
  ...
  %26 = load i64, i64* %25, align 8, !alias.scope !3, !noalias !4, !tbaa !16
...
push.store:
  ...
  store i8* %key, i8** %31, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %32 = add i64 %24, 1
  ...
  %39 = load i64, i64* %38, align 8, !alias.scope !3, !noalias !4, !tbaa !16
...
push.store.1:
  ...
  store i32 %value, i32* %44, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  %45 = add i64 %37, 1
  ...
  %48 = load %struct.nish_array*, %struct.nish_array** %47, align 8, !tbaa !22
  ...
  %53 = load i64, i64* %52, align 8, !alias.scope !3, !noalias !4, !tbaa !16
...
push.store.2:
  ...
  store i32 %49, i32* %58, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  %59 = add i64 %51, 1
  ...
  %77 = load %struct.nish_array*, %struct.nish_array** %76, align 8, !tbaa !20
...
if.else:
  ...
  %84 = load %struct.nish_array*, %struct.nish_array** %83, align 8, !tbaa !20
...
entry:
  ...
  %9 = load %struct.nish_array*, %struct.nish_array** %8, align 8, !tbaa !20
...
if.then:
  ...
  %27 = load %struct.nish_array*, %struct.nish_array** %26, align 8, !tbaa !22
  ...
  %31 = load %struct.nish_array*, %struct.nish_array** %30, align 8, !tbaa !22
...
if.end:
  ...
  store %struct.nish_array* %34, %struct.nish_array** %35, align 8, !tbaa !20
  ...
  %44 = load %struct.nish_array*, %struct.nish_array** %43, align 8, !tbaa !22
...
while.body:
  ...
  %41 = load i32, i32* %40, align 4, !alias.scope !4, !noalias !3, !tbaa !15
...
land.rhs.3:
  ...
  %64 = load i32, i32* %63, align 4, !alias.scope !4, !noalias !3, !tbaa !15
...
land.rhs.1:
  ...
  %76 = load i8*, i8** %75, align 8, !alias.scope !4, !noalias !3, !tbaa !13
...
if.then:
  ...
  %41 = load i8*, i8** %40, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %42 = bitcast i8* %10 to i8**
  %43 = getelementptr inbounds i8*, i8** %42, i64 %36
  store i8* %41, i8** %43, align 8, !alias.scope !4, !noalias !3, !tbaa !13
...
if.then:
  ...
  store i32 %41, i32* %43, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  %44 = load i32, i32* %to.addr, align 4
  %45 = add nsw i32 %44, 1
  store i32 %45, i32* %to.addr, align 4
  br label %if.end
...
pop.ok:
  ...
  %61 = load i32, i32* %60, align 4, !alias.scope !4, !noalias !3, !tbaa !15
  br label %while.cond
...
!17 = !{!"i32", !6, i64 0}
!18 = !{!"ptr", !6, i64 0}
!19 = !{!"Map$str$i32", !17, i64 0, !18, i64 8, !17, i64 16, !17, i64 20, !18, i64 24, !18, i64 32, !18, i64 40, !17, i64 48}
!20 = !{!19, !18, i64 8}
!21 = !{!19, !17, i64 16}
!22 = !{!19, !18, i64 40}
!23 = !{!19, !18, i64 24}
