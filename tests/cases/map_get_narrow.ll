...
@.str.2 = private unnamed_addr constant { i64, [3 x i8] } { i64 2, [3 x i8] c"a \00" }, align 8
@.str.3 = private unnamed_addr constant { i64, [5 x i8] } { i64 4, [5 x i8] c"no a\00" }, align 8
@.str.4 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"z\00" }, align 8
@.str.5 = private unnamed_addr constant { i64, [5 x i8] } { i64 4, [5 x i8] c"no z\00" }, align 8
...
@.str.9 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"q\00" }, align 8
...
define internal noundef double @lookup(%struct.Map$str$f64* noundef nonnull readonly align 8 dereferenceable(48) nocapture %m, i8* noundef nonnull noalias readonly align 8 %k) #0 {
entry:
  %0 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %m, i8* %k)
  %1 = icmp sge i64 %0, 0
  br i1 %1, label %get.found, label %get.end

get.found:
  %2 = trunc i64 %0 to i32
  %3 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %m, i32 %2)
  br label %get.end

get.end:
  %4 = phi double [ %3, %get.found ], [ 0.000000e+00, %entry ]
  %5 = xor i1 %1, true
  br i1 %5, label %if.then, label %if.end

if.then:
  %6 = fneg double 0x3FF0000000000000
  ret double %6

if.end:
  %7 = fmul double %4, 0x4024000000000000
  ret double %7
}
...
entry:
  ...
  %big.addr = alloca i1, align 1
  %shown.addr = alloca double, align 8
  ...
  %5 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
...
get.end:
  %10 = phi double [ %9, %get.found ], [ 0.000000e+00, %entry ]
  br i1 %7, label %if.then, label %if.else

if.then:
  %11 = call i8* @nish_str_from_f64(double %10)
  %12 = call i8* @nish_str_concat(i8* bitcast ({ i64, [3 x i8] }* @.str.2 to i8*), i8* %11)
  call void @nish_print(i8* %12)
  br label %if.end

if.else:
  call void @nish_print(i8* bitcast ({ i64, [5 x i8] }* @.str.3 to i8*))
  br label %if.end

if.end:
  %13 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %14 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %13, i8* bitcast ({ i64, [2 x i8] }* @.str.4 to i8*))
  %15 = icmp sge i64 %14, 0
  br i1 %15, label %get.found.1, label %get.end.1

get.found.1:
  %16 = trunc i64 %14 to i32
  %17 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %13, i32 %16)
  br label %get.end.1

get.end.1:
  %18 = phi double [ %17, %get.found.1 ], [ 0.000000e+00, %if.end ]
  %19 = xor i1 %15, true
  br i1 %19, label %if.then.1, label %if.end.1

if.then.1:
  call void @nish_print(i8* bitcast ({ i64, [5 x i8] }* @.str.5 to i8*))
  br label %if.end.1

if.end.1:
  %20 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %21 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %20, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %22 = icmp sge i64 %21, 0
  br i1 %22, label %get.found.2, label %get.end.2

get.found.2:
  %23 = trunc i64 %21 to i32
  %24 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %20, i32 %23)
  br label %get.end.2

get.end.2:
  %25 = phi double [ %24, %get.found.2 ], [ 0.000000e+00, %if.end.1 ]
  br i1 %22, label %land.rhs, label %land.end

land.rhs:
  %26 = fcmp ogt double %25, 0x3FF0000000000000
  br label %land.end

land.end:
  %27 = phi i1 [ false, %get.end.2 ], [ %26, %land.rhs ]
  store i1 %27, i1* %big.addr, align 1
  %28 = xor i1 %22, true
...
cond.false:
  %29 = fadd double %25, 0x4059000000000000
  br label %cond.end

cond.end:
  %30 = phi double [ 0x0000000000000000, %cond.true ], [ %29, %cond.false ]
  store double %30, double* %shown.addr, align 8
  %31 = load i1, i1* %big.addr, align 1
  %32 = select i1 %31, i8* bitcast ({ i64, [5 x i8] }* @.str.6 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.7 to i8*)
  %33 = call i8* @nish_str_concat(i8* %32, i8* bitcast ({ i64, [2 x i8] }* @.str.8 to i8*))
  %34 = load double, double* %shown.addr, align 8
  %35 = call i8* @nish_str_from_f64(double %34)
  %36 = call i8* @nish_str_concat(i8* %33, i8* %35)
  %37 = call i8* @nish_str_concat(i8* %36, i8* bitcast ({ i64, [2 x i8] }* @.str.8 to i8*))
  %38 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %39 = call double @lookup(%struct.Map$str$f64* %38, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %40 = call i8* @nish_str_from_f64(double %39)
  %41 = call i8* @nish_str_concat(i8* %37, i8* %40)
  %42 = call i8* @nish_str_concat(i8* %41, i8* bitcast ({ i64, [2 x i8] }* @.str.8 to i8*))
  %43 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %44 = call double @lookup(%struct.Map$str$f64* %43, i8* bitcast ({ i64, [2 x i8] }* @.str.9 to i8*))
  %45 = call i8* @nish_str_from_f64(double %44)
  %46 = call i8* @nish_str_concat(i8* %42, i8* %45)
  call void @nish_print(i8* %46)
  %47 = select i1 %7, double %10, double 0x401C000000000000
  %48 = call i8* @nish_str_from_f64(double %47)
  %49 = call i8* @nish_str_concat(i8* %48, i8* bitcast ({ i64, [2 x i8] }* @.str.8 to i8*))
  %50 = select i1 %15, double %18, double 0x401C000000000000
  %51 = call i8* @nish_str_from_f64(double %50)
  %52 = call i8* @nish_str_concat(i8* %49, i8* %51)
  call void @nish_print(i8* %52)
  %53 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %54 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %53, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %55 = icmp sge i64 %54, 0
  %56 = select i1 %55, i8* bitcast ({ i64, [5 x i8] }* @.str.6 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.7 to i8*)
  %57 = call i8* @nish_str_concat(i8* %56, i8* bitcast ({ i64, [2 x i8] }* @.str.8 to i8*))
  %58 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %59 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %58, i8* bitcast ({ i64, [2 x i8] }* @.str.9 to i8*))
  %60 = icmp sge i64 %59, 0
  %61 = xor i1 %60, true
  %62 = select i1 %61, i8* bitcast ({ i64, [5 x i8] }* @.str.6 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.7 to i8*)
...
bounds.ok:
  ...
  %19 = load double, double* %18, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  ret double %19
}
...
if.then:
  ...
  store double %value, double* %15, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  br label %if.end
...
push.store.1:
  ...
  store double %value, double* %41, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %42 = add i64 %34, 1
...
if.then:
  ...
  %44 = load double, double* %43, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %45 = bitcast i8* %11 to double*
  %46 = getelementptr inbounds double, double* %45, i64 %39
  store double %44, double* %46, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %47 = load i32, i32* %to.addr, align 4
  %48 = add nsw i32 %47, 1
  store i32 %48, i32* %to.addr, align 4
  br label %if.end
...
pop.ok:
  ...
  %65 = load double, double* %64, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  br label %while.cond
...
!16 = !{!"ptr", !6, i64 0}
!17 = !{!"i32", !6, i64 0}
!18 = !{!"Map$str$f64", !15, i64 0, !16, i64 8, !17, i64 16, !17, i64 20, !16, i64 24, !16, i64 32, !16, i64 40}
!19 = !{!18, !15, i64 0}
!20 = !{!18, !17, i64 16}
!21 = !{!18, !17, i64 20}
!22 = !{!18, !16, i64 8}
