...
@.str.3 = private unnamed_addr constant { i64, [9 x i8] } { i64 8, [9 x i8] c"cleared \00" }, align 8
@.str.4 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"n\00" }, align 8
@.str.5 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c"size \00" }, align 8
...
entry:
  %m.addr = alloca %struct.Map$str$f64*, align 8
  ...
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %m.addr, align 8
  %2 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %3 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %2, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), double 0x3FF0000000000000)
  %4 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %3, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), double 0x4000000000000000)
  %5 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), double 0x4008000000000000)
  %6 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* %6)
  %7 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %6, i32 0)
...
walk.body:
  %10 = call i8* @nish.Map$str$f64.keyAt(%struct.Map$str$f64* %6, i32 %8)
  store i8* %10, i8** %k.addr, align 8
  %11 = load i8*, i8** %k.addr, align 8
  call void @nish_print(i8* %11)
  %12 = load i8*, i8** %k.addr, align 8
  %13 = call zeroext i1 @nish_str_eq(i8* %12, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  br i1 %13, label %if.then, label %if.end

if.then:
  %14 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @nish.Map$str$f64.clear(%struct.Map$str$f64* %14)
  %15 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %16 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %15, i32 0, i32 0
  %17 = load double, double* %16, align 8, !tbaa !6
  %18 = call i8* @nish_str_from_f64(double %17)
  %19 = call i8* @nish_str_concat(i8* bitcast ({ i64, [9 x i8] }* @.str.3 to i8*), i8* %18)
  call void @nish_print(i8* %19)
  %20 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %21 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %20, i8* bitcast ({ i64, [2 x i8] }* @.str.4 to i8*), double 0x4022000000000000)
  br label %if.end
...
walk.inc:
  %22 = add i32 %8, 1
  %23 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %6, i32 %22)
  store i32 %23, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %6)
  %24 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %25 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %24, i32 0, i32 0
  %26 = load double, double* %25, align 8, !tbaa !6
  %27 = call i8* @nish_str_from_f64(double %26)
  %28 = call i8* @nish_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.5 to i8*), i8* %27)
  %29 = call i8* @nish_str_concat(i8* %28, i8* bitcast ({ i64, [2 x i8] }* @.str.6 to i8*))
  %30 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %31 = call i1 @nish.Map$str$f64.has(%struct.Map$str$f64* %30, i8* bitcast ({ i64, [2 x i8] }* @.str.4 to i8*))
  %32 = select i1 %31, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.8 to i8*)
  %33 = call i8* @nish_str_concat(i8* %29, i8* %32)
  %34 = call i8* @nish_str_concat(i8* %33, i8* bitcast ({ i64, [2 x i8] }* @.str.6 to i8*))
  %35 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %36 = call i1 @nish.Map$str$f64.has(%struct.Map$str$f64* %35, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %37 = select i1 %36, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.8 to i8*)
  %38 = call i8* @nish_str_concat(i8* %34, i8* %37)
  call void @nish_print(i8* %38)
  %39 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* %39)
  %40 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %39, i32 0)
  store i32 %40, i32* %walk.idx.1, align 4
  br label %walk.cond.1

walk.cond.1:
  %41 = load i32, i32* %walk.idx.1, align 4
  %42 = icmp sge i32 %41, 0
  br i1 %42, label %walk.body.1, label %walk.end.1

walk.body.1:
  %43 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %39, i32 %41)
  store double %43, double* %v.addr, align 8
...
walk.inc.1:
  %56 = add i32 %41, 1
  %57 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %39, i32 %56)
  store i32 %57, i32* %walk.idx.1, align 4
  br label %walk.cond.1

walk.end.1:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %39)
...
define internal noundef zeroext i1 @nish.Map$str$f64.has(%struct.Map$str$f64* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i8* noundef nonnull noalias readonly align 8 %key) #0 {
entry:
...
define internal void @nish.Map$str$f64.clear(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) nocapture %this) #0 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !23
  call void @nish.clearSlots(%struct.nish_array* %1)
  %2 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 7
  %3 = load i32, i32* %2, align 4, !tbaa !22
  %4 = icmp sgt i32 %3, 0
  br i1 %4, label %if.then, label %if.else

if.then:
  %5 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 6
...
if.else:
  ...
  call void @nish.truncate$str(%struct.nish_array* %8)
  ...
  call void @nish.truncate$f64(%struct.nish_array* %10)
  %11 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 6
  %12 = load %struct.nish_array*, %struct.nish_array** %11, align 8, !tbaa !26
...
if.end:
  ...
  %14 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 0
  store double 0x0000000000000000, double* %14, align 8, !tbaa !6
  ret void
}

define internal void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) nocapture %this) #3 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 7
...
define internal noundef i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %from) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 6
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !26
  %2 = call i32 @nish.nextLive(%struct.nish_array* %1, i32 %from)
  ret i32 %2
}

define internal void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) nocapture %this) #3 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 7
  %1 = load i32, i32* %0, align 4, !tbaa !22
  %2 = sub nsw i32 %1, 1
...
define internal noundef nonnull align 8 i8* @nish.Map$str$f64.keyAt(%struct.Map$str$f64* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index) #0 {
entry:
  %0 = icmp slt i32 %index, 0
  br i1 %0, label %lor.end, label %lor.rhs

lor.rhs:
  %1 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 4
...
if.end:
  %9 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 4
...
define internal void @nish.Map$str$f64.setValueAt(%struct.Map$str$f64* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index, double noundef %value) #3 {
entry:
...
push.store.1:
  ...
  store double %value, double* %45, align 8, !alias.scope !11, !noalias !10, !tbaa !30
  %46 = add i64 %38, 1
...
define internal void @nish.truncate$str(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %items) #0 {
entry:
  br label %while.cond
...
define internal void @nish.truncate$f64(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %items) #0 {
entry:
  br label %while.cond
