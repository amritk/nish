...
@.str.0 = private unnamed_addr constant { i64, [5 x i8] } { i64 4, [5 x i8] c"sum \00" }, align 8
...
for.cond:
  ...
  %3 = fcmp olt double %2, 0x4018000000000000
...
for.body:
  ...
  %8 = fmul double %6, %7
  %9 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %4, double %5, double %8)
  br label %for.inc

for.inc:
  %10 = load double, double* %i.addr, align 8
  %11 = fadd double %10, 0x3FF0000000000000
  store double %11, double* %i.addr, align 8
  br label %for.cond

for.end:
  %12 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %13 = call i1 @nish.Map$f64$f64.delete(%struct.Map$f64$f64* %12, double 0x0000000000000000)
  %14 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %15 = call i1 @nish.Map$f64$f64.delete(%struct.Map$f64$f64* %14, double 0x4010000000000000)
  %16 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %17 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %16, double 0x4000000000000000, double 0x4069000000000000)
  %18 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %19 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %18, double 0x0000000000000000, double 0x401C000000000000)
  store double 0x0000000000000000, double* %sum.addr, align 8
  %20 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  call void @nish.Map$f64$f64.walkOpen(%struct.Map$f64$f64* %20)
  %21 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %20, i32 0)
...
walk.cond:
  ...
  br i1 %23, label %walk.body, label %walk.end

walk.body:
  %24 = call double @nish.Map$f64$f64.valueAt(%struct.Map$f64$f64* %20, i32 %22)
  store double %24, double* %v.addr, align 8
  ...
  %29 = load double, double* %v.addr, align 8
  %30 = call i8* @nish_str_from_f64(double %29)
  call void @nish_print(i8* %30)
  %31 = load double, double* %sum.addr, align 8
  %32 = load double, double* %v.addr, align 8
  %33 = fadd double %31, %32
  store double %33, double* %sum.addr, align 8
...
push.store:
  ...
  store double %24, double* %33, align 8, !alias.scope !4, !noalias !3, !tbaa !28
  %34 = add i64 %26, 1
...
push.store.1:
  ...
  store double %value, double* %46, align 8, !alias.scope !4, !noalias !3, !tbaa !28
  %47 = add i64 %39, 1
  ...
  %55 = load i64, i64* %54, align 8, !alias.scope !3, !noalias !4, !tbaa !14
...
push.store.2:
  ...
  store i32 %51, i32* %60, align 4, !alias.scope !4, !noalias !3, !tbaa !13
  %61 = add i64 %53, 1
...
land.rhs.1:
  ...
  %82 = load double, double* %81, align 8, !alias.scope !4, !noalias !3, !tbaa !28
