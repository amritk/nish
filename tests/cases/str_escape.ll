...
entry:
  ...
  call void @amrit_print(i8* bitcast ({ i64, [24 x i8] }* @.str.0 to i8*))
  call void @amrit_print(i8* bitcast ({ i64, [18 x i8] }* @.str.1 to i8*))
  call void @amrit_print(i8* bitcast ({ i64, [12 x i8] }* @.str.2 to i8*))
