...
res.ok:
  ...
  %17 = add nsw i32 %4, %16
  store i32 %17, i32* %sum.addr, align 4
  br label %walk.inc
...
entry:
  ...
  %4 = sub nsw i32 0, 3
  %5 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %3, i32 2, i32 %4)
  %6 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %5, i32 3, i32 7)
  %7 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %8 = call %struct.nish_result.i32.str* @total(%struct.Map$i32$i32* %7)
  store %struct.nish_result.i32.str* %8, %struct.nish_result.i32.str** %r.addr, align 8
...
if.then:
  %12 = load %struct.nish_result.i32.str*, %struct.nish_result.i32.str** %r.addr, align 8
  %13 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %12, i32 0, i32 1
  %14 = load i32, i32* %13, align 4
  %15 = call i8* @nish_str_from_i32(i32 %14)
  %16 = call i8* @nish_str_concat(i8* bitcast ({ i64, [4 x i8] }* @.str.1 to i8*), i8* %15)
  call void @nish_print(i8* %16)
  br label %if.end

if.else:
  %17 = load %struct.nish_result.i32.str*, %struct.nish_result.i32.str** %r.addr, align 8
  %18 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %17, i32 0, i32 2
  %19 = load i8*, i8** %18, align 8
  %20 = call i8* @nish_str_concat(i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* %19)
  call void @nish_print(i8* %20)
  br label %if.end

if.end:
  %21 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %22 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %21, i32 2, i32 3)
  %23 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %24 = call %struct.nish_result.i32.str* @total(%struct.Map$i32$i32* %23)
  ...
  %26 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %25, i32 0, i32 0
  %27 = load i1, i1* %26, align 1
  %28 = select i1 %27, i8* bitcast ({ i64, [5 x i8] }* @.str.3 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.4 to i8*)
  %29 = call i8* @nish_str_concat(i8* %28, i8* bitcast ({ i64, [7 x i8] }* @.str.5 to i8*))
  %30 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %31 = call i1 @churnsFlat(%struct.Map$i32$i32* %30)
  %32 = select i1 %31, i8* bitcast ({ i64, [5 x i8] }* @.str.3 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.4 to i8*)
