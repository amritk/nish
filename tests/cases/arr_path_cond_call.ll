%struct.Queue = type { %struct.nish_array* }
...
define internal void @Queue.constructor(%struct.Queue* noundef nonnull noalias align 8 dereferenceable(8) nocapture %this, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) %items) #0 {
entry:
  %0 = getelementptr inbounds %struct.Queue, %struct.Queue* %this, i32 0, i32 0
  store %struct.nish_array* %items, %struct.nish_array** %0, align 8, !tbaa !4
  ret void
}

define internal noundef zeroext i1 @Queue.trim(%struct.Queue* noundef nonnull readonly align 8 dereferenceable(8) nocapture %this) #1 {
entry:
  br label %while.cond
...
while.body:
  %6 = getelementptr inbounds %struct.Queue, %struct.Queue* %this, i32 0, i32 0
...
define internal noundef i32 @Queue.take(%struct.Queue* noundef nonnull readonly align 8 dereferenceable(8) nocapture %this, i32 noundef %i) #1 {
entry:
  %0 = icmp sge i32 %i, 0
  br i1 %0, label %land.rhs.1, label %land.end.1

land.rhs.1:
  %1 = getelementptr inbounds %struct.Queue, %struct.Queue* %this, i32 0, i32 0
...
land.rhs:
  %8 = call i1 @Queue.trim(%struct.Queue* %this)
  br label %land.end
...
if.then:
  %10 = getelementptr inbounds %struct.Queue, %struct.Queue* %this, i32 0, i32 0
...
entry:
  ...
  %Queue.obj = alloca %struct.Queue, align 8
  ...
  store i32 10, i32* %7, align 4, !alias.scope !9, !noalias !8, !tbaa !16
  %8 = getelementptr inbounds i32, i32* %6, i64 1
  store i32 20, i32* %8, align 4, !alias.scope !9, !noalias !8, !tbaa !16
  %9 = getelementptr inbounds i32, i32* %6, i64 2
  store i32 30, i32* %9, align 4, !alias.scope !9, !noalias !8, !tbaa !16
  %10 = getelementptr inbounds i32, i32* %6, i64 3
  store i32 40, i32* %10, align 4, !alias.scope !9, !noalias !8, !tbaa !16
  %11 = getelementptr inbounds i32, i32* %6, i64 4
  store i32 50, i32* %11, align 4, !alias.scope !9, !noalias !8, !tbaa !16
  %12 = getelementptr inbounds i32, i32* %6, i64 5
  store i32 60, i32* %12, align 4, !alias.scope !9, !noalias !8, !tbaa !16
  ...
  %14 = call i32 @Queue.take(%struct.Queue* %13, i32 5)
