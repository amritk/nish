%struct.Config = type { double, %struct.amrit_array* }
...
entry:
  ...
  %6 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %2, i64 0, i32 2
  ...
  store %struct.amrit_array* %2, %struct.amrit_array** %11, align 8
  ret void
}
...
bounds.ok:
  ...
  %22 = load %struct.amrit_array*, %struct.amrit_array** %21, align 8
...
bounds.ok.1:
  ...
  %32 = call i8* @amrit_str_from_f64(double %31)
  ...
  %35 = call i8* @amrit_str_from_f64(double %34)
