...
define internal void @bump(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %tables, double noundef %t, i8* noundef nonnull noalias readonly align 8 %k) #0 {
entry:
  %0 = fptosi double %t to i64
  %1 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %tables, i64 0, i32 0
...
bounds.ok:
  %4 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %tables, i64 0, i32 2
  %5 = load i8*, i8** %4, align 8, !alias.scope !3, !noalias !4, !tbaa !11
  %6 = bitcast i8* %5 to %struct.Map$str$f64**
  %7 = getelementptr inbounds %struct.Map$str$f64*, %struct.Map$str$f64** %6, i64 %0
  %8 = load %struct.Map$str$f64*, %struct.Map$str$f64** %7, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %9 = fptosi double %t to i64
  %10 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %tables, i64 0, i32 0
...
bounds.ok.1:
  %13 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %tables, i64 0, i32 2
  %14 = load i8*, i8** %13, align 8, !alias.scope !3, !noalias !4, !tbaa !11
  %15 = bitcast i8* %14 to %struct.Map$str$f64**
  %16 = getelementptr inbounds %struct.Map$str$f64*, %struct.Map$str$f64** %15, i64 %9
  %17 = load %struct.Map$str$f64*, %struct.Map$str$f64** %16, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %18 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %17, i8* %k)
  %19 = icmp sge i64 %18, 0
  br i1 %19, label %nullish.value, label %nullish.default

nullish.value:
  %20 = trunc i64 %18 to i32
  %21 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %17, i32 %20)
...
nullish.end:
  %22 = phi double [ %21, %nullish.value ], [ 0x0000000000000000, %nullish.default ]
  %23 = fadd double %22, 0x3FF0000000000000
  %24 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %8, i8* %k, double %23)
  ret void
}

define noundef i32 @nish_main() #0 {
entry:
  %tables.addr = alloca %struct.nish_array*, align 8
  %arr.hdr = alloca %struct.nish_array, align 8
  %arr.data = alloca [2 x %struct.Map$str$f64*], align 8
  ...
  %3 = bitcast i8* %2 to %struct.Map$str$f64*
  call void @nish.Map$str$f64.constructor(%struct.Map$str$f64* %3)
  ...
  %6 = bitcast [2 x %struct.Map$str$f64*]* %arr.data to i8*
  ...
  %8 = bitcast i8* %6 to %struct.Map$str$f64**
  %9 = getelementptr inbounds %struct.Map$str$f64*, %struct.Map$str$f64** %8, i64 0
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %9, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %10 = getelementptr inbounds %struct.Map$str$f64*, %struct.Map$str$f64** %8, i64 1
  store %struct.Map$str$f64* %3, %struct.Map$str$f64** %10, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  store %struct.nish_array* %arr.hdr, %struct.nish_array** %tables.addr, align 8
  %11 = load %struct.nish_array*, %struct.nish_array** %tables.addr, align 8
  call void @bump(%struct.nish_array* %11, double 0x3FF0000000000000, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %12 = load %struct.nish_array*, %struct.nish_array** %tables.addr, align 8
  call void @bump(%struct.nish_array* %12, double 0x3FF0000000000000, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %13 = load %struct.nish_array*, %struct.nish_array** %tables.addr, align 8
  call void @bump(%struct.nish_array* %13, double 0x0000000000000000, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %14 = load %struct.nish_array*, %struct.nish_array** %tables.addr, align 8
  %15 = fptosi double 0x0000000000000000 to i64
...
bounds.ok:
  ...
  %21 = bitcast i8* %20 to %struct.Map$str$f64**
  %22 = getelementptr inbounds %struct.Map$str$f64*, %struct.Map$str$f64** %21, i64 %15
  %23 = load %struct.Map$str$f64*, %struct.Map$str$f64** %22, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %24 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %23, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %25 = icmp sge i64 %24, 0
  br i1 %25, label %nullish.value, label %nullish.default

nullish.value:
  %26 = trunc i64 %24 to i32
  %27 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %23, i32 %26)
  br label %nullish.end

nullish.default:
  %28 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %29 = phi double [ %27, %nullish.value ], [ %28, %nullish.default ]
  %30 = call i8* @nish_str_from_f64(double %29)
  %31 = call i8* @nish_str_concat(i8* %30, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %32 = load %struct.nish_array*, %struct.nish_array** %tables.addr, align 8
  %33 = fptosi double 0x3FF0000000000000 to i64
  %34 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %32, i64 0, i32 0
...
bounds.ok.1:
  ...
  %39 = bitcast i8* %38 to %struct.Map$str$f64**
  %40 = getelementptr inbounds %struct.Map$str$f64*, %struct.Map$str$f64** %39, i64 %33
  %41 = load %struct.Map$str$f64*, %struct.Map$str$f64** %40, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %42 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %41, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %43 = icmp sge i64 %42, 0
  br i1 %43, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %44 = trunc i64 %42 to i32
  %45 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %41, i32 %44)
  br label %nullish.end.1

nullish.default.1:
  %46 = fneg double 0x3FF0000000000000
  br label %nullish.end.1

nullish.end.1:
  %47 = phi double [ %45, %nullish.value.1 ], [ %46, %nullish.default.1 ]
...
!18 = !{!"ptr", !6, i64 0}
!19 = !{!"i32", !6, i64 0}
!20 = !{!"Map$str$f64", !17, i64 0, !18, i64 8, !19, i64 16, !19, i64 20, !18, i64 24, !18, i64 32, !18, i64 40, !19, i64 48}
!21 = !{!20, !17, i64 0}
!22 = !{!20, !19, i64 16}
!23 = !{!20, !19, i64 20}
!24 = !{!20, !19, i64 48}
