...
entry:
  ...
  %2 = call i8* @sts_str_from_f64(double %1)
  ...
  %11 = call i8* @sts_str_from_f64(double %10)
  %12 = call i8* @sts_str_concat(i8* %6, i8* %11)
  %13 = call i8* @sts_str_concat(i8* %12, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %14 = load double, double* %d.addr, align 8
  %15 = call i8* @sts_str_from_f64(double %14)
  %16 = call i8* @sts_str_concat(i8* %13, i8* %15)
