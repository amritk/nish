...
entry:
  ...
  store i32 0, i32* %k1.addr, align 4
  store i32 1, i32* %k2.addr, align 4
  store i32 2147483647, i32* %k3.addr, align 4
  %1 = sub nsw i32 0, -2147483648
  store i32 %1, i32* %k4.addr, align 4
  %2 = call i8* @nish_alloc_struct(i64 56)
  %3 = bitcast i8* %2 to %struct.Map$i32$i32*
  call void @nish.Map$i32$i32.constructor(%struct.Map$i32$i32* %3)
  store %struct.Map$i32$i32* %3, %struct.Map$i32$i32** %m.addr, align 8
  %4 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %5 = load i32, i32* %k0.addr, align 4
  %6 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %4, i32 %5, i32 1)
  %7 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %8 = load i32, i32* %k1.addr, align 4
  %9 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %7, i32 %8, i32 2)
  %10 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %11 = load i32, i32* %k2.addr, align 4
  %12 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %10, i32 %11, i32 3)
  %13 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %14 = load i32, i32* %k3.addr, align 4
  %15 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %13, i32 %14, i32 4)
  %16 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %17 = load i32, i32* %k4.addr, align 4
  %18 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %16, i32 %17, i32 5)
  store i32 0, i32* %found.addr, align 4
  %19 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %20 = load i32, i32* %k0.addr, align 4
  %21 = call i1 @nish.Map$i32$i32.has(%struct.Map$i32$i32* %19, i32 %20)
...
if.end:
  %24 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %25 = load i32, i32* %k1.addr, align 4
  %26 = call i1 @nish.Map$i32$i32.has(%struct.Map$i32$i32* %24, i32 %25)
...
if.end.1:
  ...
  %30 = load i32, i32* %k2.addr, align 4
  %31 = call i1 @nish.Map$i32$i32.has(%struct.Map$i32$i32* %29, i32 %30)
...
if.end.2:
  %34 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %35 = load i32, i32* %k3.addr, align 4
  %36 = call i1 @nish.Map$i32$i32.has(%struct.Map$i32$i32* %34, i32 %35)
...
if.end.3:
  %39 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %40 = load i32, i32* %k4.addr, align 4
  %41 = call i1 @nish.Map$i32$i32.has(%struct.Map$i32$i32* %39, i32 %40)
...
if.end.4:
  %44 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %45 = load i32, i32* %k0.addr, align 4
  %46 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %44, i32 %45, i32 10)
  %47 = load i32, i32* %k1.addr, align 4
  %48 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %46, i32 %47, i32 20)
  %49 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %50 = load i32, i32* %k2.addr, align 4
  %51 = call i1 @nish.Map$i32$i32.delete(%struct.Map$i32$i32* %49, i32 %50)
  store i1 %51, i1* %gone.addr, align 1
  %52 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %53 = load i32, i32* %k2.addr, align 4
  %54 = call i1 @nish.Map$i32$i32.delete(%struct.Map$i32$i32* %52, i32 %53)
  ...
  %58 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %59 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %58, i32 0, i32 0
  ...
  %72 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %73 = load i32, i32* %k2.addr, align 4
  %74 = call i1 @nish.Map$i32$i32.has(%struct.Map$i32$i32* %72, i32 %73)
  ...
  %78 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %79 = load i32, i32* %k3.addr, align 4
  %80 = call i1 @nish.Map$i32$i32.has(%struct.Map$i32$i32* %78, i32 %79)
...
lor.rhs:
  %16 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 7
...
if.end:
  %21 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 4
...
push.store:
  ...
  %33 = trunc i64 %32 to i32
  %34 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 5
...
push.store.1:
  ...
  %47 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 6
...
push.store.2:
  ...
  %61 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 3
  ...
  %69 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 4
  ...
  %75 = mul nsw i32 %74, 4
  %76 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 1
...
if.else:
  %83 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 1
  %84 = load %struct.nish_array*, %struct.nish_array** %83, align 8, !tbaa !22
  %85 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 2
