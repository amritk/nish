...
@.str.0 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c"pair \00" }, align 8
@.str.1 = private unnamed_addr constant { i64, [7 x i8] } { i64 6, [7 x i8] c" over \00" }, align 8
@.str.2 = private unnamed_addr constant { i64, [7 x i8] } { i64 6, [7 x i8] c" none \00" }, align 8
...
@.str.6 = private unnamed_addr constant { i64, [7 x i8] } { i64 6, [7 x i8] c" size \00" }, align 8
...
define internal noundef double @findPair(%struct.Map$f64$f64* noundef nonnull align 8 dereferenceable(56) nocapture %m, double noundef %total) #0 {
entry:
...
walk.body:
  %3 = call double @nish.Map$f64$f64.keyAt(%struct.Map$f64$f64* %m, i32 %1)
  store double %3, double* %a.addr, align 8
  call void @nish.Map$f64$f64.walkOpen(%struct.Map$f64$f64* %m)
  %4 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %m, i32 0)
  store i32 %4, i32* %walk.idx.1, align 4
  br label %walk.cond.1

walk.cond.1:
  %5 = load i32, i32* %walk.idx.1, align 4
  %6 = icmp sge i32 %5, 0
  br i1 %6, label %walk.body.1, label %walk.end.1

walk.body.1:
  %7 = call double @nish.Map$f64$f64.keyAt(%struct.Map$f64$f64* %m, i32 %5)
  store double %7, double* %b.addr, align 8
...
land.rhs:
  ...
  %14 = fcmp oeq double %13, %total
  br label %land.end

land.end:
  %15 = phi i1 [ false, %walk.body.1 ], [ %14, %land.rhs ]
  br i1 %15, label %if.then, label %if.end

if.then:
  %16 = load double, double* %a.addr, align 8
  %17 = fmul double %16, 0x4059000000000000
...
entry:
  ...
  store double 0x3FF0000000000000, double* %i.addr, align 8
  br label %for.cond

for.cond:
  %2 = load double, double* %i.addr, align 8
  %3 = fcmp ole double %2, 0x4022000000000000
...
for.end:
  ...
  %13 = call double @findPair(%struct.Map$f64$f64* %12, double 0x4026000000000000)
  %14 = call i8* @nish_str_from_f64(double %13)
  %15 = call i8* @nish_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.0 to i8*), i8* %14)
  %16 = call i8* @nish_str_concat(i8* %15, i8* bitcast ({ i64, [7 x i8] }* @.str.1 to i8*))
  %17 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %18 = call double @firstOver(%struct.Map$f64$f64* %17, double 0x4034000000000000)
  %19 = call i8* @nish_str_from_f64(double %18)
  %20 = call i8* @nish_str_concat(i8* %16, i8* %19)
  %21 = call i8* @nish_str_concat(i8* %20, i8* bitcast ({ i64, [7 x i8] }* @.str.2 to i8*))
  %22 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %23 = call double @firstOver(%struct.Map$f64$f64* %22, double 0x4059000000000000)
  ...
  %27 = call i1 @churnsFlat(%struct.Map$f64$f64* %26)
  %28 = select i1 %27, i8* bitcast ({ i64, [5 x i8] }* @.str.4 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.5 to i8*)
  %29 = call i8* @nish_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*), i8* %28)
  %30 = call i8* @nish_str_concat(i8* %29, i8* bitcast ({ i64, [7 x i8] }* @.str.6 to i8*))
