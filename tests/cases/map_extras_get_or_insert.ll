...
define internal noundef double @firstSeen(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %at, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %words) #0 {
entry:
...
for.body:
  ...
  %8 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 0
...
bounds.ok:
  %11 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 2
  %12 = load i8*, i8** %11, align 8, !alias.scope !3, !noalias !4, !tbaa !11
  %13 = bitcast i8* %12 to i8**
  %14 = getelementptr inbounds i8*, i8** %13, i64 %7
  %15 = load i8*, i8** %14, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %16 = load double, double* %i.addr, align 8
  %17 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %at, i8* %15)
  %18 = icmp sge i64 %17, 0
  br i1 %18, label %get.found, label %get.insert

get.found:
  %19 = trunc i64 %17 to i32
  %20 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %at, i32 %19)
  br label %get.end

get.insert:
  call void @nish.Map$str$f64.insertAt(%struct.Map$str$f64* %at, i64 %17, i8* %15, double %16)
  br label %get.end

get.end:
  %21 = phi double [ %20, %get.found ], [ %16, %get.insert ]
  %22 = fadd double %5, %21
  store double %22, double* %sum.addr, align 8
  br label %for.inc

for.inc:
  %23 = load double, double* %i.addr, align 8
  %24 = fadd double %23, 0x3FF0000000000000
  store double %24, double* %i.addr, align 8
  br label %for.cond
...
entry:
  %at.addr = alloca %struct.Map$str$f64*, align 8
  %sum.addr = alloca double, align 8
  ...
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %at.addr, align 8
  %2 = load %struct.Map$str$f64*, %struct.Map$str$f64** %at.addr, align 8
  ...
  store i64 6, i64* %4, align 8, !alias.scope !3, !noalias !4, !tbaa !14
  %5 = bitcast [6 x i8*]* %arr.data to i8*
  ...
  store i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8** %8, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %9 = getelementptr inbounds i8*, i8** %7, i64 1
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %9, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %10 = getelementptr inbounds i8*, i8** %7, i64 2
  store i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8** %10, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %11 = getelementptr inbounds i8*, i8** %7, i64 3
  store i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), i8** %11, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %12 = getelementptr inbounds i8*, i8** %7, i64 4
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %12, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %13 = getelementptr inbounds i8*, i8** %7, i64 5
  store i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8** %13, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %14 = call double @firstSeen(%struct.Map$str$f64* %2, %struct.nish_array* %arr.hdr)
  store double %14, double* %sum.addr, align 8
  %15 = load %struct.Map$str$f64*, %struct.Map$str$f64** %at.addr, align 8
  call void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* %15)
  %16 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %15, i32 0)
  store i32 %16, i32* %walk.idx, align 4
  br label %walk.cond

walk.cond:
  %17 = load i32, i32* %walk.idx, align 4
  %18 = icmp sge i32 %17, 0
  br i1 %18, label %walk.body, label %walk.end

walk.body:
  %19 = call i8* @nish.Map$str$f64.keyAt(%struct.Map$str$f64* %15, i32 %17)
  ...
  %24 = load i8*, i8** %w.addr, align 8
  %25 = call i8* @nish_str_concat(i8* %24, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*))
  %26 = load %struct.Map$str$f64*, %struct.Map$str$f64** %at.addr, align 8
  %27 = load i8*, i8** %w.addr, align 8
  %28 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %26, i8* %27)
  %29 = icmp sge i64 %28, 0
  br i1 %29, label %nullish.value, label %nullish.default

nullish.value:
  %30 = trunc i64 %28 to i32
  %31 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %26, i32 %30)
  br label %nullish.end

nullish.default:
  %32 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %33 = phi double [ %31, %nullish.value ], [ %32, %nullish.default ]
  %34 = call i8* @nish_str_from_f64(double %33)
  %35 = call i8* @nish_str_concat(i8* %25, i8* %34)
...
walk.inc:
  %42 = add i32 %17, 1
  %43 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %15, i32 %42)
  store i32 %43, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %15)
  %44 = load double, double* %sum.addr, align 8
  %45 = call i8* @nish_str_from_f64(double %44)
  %46 = call i8* @nish_str_concat(i8* %45, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*))
  %47 = load %struct.Map$str$f64*, %struct.Map$str$f64** %at.addr, align 8
