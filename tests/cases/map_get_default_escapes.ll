...
define internal noundef nonnull align 8 dereferenceable(8) %struct.Node* @pick(%struct.Map$str$$Node* noundef nonnull readonly align 8 dereferenceable(48) nocapture %m, i8* noundef nonnull noalias readonly align 8 %k) #1 {
entry:
...
define internal void @fill(%struct.Map$str$$Node* noundef nonnull align 8 dereferenceable(48) %m, i8* noundef nonnull noalias readonly align 8 %k) #1 {
entry:
  %0 = call i64 @nish.Map$str$$Node.probe(%struct.Map$str$$Node* %m, i8* %k)
  %1 = icmp sge i64 %0, 0
  br i1 %1, label %nullish.value, label %nullish.default
...
for.body:
  ...
  %18 = load i32, i32* %17, align 4, !alias.scope !9, !noalias !8, !tbaa !19
...
entry:
  ...
  store %struct.nish_array* %5, %struct.nish_array** %11, align 8, !tbaa !26
  ...
  store i64 0, i64* %15, align 8, !alias.scope !8, !noalias !9, !tbaa !14
  %16 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %13, i64 0, i32 2
  store i8* null, i8** %16, align 8, !alias.scope !8, !noalias !9, !tbaa !15
  %17 = getelementptr inbounds %struct.Map$str$$Node, %struct.Map$str$$Node* %this, i32 0, i32 4
  store %struct.nish_array* %13, %struct.nish_array** %17, align 8, !tbaa !27
  ...
  store i64 0, i64* %21, align 8, !alias.scope !8, !noalias !9, !tbaa !14
  %22 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %19, i64 0, i32 2
  store i8* null, i8** %22, align 8, !alias.scope !8, !noalias !9, !tbaa !15
  %23 = getelementptr inbounds %struct.Map$str$$Node, %struct.Map$str$$Node* %this, i32 0, i32 5
  store %struct.nish_array* %19, %struct.nish_array** %23, align 8, !tbaa !28
  ...
  store i64 0, i64* %27, align 8, !alias.scope !8, !noalias !9, !tbaa !14
  %28 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %25, i64 0, i32 2
  store i8* null, i8** %28, align 8, !alias.scope !8, !noalias !9, !tbaa !15
  %29 = getelementptr inbounds %struct.Map$str$$Node, %struct.Map$str$$Node* %this, i32 0, i32 6
  store %struct.nish_array* %25, %struct.nish_array** %29, align 8, !tbaa !29
  ret void
}
...
entry:
  ...
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !29
  %6 = getelementptr inbounds %struct.Map$str$$Node, %struct.Map$str$$Node* %this, i32 0, i32 4
  %7 = load %struct.nish_array*, %struct.nish_array** %6, align 8, !tbaa !27
...
lor.rhs:
  ...
  %2 = load %struct.nish_array*, %struct.nish_array** %1, align 8, !tbaa !28
...
entry:
  ...
  %8 = load %struct.nish_array*, %struct.nish_array** %7, align 8, !tbaa !27
...
push.store:
  ...
  store i8* %key, i8** %28, align 8, !alias.scope !9, !noalias !8, !tbaa !17
  %29 = add i64 %21, 1
  ...
  %36 = load i64, i64* %35, align 8, !alias.scope !8, !noalias !9, !tbaa !14
...
push.store.1:
  ...
  %39 = load i8*, i8** %38, align 8, !alias.scope !8, !noalias !9, !tbaa !15
  %40 = bitcast i8* %39 to %struct.Node**
  %41 = getelementptr inbounds %struct.Node*, %struct.Node** %40, i64 %34
  store %struct.Node* %value, %struct.Node** %41, align 8, !alias.scope !9, !noalias !8, !tbaa !17
  %42 = add i64 %34, 1
  ...
  %45 = load %struct.nish_array*, %struct.nish_array** %44, align 8, !tbaa !29
  ...
  %50 = load i64, i64* %49, align 8, !alias.scope !8, !noalias !9, !tbaa !14
...
push.store.2:
  ...
  store i32 %46, i32* %55, align 4, !alias.scope !9, !noalias !8, !tbaa !19
  %56 = add i64 %48, 1
  ...
  store double %64, double* %65, align 8, !tbaa !23
  %66 = getelementptr inbounds %struct.Map$str$$Node, %struct.Map$str$$Node* %this, i32 0, i32 4
  %67 = load %struct.nish_array*, %struct.nish_array** %66, align 8, !tbaa !27
  ...
  %75 = load %struct.nish_array*, %struct.nish_array** %74, align 8, !tbaa !26
...
if.else:
  ...
  %83 = load %struct.nish_array*, %struct.nish_array** %82, align 8, !tbaa !26
...
if.then:
  ...
  %17 = load %struct.nish_array*, %struct.nish_array** %16, align 8, !tbaa !27
  %18 = getelementptr inbounds %struct.Map$str$$Node, %struct.Map$str$$Node* %this, i32 0, i32 6
  %19 = load %struct.nish_array*, %struct.nish_array** %18, align 8, !tbaa !29
  ...
  %21 = load %struct.nish_array*, %struct.nish_array** %20, align 8, !tbaa !28
  ...
  %25 = load %struct.nish_array*, %struct.nish_array** %24, align 8, !tbaa !29
...
if.end:
  ...
  store %struct.nish_array* %26, %struct.nish_array** %27, align 8, !tbaa !26
  ...
  %37 = load %struct.nish_array*, %struct.nish_array** %36, align 8, !tbaa !29
...
!20 = !{!"double", !1, i64 0}
!21 = !{!"i32", !1, i64 0}
!22 = !{!"Map$str$$Node", !20, i64 0, !2, i64 8, !21, i64 16, !21, i64 20, !2, i64 24, !2, i64 32, !2, i64 40}
!23 = !{!22, !20, i64 0}
!24 = !{!22, !21, i64 16}
!25 = !{!22, !21, i64 20}
!26 = !{!22, !2, i64 8}
