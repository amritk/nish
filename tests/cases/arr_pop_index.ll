...
declare zeroext i1 @sts_str_eq(i8* noundef nonnull readonly align 8 nocapture, i8* noundef nonnull readonly align 8 nocapture) #1
declare void @sts_panic_index(i64 noundef, i64 noundef) #2

define noundef i32 @test() #0 {
entry:
  %names.addr = alloca %struct.sts_array*, align 8
  %arr.hdr = alloca %struct.sts_array, align 8
  %arr.data = alloca [3 x i8*], align 8
  %last.addr = alloca i8*, align 8
  %nums.addr = alloca %struct.sts_array*, align 8
  ...
  store %struct.sts_array* %arr.hdr, %struct.sts_array** %names.addr, align 8
  %8 = load %struct.sts_array*, %struct.sts_array** %names.addr, align 8
...
pop.empty:
  call void @sts_panic_index(i64 0, i64 0)
  unreachable
...
pop.ok:
  ...
  %18 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %arr.hdr.1, i64 0, i32 0
  store i64 3, i64* %18, align 8
  %19 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %arr.hdr.1, i64 0, i32 1
  store i64 3, i64* %19, align 8
  %20 = bitcast [3 x i32]* %arr.data.1 to i8*
  %21 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %arr.hdr.1, i64 0, i32 2
  ...
  store %struct.sts_array* %arr.hdr.1, %struct.sts_array** %nums.addr, align 8
  %26 = load %struct.sts_array*, %struct.sts_array** %names.addr, align 8
  %27 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %26, i64 0, i32 0
  %28 = load i64, i64* %27, align 8
  %29 = trunc i64 %28 to i32
  %30 = mul i32 %29, 100000
  %31 = load %struct.sts_array*, %struct.sts_array** %names.addr, align 8
...
idx.test:
  %36 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %31, i64 0, i32 2
  %37 = load i8*, i8** %36, align 8
  %38 = bitcast i8* %37 to i8**
  %39 = getelementptr inbounds i8*, i8** %38, i64 %34
  %40 = load i8*, i8** %39, align 8
  %41 = call zeroext i1 @sts_str_eq(i8* %40, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
...
idx.found:
  ...
  %48 = call zeroext i1 @sts_str_eq(i8* %47, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
...
cond.end:
  ...
  %50 = add i32 %46, %49
  %51 = load %struct.sts_array*, %struct.sts_array** %nums.addr, align 8
...
idx.found.1:
  ...
  %66 = mul i32 %65, 100
  %67 = add i32 %50, %66
  %68 = load %struct.sts_array*, %struct.sts_array** %nums.addr, align 8
  %69 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %68, i64 0, i32 0
...
idx.test.2:
  %73 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %68, i64 0, i32 2
...
idx.found.2:
  ...
  %83 = mul i32 %82, 10
  %84 = add i32 %67, %83
  %85 = load %struct.sts_array*, %struct.sts_array** %names.addr, align 8
...
idx.test.3:
  %90 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %85, i64 0, i32 2
  %91 = load i8*, i8** %90, align 8
  %92 = bitcast i8* %91 to i8**
  %93 = getelementptr inbounds i8*, i8** %92, i64 %88
  %94 = load i8*, i8** %93, align 8
  %95 = call zeroext i1 @sts_str_eq(i8* %94, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
