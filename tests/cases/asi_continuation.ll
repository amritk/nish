...
entry:
  ...
  %picked.addr = alloca i32, align 4
  %doubled.addr = alloca i32, align 4
  ...
  store i32 %13, i32* %picked.addr, align 4
  %14 = load i32, i32* %picked.addr, align 4
  %15 = call i32 @twice(i32 %14)
  store i32 %15, i32* %doubled.addr, align 4
  ...
  %18 = add nsw i32 %17, 1
  store i32 %18, i32* %b.addr, align 4
  %19 = load i32, i32* %picked.addr, align 4
  %20 = call i8* @nish_str_from_i32(i32 %19)
  %21 = call i8* @nish_str_concat(i8* %20, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %22 = load i32, i32* %doubled.addr, align 4
