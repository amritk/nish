...
entry:
  ...
  %6 = or i64 %4, %5
  %7 = trunc i64 %6 to i1
  %8 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj, i32 0, i32 0
  store i1 %7, i1* %8, align 1
  %9 = lshr i64 %6, 32
  %10 = trunc i64 %9 to i32
  %11 = bitcast i32 %10 to float
  %12 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj, i32 0, i32 1
  store float %11, float* %12, align 4
  %13 = trunc i64 %9 to i1
  %14 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj, i32 0, i32 2
  store i1 %13, i1* %14, align 1
  %15 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj, i32 0, i32 0
  %16 = load i1, i1* %15, align 1
  br i1 %16, label %res.ok, label %res.alt

res.ok:
  %17 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj, i32 0, i32 1
...
res.end:
  ...
  %32 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj.1, i32 0, i32 0
  store i1 %31, i1* %32, align 1
  %33 = lshr i64 %30, 32
  %34 = trunc i64 %33 to i32
  %35 = bitcast i32 %34 to float
  %36 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj.1, i32 0, i32 1
  store float %35, float* %36, align 4
  %37 = trunc i64 %33 to i1
  %38 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj.1, i32 0, i32 2
  store i1 %37, i1* %38, align 1
  %39 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj.1, i32 0, i32 0
  %40 = load i1, i1* %39, align 1
  br i1 %40, label %res.ok.1, label %res.alt.1

res.ok.1:
  %41 = getelementptr inbounds %struct.nish_result.f32.bool, %struct.nish_result.f32.bool* %nish_result.f32.bool.obj.1, i32 0, i32 1
...
res.end.1:
  ...
  %55 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %nish_result.u8.u16.obj, i32 0, i32 0
  store i1 %54, i1* %55, align 1
  %56 = lshr i64 %53, 32
  %57 = trunc i64 %56 to i8
  %58 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %nish_result.u8.u16.obj, i32 0, i32 1
  store i8 %57, i8* %58, align 1
  %59 = trunc i64 %56 to i16
  %60 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %nish_result.u8.u16.obj, i32 0, i32 2
  ...
  %61 = load %struct.nish_result.u8.u16*, %struct.nish_result.u8.u16** %small.addr, align 8
...
if.then:
  %64 = load %struct.nish_result.u8.u16*, %struct.nish_result.u8.u16** %small.addr, align 8
  %65 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %64, i32 0, i32 1
...
if.end:
  ...
  %77 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %nish_result.u8.u16.obj.1, i32 0, i32 0
  store i1 %76, i1* %77, align 1
  %78 = lshr i64 %75, 32
  %79 = trunc i64 %78 to i8
  %80 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %nish_result.u8.u16.obj.1, i32 0, i32 1
  store i8 %79, i8* %80, align 1
  %81 = trunc i64 %78 to i16
  %82 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %nish_result.u8.u16.obj.1, i32 0, i32 2
  ...
  %83 = load %struct.nish_result.u8.u16*, %struct.nish_result.u8.u16** %big.addr, align 8
  %84 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %83, i32 0, i32 0
  %85 = load i1, i1* %84, align 1
  %86 = xor i1 %85, true
  br i1 %86, label %if.then.1, label %if.end.1

if.then.1:
  %87 = load %struct.nish_result.u8.u16*, %struct.nish_result.u8.u16** %big.addr, align 8
  %88 = getelementptr inbounds %struct.nish_result.u8.u16, %struct.nish_result.u8.u16* %87, i32 0, i32 2
  %89 = load i16, i16* %88, align 2
  %90 = zext i16 %89 to i64
  %91 = call i8* @nish_str_from_u64(i64 %90)
