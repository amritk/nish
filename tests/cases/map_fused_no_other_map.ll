...
define internal void @merge(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %e, %struct.Map$str$f64* noundef nonnull readonly align 8 dereferenceable(56) nocapture %m, i8* noundef nonnull noalias readonly align 8 %w) #0 {
entry:
  %0 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %e, i8* %w)
  %1 = icmp sge i64 %0, 0
  br i1 %1, label %nullish.value, label %nullish.default

nullish.value:
  %2 = trunc i64 %0 to i32
  %3 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %e, i32 %2)
...
nullish.end:
  ...
  %5 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %m, i8* %w)
  %6 = icmp sge i64 %5, 0
  br i1 %6, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %7 = trunc i64 %5 to i32
  %8 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %m, i32 %7)
...
nullish.end.1:
  ...
  %10 = fadd double %4, %9
  %11 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %e, i8* %w, double %10)
  ret void
}

define noundef i32 @nish_main() #0 {
entry:
  %e.addr = alloca %struct.Map$str$f64*, align 8
  ...
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %e.addr, align 8
  ...
  store %struct.Map$str$f64* %3, %struct.Map$str$f64** %m.addr, align 8
  %4 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %5 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), double 0x4024000000000000)
  %6 = load %struct.Map$str$f64*, %struct.Map$str$f64** %e.addr, align 8
  %7 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @merge(%struct.Map$str$f64* %6, %struct.Map$str$f64* %7, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %8 = load %struct.Map$str$f64*, %struct.Map$str$f64** %e.addr, align 8
  %9 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @merge(%struct.Map$str$f64* %8, %struct.Map$str$f64* %9, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %10 = load %struct.Map$str$f64*, %struct.Map$str$f64** %e.addr, align 8
  %11 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @merge(%struct.Map$str$f64* %10, %struct.Map$str$f64* %11, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %12 = load %struct.Map$str$f64*, %struct.Map$str$f64** %e.addr, align 8
  %13 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %12, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %14 = icmp sge i64 %13, 0
  br i1 %14, label %nullish.value, label %nullish.default

nullish.value:
  %15 = trunc i64 %13 to i32
  %16 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %12, i32 %15)
  br label %nullish.end

nullish.default:
  %17 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %18 = phi double [ %16, %nullish.value ], [ %17, %nullish.default ]
  %19 = call i8* @nish_str_from_f64(double %18)
  %20 = call i8* @nish_str_concat(i8* %19, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  %21 = load %struct.Map$str$f64*, %struct.Map$str$f64** %e.addr, align 8
  %22 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %21, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %23 = icmp sge i64 %22, 0
  br i1 %23, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %24 = trunc i64 %22 to i32
  %25 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %21, i32 %24)
  br label %nullish.end.1
...
nullish.end.1:
  %27 = phi double [ %25, %nullish.value.1 ], [ %26, %nullish.default.1 ]
  %28 = call i8* @nish_str_from_f64(double %27)
  %29 = call i8* @nish_str_concat(i8* %20, i8* %28)
  %30 = call i8* @nish_str_concat(i8* %29, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  %31 = load %struct.Map$str$f64*, %struct.Map$str$f64** %e.addr, align 8
  %32 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %31, i32 0, i32 0
...
push.store:
  ...
  store i8* %key, i8** %32, align 8, !alias.scope !11, !noalias !10, !tbaa !30
  %33 = add i64 %25, 1
...
land.rhs.1:
  ...
  %79 = load i8*, i8** %78, align 8, !alias.scope !11, !noalias !10, !tbaa !30
...
if.then:
  ...
  %44 = load i8*, i8** %43, align 8, !alias.scope !11, !noalias !10, !tbaa !30
  %45 = bitcast i8* %11 to i8**
  %46 = getelementptr inbounds i8*, i8** %45, i64 %39
  store i8* %44, i8** %46, align 8, !alias.scope !11, !noalias !10, !tbaa !30
...
pop.ok:
  ...
  %65 = load i8*, i8** %64, align 8, !alias.scope !11, !noalias !10, !tbaa !30
  br label %while.cond
