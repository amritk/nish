%struct.Tally = type { %struct.Map$str$f64*, %struct.Set$str*, %struct.nish_array* }
...
define internal void @Tally.constructor(%struct.Tally* noundef nonnull noalias align 8 dereferenceable(24) nocapture %this) #0 {
entry:
  ...
  %2 = getelementptr inbounds %struct.Tally, %struct.Tally* %this, i32 0, i32 0
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %2, align 8, !tbaa !4
  %3 = call i8* @nish_alloc_struct(i64 48)
  %4 = bitcast i8* %3 to %struct.Set$str*
  call void @nish.Set$str.constructor(%struct.Set$str* %4)
  %5 = getelementptr inbounds %struct.Tally, %struct.Tally* %this, i32 0, i32 1
  store %struct.Set$str* %4, %struct.Set$str** %5, align 8, !tbaa !5
  ...
  store i64 0, i64* %8, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %9 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %7, i64 0, i32 1
  store i64 0, i64* %9, align 8, !alias.scope !9, !noalias !10, !tbaa !15
  %10 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %7, i64 0, i32 2
  store i8* null, i8** %10, align 8, !alias.scope !9, !noalias !10, !tbaa !16
  %11 = getelementptr inbounds %struct.Tally, %struct.Tally* %this, i32 0, i32 2
  store %struct.nish_array* %7, %struct.nish_array** %11, align 8, !tbaa !17
  ret void
}
...
entry:
  ...
  %2 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %1, i8* %w)
  %3 = icmp sge i64 %2, 0
  br i1 %3, label %nullish.value, label %nullish.default

nullish.value:
  %4 = trunc i64 %2 to i32
  %5 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %1, i32 %4)
...
nullish.end:
  %6 = phi double [ %5, %nullish.value ], [ 0x0000000000000000, %nullish.default ]
  %7 = fadd double %6, 0x3FF0000000000000
  br i1 %3, label %set.found, label %set.insert

set.found:
  %8 = trunc i64 %2 to i32
  call void @nish.Map$str$f64.setValueAt(%struct.Map$str$f64* %1, i32 %8, double %7)
  br label %set.end

set.insert:
  call void @nish.Map$str$f64.insertAt(%struct.Map$str$f64* %1, i64 %2, i8* %w, double %7)
  br label %set.end

set.end:
  %9 = getelementptr inbounds %struct.Tally, %struct.Tally* %this, i32 0, i32 1
  %10 = load %struct.Set$str*, %struct.Set$str** %9, align 8, !tbaa !5
  %11 = call i64 @nish.Set$str.probe(%struct.Set$str* %10, i8* %w)
  %12 = icmp sge i64 %11, 0
  %13 = xor i1 %12, true
  br i1 %13, label %if.then, label %if.end

if.then:
  call void @nish.Set$str.insertAt(%struct.Set$str* %10, i64 %11, i8* %w)
  %14 = getelementptr inbounds %struct.Tally, %struct.Tally* %this, i32 0, i32 2
  ...
  %17 = load i64, i64* %16, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %18 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %15, i64 0, i32 1
  %19 = load i64, i64* %18, align 8, !alias.scope !9, !noalias !10, !tbaa !15
...
push.store:
  ...
  %22 = load i8*, i8** %21, align 8, !alias.scope !9, !noalias !10, !tbaa !16
  %23 = bitcast i8* %22 to i8**
  %24 = getelementptr inbounds i8*, i8** %23, i64 %17
  store i8* %w, i8** %24, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  %25 = add i64 %17, 1
  store i64 %25, i64* %16, align 8, !alias.scope !9, !noalias !10, !tbaa !14
...
entry:
  ...
  call void @Tally.constructor(%struct.Tally* %Tally.obj)
  store %struct.Tally* %Tally.obj, %struct.Tally** %t.addr, align 8
  %0 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 0
  store i64 6, i64* %0, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %1 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 1
  store i64 6, i64* %1, align 8, !alias.scope !9, !noalias !10, !tbaa !15
  %2 = bitcast [6 x i8*]* %arr.data to i8*
  %3 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 2
  store i8* %2, i8** %3, align 8, !alias.scope !9, !noalias !10, !tbaa !16
  %4 = bitcast i8* %2 to i8**
  %5 = getelementptr inbounds i8*, i8** %4, i64 0
  store i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8** %5, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  %6 = getelementptr inbounds i8*, i8** %4, i64 1
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %6, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  %7 = getelementptr inbounds i8*, i8** %4, i64 2
  store i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8** %7, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  %8 = getelementptr inbounds i8*, i8** %4, i64 3
  store i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8** %8, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  %9 = getelementptr inbounds i8*, i8** %4, i64 4
  store i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), i8** %9, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  %10 = getelementptr inbounds i8*, i8** %4, i64 5
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %10, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  store i64 0, i64* %forof.idx, align 8
  br label %forof.cond

forof.cond:
  %11 = load i64, i64* %forof.idx, align 8
  %12 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 0
  %13 = load i64, i64* %12, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %14 = icmp ult i64 %11, %13
  br i1 %14, label %forof.body, label %forof.end
...
forof.body:
  ...
  %19 = load i8*, i8** %18, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  store i8* %19, i8** %w.addr, align 8
  %20 = load %struct.Tally*, %struct.Tally** %t.addr, align 8
  %21 = load i8*, i8** %w.addr, align 8
  call void @Tally.note(%struct.Tally* %20, i8* %21)
  br label %forof.inc

forof.inc:
  %22 = load i64, i64* %forof.idx, align 8
  %23 = add i64 %22, 1
  store i64 %23, i64* %forof.idx, align 8
  br label %forof.cond

forof.end:
  %24 = load %struct.Tally*, %struct.Tally** %t.addr, align 8
  %25 = getelementptr inbounds %struct.Tally, %struct.Tally* %24, i32 0, i32 2
  %26 = load %struct.nish_array*, %struct.nish_array** %25, align 8, !tbaa !17
...
forof.body.1:
  ...
  %32 = load i8*, i8** %31, align 8, !alias.scope !9, !noalias !10, !tbaa !16
  %33 = bitcast i8* %32 to i8**
  %34 = getelementptr inbounds i8*, i8** %33, i64 %27
  %35 = load i8*, i8** %34, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  store i8* %35, i8** %w.addr.1, align 8
  ...
  %40 = load i8*, i8** %w.addr.1, align 8
  %41 = call i8* @nish_str_concat(i8* %40, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*))
  %42 = load %struct.Tally*, %struct.Tally** %t.addr, align 8
  %43 = getelementptr inbounds %struct.Tally, %struct.Tally* %42, i32 0, i32 0
  %44 = load %struct.Map$str$f64*, %struct.Map$str$f64** %43, align 8, !tbaa !4
  %45 = load i8*, i8** %w.addr.1, align 8
  %46 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %44, i8* %45)
  %47 = icmp sge i64 %46, 0
  br i1 %47, label %nullish.value, label %nullish.default

nullish.value:
  %48 = trunc i64 %46 to i32
  %49 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %44, i32 %48)
  br label %nullish.end

nullish.default:
  %50 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %51 = phi double [ %49, %nullish.value ], [ %50, %nullish.default ]
  %52 = call i8* @nish_str_from_f64(double %51)
  %53 = call i8* @nish_str_concat(i8* %41, i8* %52)
...
forof.inc.1:
  %60 = load i64, i64* %forof.idx.1, align 8
  %61 = add i64 %60, 1
  store i64 %61, i64* %forof.idx.1, align 8
  br label %forof.cond.1
...
entry:
  ...
  %5 = load i8*, i8** %4, align 8, !alias.scope !9, !noalias !10, !tbaa !16
  br label %while.cond
...
while.body:
  ...
  %17 = load i32, i32* %16, align 4, !alias.scope !10, !noalias !9, !tbaa !21
  %18 = icmp eq i32 %17, 0
...
if.then:
  ...
  store i32 %21, i32* %23, align 4, !alias.scope !10, !noalias !9, !tbaa !21
  ret void
...
for.body:
  ...
  %13 = load i32, i32* %12, align 4, !alias.scope !10, !noalias !9, !tbaa !21
...
if.then:
  ...
  store i32 %25, i32* %27, align 4, !alias.scope !10, !noalias !9, !tbaa !21
...
pop.ok:
  %41 = sub i64 %39, 1
  store i64 %41, i64* %38, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  ...
  %46 = load i32, i32* %45, align 4, !alias.scope !10, !noalias !9, !tbaa !21
  br label %while.cond
...
entry:
  ...
  %6 = load i64, i64* %5, align 8, !alias.scope !9, !noalias !10, !tbaa !14
...
for.body:
  ...
  store i32 0, i32* %11, align 4, !alias.scope !10, !noalias !9, !tbaa !21
  br label %for.inc
...
if.then:
  ...
  %11 = load i8*, i8** %10, align 8, !alias.scope !9, !noalias !10, !tbaa !16
  %12 = bitcast i8* %11 to i32*
  %13 = getelementptr inbounds i32, i32* %12, i64 %7
  store i32 %9, i32* %13, align 4, !alias.scope !10, !noalias !9, !tbaa !21
  br label %if.end
...
entry:
  ...
  store double 0x0000000000000000, double* %0, align 8, !tbaa !25
  %1 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !26
...
entry:
  ...
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !32
...
lor.rhs:
  ...
  %2 = load %struct.nish_array*, %struct.nish_array** %1, align 8, !tbaa !31
...
if.end:
  ...
  %10 = load %struct.nish_array*, %struct.nish_array** %9, align 8, !tbaa !31
...
bounds.ok:
  ...
  %19 = load double, double* %18, align 8, !alias.scope !10, !noalias !9, !tbaa !34
  ret double %19
}
...
if.then:
  ...
  store double %value, double* %15, align 8, !alias.scope !10, !noalias !9, !tbaa !34
  br label %if.end
...
entry:
  ...
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !30
...
if.then:
  ...
  %26 = load %struct.nish_array*, %struct.nish_array** %25, align 8, !tbaa !30
  %27 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 6
  %28 = load %struct.nish_array*, %struct.nish_array** %27, align 8, !tbaa !32
  ...
  %30 = load %struct.nish_array*, %struct.nish_array** %29, align 8, !tbaa !31
  %31 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 6
  %32 = load %struct.nish_array*, %struct.nish_array** %31, align 8, !tbaa !32
  ...
  %34 = load %struct.nish_array*, %struct.nish_array** %33, align 8, !tbaa !32
...
if.end:
  ...
  store %struct.nish_array* %35, %struct.nish_array** %36, align 8, !tbaa !29
  ...
  %46 = load %struct.nish_array*, %struct.nish_array** %45, align 8, !tbaa !32
...
entry:
  ...
  store double 0x0000000000000000, double* %0, align 8, !tbaa !36
  %1 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !37
...
entry:
  ...
  %10 = load %struct.nish_array*, %struct.nish_array** %9, align 8, !tbaa !40
  %11 = load i1, i1* %walking.addr, align 1
  br i1 %11, label %cond.true, label %cond.false
...
if.then:
  ...
  %26 = load %struct.nish_array*, %struct.nish_array** %25, align 8, !tbaa !41
  ...
  %30 = load %struct.nish_array*, %struct.nish_array** %29, align 8, !tbaa !42
...
if.end:
  ...
  store %struct.nish_array* %31, %struct.nish_array** %32, align 8, !tbaa !40
  ...
  store i32 %38, i32* %39, align 4, !tbaa !37
  ...
  %42 = load %struct.nish_array*, %struct.nish_array** %41, align 8, !tbaa !42
...
while.body:
  ...
  %42 = load i32, i32* %41, align 4, !alias.scope !10, !noalias !9, !tbaa !21
...
land.rhs.3:
  ...
  %66 = load i32, i32* %65, align 4, !alias.scope !10, !noalias !9, !tbaa !21
...
land.rhs.1:
  ...
  %79 = load i8*, i8** %78, align 8, !alias.scope !10, !noalias !9, !tbaa !19
...
for.body:
  ...
  %24 = load i32, i32* %23, align 4, !alias.scope !10, !noalias !9, !tbaa !21
  %25 = icmp ne i32 %24, 0
...
if.then:
  ...
  %44 = load i8*, i8** %43, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  %45 = bitcast i8* %11 to i8**
  %46 = getelementptr inbounds i8*, i8** %45, i64 %39
  store i8* %44, i8** %46, align 8, !alias.scope !10, !noalias !9, !tbaa !19
...
pop.ok:
  %60 = sub i64 %58, 1
  store i64 %60, i64* %57, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %61 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %items, i64 0, i32 2
  %62 = load i8*, i8** %61, align 8, !alias.scope !9, !noalias !10, !tbaa !16
  %63 = bitcast i8* %62 to i8**
  %64 = getelementptr inbounds i8*, i8** %63, i64 %60
  %65 = load i8*, i8** %64, align 8, !alias.scope !10, !noalias !9, !tbaa !19
  br label %while.cond
...
if.then:
  ...
  %44 = load double, double* %43, align 8, !alias.scope !10, !noalias !9, !tbaa !34
  %45 = bitcast i8* %11 to double*
  %46 = getelementptr inbounds double, double* %45, i64 %39
  store double %44, double* %46, align 8, !alias.scope !10, !noalias !9, !tbaa !34
  %47 = load i32, i32* %to.addr, align 4
  %48 = add nsw i32 %47, 1
  store i32 %48, i32* %to.addr, align 4
  br label %if.end
...
pop.ok:
  ...
  %65 = load double, double* %64, align 8, !alias.scope !10, !noalias !9, !tbaa !34
  br label %while.cond
...
!2 = !{!"ptr", !1, i64 0}
!3 = !{!"Tally", !2, i64 0, !2, i64 8, !2, i64 16}
!4 = !{!3, !2, i64 0}
!5 = !{!3, !2, i64 8}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
...
!22 = !{!"double", !1, i64 0}
!23 = !{!"i32", !1, i64 0}
!24 = !{!"Map$str$f64", !22, i64 0, !2, i64 8, !23, i64 16, !23, i64 20, !2, i64 24, !2, i64 32, !2, i64 40, !23, i64 48}
!25 = !{!24, !22, i64 0}
!26 = !{!24, !23, i64 16}
!27 = !{!24, !23, i64 20}
!28 = !{!24, !23, i64 48}
...
!31 = !{!24, !2, i64 32}
!32 = !{!24, !2, i64 40}
!33 = !{!"element double", !1, i64 0}
!34 = !{!33, !33, i64 0}
!35 = !{!"Set$str", !22, i64 0, !2, i64 8, !23, i64 16, !23, i64 20, !2, i64 24, !2, i64 32, !23, i64 40}
!36 = !{!35, !22, i64 0}
!37 = !{!35, !23, i64 16}
!38 = !{!35, !23, i64 20}
!39 = !{!35, !23, i64 40}
