...
entry:
  ...
  %2 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 4
  %3 = load %struct.nish_array*, %struct.nish_array** %2, align 8, !tbaa !22
  call void @nish.truncate$str(%struct.nish_array* %3)
  %4 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 5
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !23
  call void @nish.truncate$u32(%struct.nish_array* %5)
  %6 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 3
  store i32 0, i32* %6, align 4, !tbaa !20
  %7 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 0
...
push.store.1:
  ...
  %58 = mul nsw i32 %57, 4
  %59 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 1
  %60 = load %struct.nish_array*, %struct.nish_array** %59, align 8, !tbaa !21
...
if.else:
  %66 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 1
  %67 = load %struct.nish_array*, %struct.nish_array** %66, align 8, !tbaa !21
  %68 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 2
...
if.end:
  ...
  %22 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 1
  store %struct.nish_array* %21, %struct.nish_array** %22, align 8, !tbaa !21
  ...
  %27 = sub nsw i32 %26, 1
  %28 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 2
...
pop.ok:
  ...
  %12 = load i8*, i8** %11, align 8, !alias.scope !10, !noalias !9, !tbaa !25
  br label %while.cond
