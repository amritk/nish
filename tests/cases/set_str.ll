...
define internal void @nish.Set$str.clear(%struct.Set$str* noundef nonnull align 8 dereferenceable(48) nocapture %this) #0 {
entry:
  %0 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !22
  call void @nish.clearSlots(%struct.nish_array* %1)
  %2 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 6
...
if.else:
  ...
  %9 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 5
  %10 = load %struct.nish_array*, %struct.nish_array** %9, align 8, !tbaa !24
  call void @nish.truncate$u32(%struct.nish_array* %10)
  br label %if.end
...
push.store:
  ...
  store i8* %key, i8** %31, align 8, !alias.scope !10, !noalias !9, !tbaa !26
  %32 = add i64 %24, 1
...
pop.ok:
  ...
  %12 = load i8*, i8** %11, align 8, !alias.scope !10, !noalias !9, !tbaa !26
  br label %while.cond
...
!2 = !{!"i32", !1, i64 0}
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"Set$str", !2, i64 0, !3, i64 8, !2, i64 16, !2, i64 20, !3, i64 24, !3, i64 32, !2, i64 40}
!5 = !{!4, !2, i64 0}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
!8 = !{!"elements", !6}
