...
declare noundef i64 @sts_arena_mark() #3
declare void @sts_arena_release(i64 noundef) #3
...
declare noalias noundef nonnull align 8 i8* @sts_str_from_i64(i64 noundef) #3
...
define noundef i32 @sumI32(%struct.sts_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %xs) #0 {
entry:
...
define noundef double @sumF64(%struct.sts_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %xs) #0 {
entry:
...
define noundef nonnull align 8 dereferenceable(24) %struct.sts_array* @squares(i32 noundef %n) #1 {
entry:
  %out.addr = alloca %struct.sts_array*, align 8
  ...
  store %struct.sts_array* %2, %struct.sts_array** %out.addr, align 8
...
for.body:
  %10 = load %struct.sts_array*, %struct.sts_array** %out.addr, align 8
  %11 = load i32, i32* %i.addr, align 4
  %12 = sext i32 %11 to i64
  %13 = load i32, i32* %i.addr, align 4
  %14 = load i32, i32* %i.addr, align 4
  %15 = mul i32 %13, %14
  %16 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %10, i64 0, i32 0
  %17 = load i64, i64* %16, align 8
  %18 = icmp ult i64 %12, %17
  br i1 %18, label %bounds.ok, label %bounds.fail

bounds.fail:
  call void @sts_panic_index(i64 %12, i64 %17)
  unreachable

bounds.ok:
  %19 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %10, i64 0, i32 2
...
for.end:
  %25 = load %struct.sts_array*, %struct.sts_array** %out.addr, align 8
  ret %struct.sts_array* %25
}

define noundef nonnull align 8 dereferenceable(24) %struct.sts_array* @scale(%struct.sts_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %xs, double noundef %k) #1 {
entry:
  %out.addr = alloca %struct.sts_array*, align 8
  %i.addr = alloca i32, align 4
  ...
  %5 = bitcast i8* %4 to %struct.sts_array*
  %6 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %5, i64 0, i32 0
  store i64 %3, i64* %6, align 8
  %7 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %5, i64 0, i32 1
  store i64 %3, i64* %7, align 8
  %8 = mul i64 %3, 8
  %9 = call i8* @sts_alloc_struct(i64 %8)
  call void @llvm.memset.p0i8.i64(i8* align 8 %9, i8 0, i64 %8, i1 false)
  %10 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %5, i64 0, i32 2
  store i8* %9, i8** %10, align 8
  store %struct.sts_array* %5, %struct.sts_array** %out.addr, align 8
  store i32 0, i32* %i.addr, align 4
  br label %for.cond

for.cond:
  %11 = load i32, i32* %i.addr, align 4
  %12 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %xs, i64 0, i32 0
...
for.body:
  %16 = load %struct.sts_array*, %struct.sts_array** %out.addr, align 8
...
bounds.ok:
  ...
  %29 = fmul double %28, %k
  %30 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %16, i64 0, i32 0
  %31 = load i64, i64* %30, align 8
  %32 = icmp ult i64 %18, %31
  br i1 %32, label %bounds.ok.1, label %bounds.fail.1

bounds.fail.1:
  call void @sts_panic_index(i64 %18, i64 %31)
  unreachable

bounds.ok.1:
  %33 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %16, i64 0, i32 2
...
for.end:
  %39 = load %struct.sts_array*, %struct.sts_array** %out.addr, align 8
  ret %struct.sts_array* %39
}

define noundef nonnull align 8 dereferenceable(24) %struct.sts_array* @widen(%struct.sts_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %xs) #1 {
entry:
  %out.addr = alloca %struct.sts_array*, align 8
  %i.addr = alloca i32, align 4
  %0 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %xs, i64 0, i32 0
...
entry:
  %sq.addr = alloca %struct.sts_array*, align 8
  %ws.addr = alloca %struct.sts_array*, align 8
  %arr.hdr = alloca %struct.sts_array, align 8
  %arr.data = alloca [3 x double], align 8
  %k.addr = alloca double, align 8
  %big.addr = alloca %struct.sts_array*, align 8
  %arena.mark = call i64 @sts_arena_mark()
  %0 = call %struct.sts_array* @squares(i32 5)
  store %struct.sts_array* %0, %struct.sts_array** %sq.addr, align 8
  %1 = load %struct.sts_array*, %struct.sts_array** %sq.addr, align 8
  %2 = call i32 @sumI32(%struct.sts_array* %1)
  %3 = call i8* @sts_str_from_i32(i32 %2)
  call void @sts_print(i8* %3)
  %4 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %arr.hdr, i64 0, i32 0
  store i64 3, i64* %4, align 8
  %5 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %arr.hdr, i64 0, i32 1
  store i64 3, i64* %5, align 8
  %6 = mul i64 3, 8
  %7 = bitcast [3 x double]* %arr.data to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %7, i8 0, i64 %6, i1 false)
  %8 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %arr.hdr, i64 0, i32 2
  store i8* %7, i8** %8, align 8
  store %struct.sts_array* %arr.hdr, %struct.sts_array** %ws.addr, align 8
  %9 = load %struct.sts_array*, %struct.sts_array** %ws.addr, align 8
...
bounds.ok:
  ...
  store double 0x3FE0000000000000, double* %16, align 8
  %17 = load %struct.sts_array*, %struct.sts_array** %ws.addr, align 8
  %18 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %17, i64 0, i32 0
  %19 = load i64, i64* %18, align 8
  %20 = icmp ult i64 1, %19
  br i1 %20, label %bounds.ok.1, label %bounds.fail.1

bounds.fail.1:
  call void @sts_panic_index(i64 1, i64 %19)
  unreachable

bounds.ok.1:
  %21 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %17, i64 0, i32 2
  %22 = load i8*, i8** %21, align 8
  %23 = bitcast i8* %22 to double*
  %24 = getelementptr inbounds double, double* %23, i64 1
  store double 0x3FF8000000000000, double* %24, align 8
  %25 = load %struct.sts_array*, %struct.sts_array** %ws.addr, align 8
...
bounds.fail.2:
  call void @sts_panic_index(i64 2, i64 %27)
  unreachable

bounds.ok.2:
  %29 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %25, i64 0, i32 2
  %30 = load i8*, i8** %29, align 8
  %31 = bitcast i8* %30 to double*
  %32 = getelementptr inbounds double, double* %31, i64 2
  store double 0x4004000000000000, double* %32, align 8
  store double 0x4000000000000000, double* %k.addr, align 8
  %33 = load %struct.sts_array*, %struct.sts_array** %ws.addr, align 8
  %34 = load double, double* %k.addr, align 8
  %35 = call %struct.sts_array* @scale(%struct.sts_array* %33, double %34)
  %36 = call double @sumF64(%struct.sts_array* %35)
  %37 = call i8* @sts_str_from_f64(double %36)
  call void @sts_print(i8* %37)
  %38 = load %struct.sts_array*, %struct.sts_array** %sq.addr, align 8
  %39 = call %struct.sts_array* @widen(%struct.sts_array* %38)
  store %struct.sts_array* %39, %struct.sts_array** %big.addr, align 8
  %40 = load %struct.sts_array*, %struct.sts_array** %big.addr, align 8
...
bounds.fail.3:
  call void @sts_panic_index(i64 4, i64 %42)
  unreachable
...
bounds.ok.3:
  ...
  %50 = call i8* @sts_str_from_i64(i64 %49)
  call void @sts_print(i8* %50)
  %51 = load %struct.sts_array*, %struct.sts_array** %sq.addr, align 8
  %52 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %51, i64 0, i32 0
  %53 = load i64, i64* %52, align 8
  %54 = trunc i64 %53 to i32
  %55 = call i8* @sts_str_from_i32(i32 %54)
