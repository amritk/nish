...
if.then:
  ...
  %14 = add nsw i32 %13, 1
  store i32 %14, i32* %fresh.addr, align 4
  br label %if.end
...
forof.end:
  %17 = load i32, i32* %fresh.addr, align 4
  ret i32 %17
}
...
define internal void @nish.Set$i32.constructor(%struct.Set$i32* noundef nonnull noalias align 8 dereferenceable(48) nocapture %this) #3 {
entry:
...
define internal void @nish.Set$i32.walkOpen(%struct.Set$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this) #3 {
entry:
...
define internal void @nish.Set$i32.walkClose(%struct.Set$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this) #3 {
entry:
  %0 = getelementptr inbounds %struct.Set$i32, %struct.Set$i32* %this, i32 0, i32 6
  %1 = load i32, i32* %0, align 4, !tbaa !22
  %2 = sub nsw i32 %1, 1
