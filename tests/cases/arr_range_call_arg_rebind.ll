...
define internal noundef i32 @pick(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %xs, i32 noundef %a, i32 noundef %b) #0 {
entry:
  %0 = sext i32 %a to i64
...
entry:
  ...
  %9 = call i32 @pick(%struct.nish_array* %8, i32 0, i32 0)
  ...
  %13 = call i32 @pick(%struct.nish_array* %11, i32 %12, i32 0)
