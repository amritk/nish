...
entry:
  %good.addr = alloca %struct.sts_result.i32.i32*, align 8
  %sts_result.i32.i32.obj = alloca %struct.sts_result.i32.i32, align 8
  %bad.addr = alloca %struct.sts_result.i32.i32*, align 8
  ...
  store %struct.sts_result.i32.i32* %sts_result.i32.i32.obj, %struct.sts_result.i32.i32** %good.addr, align 8
  %7 = load %struct.sts_result.i32.i32*, %struct.sts_result.i32.i32** %good.addr, align 8
...
if.then:
  %11 = load %struct.sts_result.i32.i32*, %struct.sts_result.i32.i32** %good.addr, align 8
...
if.end:
  %15 = load %struct.sts_result.i32.i32*, %struct.sts_result.i32.i32** %good.addr, align 8
  ...
  %21 = getelementptr inbounds %struct.sts_result.i32.i32, %struct.sts_result.i32.i32* %sts_result.i32.i32.obj.1, i32 0, i32 0
  store i1 %20, i1* %21, align 1
  %22 = lshr i64 %19, 32
  %23 = trunc i64 %22 to i32
  %24 = getelementptr inbounds %struct.sts_result.i32.i32, %struct.sts_result.i32.i32* %sts_result.i32.i32.obj.1, i32 0, i32 1
  ...
  store %struct.sts_result.i32.i32* %sts_result.i32.i32.obj.1, %struct.sts_result.i32.i32** %bad.addr, align 8
  %26 = load %struct.sts_result.i32.i32*, %struct.sts_result.i32.i32** %bad.addr, align 8
  %27 = getelementptr inbounds %struct.sts_result.i32.i32, %struct.sts_result.i32.i32* %26, i32 0, i32 0
  %28 = load i1, i1* %27, align 1
  br i1 %28, label %if.then.1, label %if.end.1

if.then.1:
  %29 = load %struct.sts_result.i32.i32*, %struct.sts_result.i32.i32** %bad.addr, align 8
  %30 = getelementptr inbounds %struct.sts_result.i32.i32, %struct.sts_result.i32.i32* %29, i32 0, i32 1
  %31 = load i32, i32* %30, align 4
  %32 = call i8* @sts_str_from_i32(i32 %31)
  call void @sts_print(i8* %32)
  call void @sts_arena_release(i64 %arena.mark)
  ret i32 1

if.end.1:
  %33 = load %struct.sts_result.i32.i32*, %struct.sts_result.i32.i32** %bad.addr, align 8
  %34 = getelementptr inbounds %struct.sts_result.i32.i32, %struct.sts_result.i32.i32* %33, i32 0, i32 2
  %35 = load i32, i32* %34, align 4
  %36 = call i8* @sts_str_from_i32(i32 %35)
