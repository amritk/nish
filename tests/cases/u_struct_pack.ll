...
declare noalias noundef nonnull align 8 i8* @amrit_str_from_u64(i64 noundef) #1
...
entry:
  ...
  %bytes.addr = alloca %struct.amrit_array*, align 8
...
bounds.fail:
  call void @amrit_panic_index(i64 0, i64 %23)
  unreachable
...
bounds.fail.1:
  call void @amrit_panic_index(i64 0, i64 %31)
  unreachable
...
bounds.ok.1:
  ...
  %43 = call i8* @amrit_str_from_u64(i64 %42)
  %44 = call i8* @amrit_str_concat(i8* %43, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  ...
  %50 = call i8* @amrit_str_concat(i8* %44, i8* %49)
  %51 = call i8* @amrit_str_concat(i8* %50, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  ...
  %56 = call i8* @amrit_str_from_u64(i64 %55)
  %57 = call i8* @amrit_str_concat(i8* %51, i8* %56)
...
bounds.fail.2:
  call void @amrit_panic_index(i64 0, i64 %61)
  unreachable
