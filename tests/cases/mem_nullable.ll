...
if.then:
  ...
  %45 = call i8* @amrit_str_from_i32(i32 %44)
  call void @amrit_print(i8* %45)
  br label %if.end

if.end:
  %46 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr, i64 0, i32 0
  store i64 2, i64* %46, align 8
  %47 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr, i64 0, i32 1
  store i64 2, i64* %47, align 8
  %48 = mul i64 2, 8
  %49 = bitcast [2 x %struct.Node*]* %arr.data to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %49, i8 0, i64 %48, i1 false)
  %50 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr, i64 0, i32 2
  store i8* %49, i8** %50, align 8
  store %struct.amrit_array* %arr.hdr, %struct.amrit_array** %xs.addr, align 8
  %51 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
  %52 = load %struct.Node*, %struct.Node** %c.addr, align 8
  %53 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %51, i64 0, i32 0
  %54 = load i64, i64* %53, align 8
  %55 = icmp ult i64 1, %54
  br i1 %55, label %bounds.ok, label %bounds.fail

bounds.fail:
  call void @amrit_panic_index(i64 1, i64 %54)
  unreachable
...
bounds.ok:
  ...
  %60 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
  %61 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %60, i64 0, i32 0
  %62 = load i64, i64* %61, align 8
  %63 = icmp ult i64 0, %62
  br i1 %63, label %bounds.ok.1, label %bounds.fail.1

bounds.fail.1:
  call void @amrit_panic_index(i64 0, i64 %62)
  unreachable

bounds.ok.1:
  %64 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %60, i64 0, i32 2
  ...
  %72 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
...
bounds.fail.2:
  call void @amrit_panic_index(i64 1, i64 %74)
  unreachable
...
if.then.1:
  ...
  %86 = call i8* @amrit_str_from_i32(i32 %85)
  call void @amrit_print(i8* %86)
  br label %if.end.1
