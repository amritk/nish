...
declare void @sts_array_grow(%struct.sts_array* noundef nonnull align 8 nocapture, i64 noundef) #1
...
for.body:
  %5 = load %struct.sts_array*, %struct.sts_array** %xs.addr, align 8
  %6 = load i32, i32* %i.addr, align 4
  %7 = load i32, i32* %i.addr, align 4
  %8 = mul i32 %6, %7
  %9 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %5, i64 0, i32 0
  %10 = load i64, i64* %9, align 8
  %11 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %5, i64 0, i32 1
  %12 = load i64, i64* %11, align 8
  %13 = icmp eq i64 %10, %12
  br i1 %13, label %push.grow, label %push.store

push.grow:
  call void @sts_array_grow(%struct.sts_array* %5, i64 4)
  br label %push.store

push.store:
  %14 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %5, i64 0, i32 2
...
for.end:
  %22 = load %struct.sts_array*, %struct.sts_array** %xs.addr, align 8
  %23 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %22, i64 0, i32 0
  %24 = load i64, i64* %23, align 8
  %25 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %22, i64 0, i32 1
  %26 = load i64, i64* %25, align 8
  %27 = icmp eq i64 %24, %26
  br i1 %27, label %push.grow.1, label %push.store.1

push.grow.1:
  call void @sts_array_grow(%struct.sts_array* %22, i64 4)
  br label %push.store.1

push.store.1:
  %28 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %22, i64 0, i32 2
  ...
  %36 = load %struct.sts_array*, %struct.sts_array** %xs.addr, align 8
  %37 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %36, i64 0, i32 0
...
for.cond.1:
  ...
  %42 = load %struct.sts_array*, %struct.sts_array** %xs.addr, align 8
...
for.body.1:
  %47 = load %struct.sts_array*, %struct.sts_array** %xs.addr, align 8
  %48 = load i32, i32* %i.addr.1, align 4
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %47, i64 0, i32 0
  %51 = load i64, i64* %50, align 8
  %52 = icmp ult i64 %49, %51
  br i1 %52, label %bounds.ok, label %bounds.fail

bounds.fail:
  call void @sts_panic_index(i64 %49, i64 %51)
  unreachable

bounds.ok:
  %53 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %47, i64 0, i32 2
