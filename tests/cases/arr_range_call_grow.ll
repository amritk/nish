...
define internal noundef i32 @visit(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %xs, i32 noundef %i) #0 {
entry:
...
bounds.ok:
  ...
  %10 = icmp slt i32 %i, 10
  br i1 %10, label %if.then, label %if.end

if.then:
  %11 = add nsw i32 %i, 1
  store i32 %11, i32* %j.addr, align 4
  %12 = load i32, i32* %j.addr, align 4
  %13 = call i32 @visit(%struct.nish_array* %xs, i32 %12)
...
if.then:
  ...
  %14 = call i32 @visit(%struct.nish_array* %13, i32 0)
  br label %if.end
