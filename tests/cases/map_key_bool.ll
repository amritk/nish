%struct.Map$bool$str = type { i32, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array*, i32 }
...
define internal void @nish.Map$bool$str.constructor(%struct.Map$bool$str* noundef nonnull noalias align 8 dereferenceable(56) nocapture %this) #2 {
entry:
  ...
  %3 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 7
  ...
  %12 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 1
  ...
  %18 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 4
  ...
  %24 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 5
  ...
  %30 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 6
  store %struct.nish_array* %26, %struct.nish_array** %30, align 8, !tbaa !25
  ret void
}

define internal noundef i64 @nish.Map$bool$str.probe(%struct.Map$bool$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i1 noundef zeroext %key) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$bool$str.has(%struct.Map$bool$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i1 noundef zeroext %key) #0 {
entry:
...
define internal noundef nonnull align 8 dereferenceable(56) %struct.Map$bool$str* @nish.Map$bool$str.set(%struct.Map$bool$str* noundef nonnull align 8 dereferenceable(56) %this, i1 noundef zeroext %key, i8* noundef nonnull noalias readonly align 8 %value) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$bool$str.delete(%struct.Map$bool$str* noundef nonnull align 8 dereferenceable(56) nocapture %this, i1 noundef zeroext %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$bool$str.probe(%struct.Map$bool$str* %this, i1 %key)
  store i64 %0, i64* %found.addr, align 8
...
define internal void @nish.Map$bool$str.setValueAt(%struct.Map$bool$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index, i8* noundef nonnull noalias readonly align 8 %value) #2 {
entry:
...
if.then:
  ...
  store i8* %value, i8** %14, align 8, !alias.scope !10, !noalias !9, !tbaa !27
  br label %if.end
...
define internal void @nish.Map$bool$str.insertAt(%struct.Map$bool$str* noundef nonnull align 8 dereferenceable(56) nocapture %this, i64 noundef %absent, i1 noundef zeroext %key, i8* noundef nonnull noalias readonly align 8 %value) #0 {
entry:
...
lor.rhs:
  %16 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 7
...
if.end:
  %21 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 4
...
push.store:
  ...
  %31 = getelementptr inbounds i1, i1* %30, i64 %24
  store i1 %key, i1* %31, align 1, !alias.scope !10, !noalias !9, !tbaa !29
  %32 = add i64 %24, 1
  store i64 %32, i64* %23, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %33 = trunc i64 %32 to i32
  %34 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 5
...
push.store.1:
  ...
  store i8* %value, i8** %44, align 8, !alias.scope !10, !noalias !9, !tbaa !27
  %45 = add i64 %37, 1
  store i64 %45, i64* %36, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %46 = trunc i64 %45 to i32
  %47 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 6
...
push.store.2:
  ...
  %61 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 3
  %62 = load i32, i32* %61, align 4, !tbaa !20
  %63 = add nsw i32 %62, 1
  %64 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 3
  store i32 %63, i32* %64, align 4, !tbaa !20
  %65 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 0
  %66 = load i32, i32* %65, align 4, !tbaa !5
  %67 = add nsw i32 %66, 1
  %68 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 0
  store i32 %67, i32* %68, align 4, !tbaa !5
  %69 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 4
  ...
  %75 = mul nsw i32 %74, 4
  %76 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 1
...
if.else:
  %83 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 1
  %84 = load %struct.nish_array*, %struct.nish_array** %83, align 8, !tbaa !22
  %85 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 2
...
define internal void @nish.Map$bool$str.rebuild(%struct.Map$bool$str* noundef nonnull align 8 dereferenceable(56) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  ...
  %5 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 7
  %6 = load i32, i32* %5, align 4, !tbaa !21
  %7 = icmp sgt i32 %6, 0
  store i1 %7, i1* %walking.addr, align 1
  %8 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 1
...
cond.false:
  %12 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 3
...
land.rhs:
  %19 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 3
...
if.then:
  %24 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 4
  %25 = load %struct.nish_array*, %struct.nish_array** %24, align 8, !tbaa !23
  %26 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 6
  %27 = load %struct.nish_array*, %struct.nish_array** %26, align 8, !tbaa !25
  call void @nish.compactEntries$bool(%struct.nish_array* %25, %struct.nish_array* %27)
  %28 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 5
  ...
  %32 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 6
...
if.end:
  ...
  %35 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 1
  ...
  %40 = sub nsw i32 %39, 1
  %41 = getelementptr inbounds %struct.Map$bool$str, %struct.Map$bool$str* %this, i32 0, i32 2
...
land.rhs.1:
  ...
  %72 = load i1, i1* %71, align 1, !alias.scope !10, !noalias !9, !tbaa !29
...
if.then:
  ...
  %41 = load i1, i1* %40, align 1, !alias.scope !10, !noalias !9, !tbaa !29
  %42 = bitcast i8* %10 to i1*
  %43 = getelementptr inbounds i1, i1* %42, i64 %36
  store i1 %41, i1* %43, align 1, !alias.scope !10, !noalias !9, !tbaa !29
...
pop.ok:
  ...
  %61 = load i1, i1* %60, align 1, !alias.scope !10, !noalias !9, !tbaa !29
  br label %while.cond
...
!2 = !{!"i32", !1, i64 0}
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"Map$bool$str", !2, i64 0, !3, i64 8, !2, i64 16, !2, i64 20, !3, i64 24, !3, i64 32, !3, i64 40, !2, i64 48}
!5 = !{!4, !2, i64 0}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
!8 = !{!"elements", !6}
