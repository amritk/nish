...
entry:
  ...
  %19 = sub i64 %17, %18
  %20 = call i8* @nish_str_from_u64(i64 %19)
  %21 = call i8* @nish_str_concat(i8* %16, i8* %20)
  ...
  %31 = call i8* @nish_str_concat(i8* %26, i8* %30)
  ...
  %37 = call i8* @nish_str_concat(i8* %32, i8* %36)
