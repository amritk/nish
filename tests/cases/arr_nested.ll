...
for.body:
  ...
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %m, i64 0, i32 0
...
bounds.ok:
  %11 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %m, i64 0, i32 2
  %12 = load i8*, i8** %11, align 8, !alias.scope !3, !noalias !4
  %13 = bitcast i8* %12 to %struct.nish_array**
  %14 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %13, i64 %7
  %15 = load %struct.nish_array*, %struct.nish_array** %14, align 8, !alias.scope !4, !noalias !3
  %16 = load i32, i32* %i.addr, align 4
  %17 = sext i32 %16 to i64
  %18 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %15, i64 0, i32 0
...
for.body.1:
  ...
  %21 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %14, i64 0, i32 0
  %22 = load i64, i64* %21, align 8, !alias.scope !3, !noalias !4
  %23 = icmp ult i64 %16, %22
  br i1 %23, label %bounds.ok, label %bounds.fail

bounds.fail:
  call void @nish_panic_index(i64 %16, i64 %22)
  unreachable
...
for.end.1:
  %30 = load %struct.nish_array*, %struct.nish_array** %m.addr, align 8
  %31 = load %struct.nish_array*, %struct.nish_array** %row.addr, align 8
  %32 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %30, i64 0, i32 0
  %33 = load i64, i64* %32, align 8, !alias.scope !3, !noalias !4
  %34 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %30, i64 0, i32 1
  %35 = load i64, i64* %34, align 8, !alias.scope !3, !noalias !4
  %36 = icmp eq i64 %33, %35
  br i1 %36, label %push.grow, label %push.store

push.grow:
  call void @nish_array_grow(%struct.nish_array* %30, i64 8)
  br label %push.store

push.store:
  %37 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %30, i64 0, i32 2
  %38 = load i8*, i8** %37, align 8, !alias.scope !3, !noalias !4
  %39 = bitcast i8* %38 to %struct.nish_array**
  %40 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %39, i64 %33
  store %struct.nish_array* %31, %struct.nish_array** %40, align 8, !alias.scope !4, !noalias !3
  %41 = add i64 %33, 1
...
for.end:
  %45 = load %struct.nish_array*, %struct.nish_array** %m.addr, align 8
...
bounds.fail.1:
  call void @nish_panic_index(i64 1, i64 %47)
  unreachable
...
bounds.ok.1:
  ...
  %52 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %51, i64 1
  %53 = load %struct.nish_array*, %struct.nish_array** %52, align 8, !alias.scope !4, !noalias !3
...
bounds.ok.2:
  ...
  %62 = call i32 @trace(%struct.nish_array* %61)
  %63 = call i8* @nish_str_from_i32(i32 %62)
  call void @nish_print(i8* %63)
  %64 = load %struct.nish_array*, %struct.nish_array** %m.addr, align 8
...
bounds.ok.3:
  ...
  %71 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %70, i64 2
  %72 = load %struct.nish_array*, %struct.nish_array** %71, align 8, !alias.scope !4, !noalias !3
  ...
  %82 = call i8* @nish_alloc_struct(i64 24)
  %83 = bitcast i8* %82 to %struct.nish_array*
  ...
  %85 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %83, i64 0, i32 1
  store i64 1, i64* %85, align 8, !alias.scope !3, !noalias !4
  %86 = call i8* @nish_alloc_struct(i64 4)
  ...
  %90 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr.1, i64 0, i32 0
  store i64 2, i64* %90, align 8, !alias.scope !3, !noalias !4
  %91 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr.1, i64 0, i32 1
  store i64 2, i64* %91, align 8, !alias.scope !3, !noalias !4
  %92 = bitcast [2 x %struct.nish_array*]* %arr.data to i8*
  %93 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr.1, i64 0, i32 2
  store i8* %92, i8** %93, align 8, !alias.scope !3, !noalias !4
  %94 = bitcast i8* %92 to %struct.nish_array**
  %95 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %94, i64 0
  store %struct.nish_array* %78, %struct.nish_array** %95, align 8, !alias.scope !4, !noalias !3
  %96 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %94, i64 1
  store %struct.nish_array* %83, %struct.nish_array** %96, align 8, !alias.scope !4, !noalias !3
  store %struct.nish_array* %arr.hdr.1, %struct.nish_array** %empty.addr, align 8
  %97 = load %struct.nish_array*, %struct.nish_array** %empty.addr, align 8
...
bounds.ok.4:
  ...
  %103 = bitcast i8* %102 to %struct.nish_array**
  %104 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %103, i64 0
  %105 = load %struct.nish_array*, %struct.nish_array** %104, align 8, !alias.scope !4, !noalias !3
  ...
  %109 = call i8* @nish_str_from_i32(i32 %108)
  call void @nish_print(i8* %109)
  %110 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr.2, i64 0, i32 0
  store i64 0, i64* %110, align 8, !alias.scope !3, !noalias !4
  %111 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr.2, i64 0, i32 1
  store i64 0, i64* %111, align 8, !alias.scope !3, !noalias !4
  %112 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr.2, i64 0, i32 2
  ...
  %113 = load %struct.nish_array*, %struct.nish_array** %grid.addr, align 8
  %114 = call i8* @nish_alloc_struct(i64 24)
  %115 = bitcast i8* %114 to %struct.nish_array*
  ...
  %117 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %115, i64 0, i32 1
  store i64 2, i64* %117, align 8, !alias.scope !3, !noalias !4
  %118 = mul i64 2, 4
  %119 = call i8* @nish_alloc_struct(i64 %118)
  call void @llvm.memset.p0i8.i64(i8* align 8 %119, i8 0, i64 %118, i1 false), !alias.scope !4, !noalias !3
  %120 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %115, i64 0, i32 2
  store i8* %119, i8** %120, align 8, !alias.scope !3, !noalias !4
  %121 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %113, i64 0, i32 0
  %122 = load i64, i64* %121, align 8, !alias.scope !3, !noalias !4
  %123 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %113, i64 0, i32 1
...
push.grow.1:
  call void @nish_array_grow(%struct.nish_array* %113, i64 8)
  br label %push.store.1

push.store.1:
  %126 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %113, i64 0, i32 2
  %127 = load i8*, i8** %126, align 8, !alias.scope !3, !noalias !4
  %128 = bitcast i8* %127 to %struct.nish_array**
  %129 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %128, i64 %122
  store %struct.nish_array* %115, %struct.nish_array** %129, align 8, !alias.scope !4, !noalias !3
  %130 = add i64 %122, 1
  store i64 %130, i64* %121, align 8, !alias.scope !3, !noalias !4
  %131 = trunc i64 %130 to i32
  %132 = load %struct.nish_array*, %struct.nish_array** %grid.addr, align 8
...
bounds.ok.5:
  ...
  %138 = bitcast i8* %137 to %struct.nish_array**
  %139 = getelementptr inbounds %struct.nish_array*, %struct.nish_array** %138, i64 0
  %140 = load %struct.nish_array*, %struct.nish_array** %139, align 8, !alias.scope !4, !noalias !3
  %141 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %140, i64 0, i32 0
...
bounds.fail.6:
  call void @nish_panic_index(i64 1, i64 %142)
  unreachable

bounds.ok.6:
  %144 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %140, i64 0, i32 2
