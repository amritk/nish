...
bounds.ok:
  ...
  %15 = load %struct.amrit_array*, %struct.amrit_array** %14, align 8
...
push.store:
  ...
  store %struct.amrit_array* %31, %struct.amrit_array** %40, align 8
  %41 = add i64 %33, 1
...
bounds.ok.1:
  ...
  %53 = load %struct.amrit_array*, %struct.amrit_array** %52, align 8
...
bounds.ok.3:
  ...
  %72 = load %struct.amrit_array*, %struct.amrit_array** %71, align 8
  ...
  store %struct.amrit_array* %78, %struct.amrit_array** %95, align 8
  %96 = getelementptr inbounds %struct.amrit_array*, %struct.amrit_array** %94, i64 1
  store %struct.amrit_array* %83, %struct.amrit_array** %96, align 8
...
bounds.ok.4:
  ...
  %105 = load %struct.amrit_array*, %struct.amrit_array** %104, align 8
...
push.store.1:
  ...
  store %struct.amrit_array* %115, %struct.amrit_array** %129, align 8
  %130 = add i64 %122, 1
...
bounds.ok.5:
  ...
  %140 = load %struct.amrit_array*, %struct.amrit_array** %139, align 8
