...
declare zeroext i1 @amrit_is_dir(i8* noundef nonnull readonly align 8 nocapture) #0

define noundef i32 @amrit_main() #0 {
entry:
  %arena.mark = call i64 @amrit_arena_mark()
  %0 = call zeroext i1 @amrit_is_dir(i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %1 = select i1 %0, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %2 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.0 to i8*), i8* %1)
  call void @amrit_print(i8* %2)
  %3 = call zeroext i1 @amrit_is_dir(i8* bitcast ({ i64, [2 x i8] }* @.str.5 to i8*))
  %4 = select i1 %3, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %5 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [7 x i8] }* @.str.4 to i8*), i8* %4)
  call void @amrit_print(i8* %5)
  %6 = call zeroext i1 @amrit_is_dir(i8* bitcast ({ i64, [10 x i8] }* @.str.7 to i8*))
  ...
  %9 = call zeroext i1 @amrit_is_dir(i8* bitcast ({ i64, [19 x i8] }* @.str.9 to i8*))
  %10 = select i1 %9, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %11 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [10 x i8] }* @.str.8 to i8*), i8* %10)
