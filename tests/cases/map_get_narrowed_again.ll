...
entry:
  ...
  %5 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %6 = icmp sge i64 %5, 0
...
if.then.1:
  %11 = call i8* @nish_str_from_f64(double %9)
  call void @nish_print(i8* %11)
  br label %if.end.1

if.end.1:
  %12 = select i1 %6, double %9, double 0x4008000000000000
  store double %12, double* %b.addr, align 8
