...
for.body.1:
  ...
  store i32 %32, i32* %40, align 4, !alias.scope !4, !noalias !3, !tbaa !8
  %41 = getelementptr inbounds i32, i32* %39, i64 1
  store i32 %34, i32* %41, align 4, !alias.scope !4, !noalias !3, !tbaa !8
  ...
  %52 = load i32, i32* %51, align 4, !alias.scope !4, !noalias !3, !tbaa !8
...
bounds.ok:
  ...
  store i32 %73, i32* %80, align 4, !alias.scope !4, !noalias !3, !tbaa !8
...
push.store:
  ...
  store %struct.nish_array* %82, %struct.nish_array** %91, align 8, !alias.scope !4, !noalias !3, !tbaa !14
  %92 = add i64 %84, 1
...
bounds.ok.1:
  ...
  store i32 7, i32* %112, align 4, !alias.scope !4, !noalias !3, !tbaa !8
  ...
  %121 = load i64, i64* %120, align 8, !alias.scope !3, !noalias !4
  %122 = icmp ult i64 0, %121
  br i1 %122, label %bounds.ok.2, label %bounds.fail.2

bounds.fail.2:
  call void @nish_panic_index(i64 0, i64 %121)
  unreachable

bounds.ok.2:
  %123 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %119, i64 0, i32 2
  %124 = load i8*, i8** %123, align 8, !alias.scope !3, !noalias !4
  %125 = bitcast i8* %124 to i32*
  %126 = getelementptr inbounds i32, i32* %125, i64 0
  %127 = load i32, i32* %126, align 4, !alias.scope !4, !noalias !3, !tbaa !8
