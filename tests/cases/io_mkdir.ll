...
entry:
  ...
  %1 = call zeroext i1 @nish_mkdir(i8* %0)
  %2 = select i1 %1, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %3 = call i8* @nish_str_concat(i8* bitcast ({ i64, [8 x i8] }* @.str.1 to i8*), i8* %2)
  ...
  %7 = call i8* @nish_str_concat(i8* bitcast ({ i64, [16 x i8] }* @.str.4 to i8*), i8* %6)
  call void @nish_print(i8* %7)
  %8 = call zeroext i1 @nish_mkdir(i8* bitcast ({ i64, [33 x i8] }* @.str.6 to i8*))
  %9 = select i1 %8, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %10 = call i8* @nish_str_concat(i8* bitcast ({ i64, [12 x i8] }* @.str.5 to i8*), i8* %9)
  call void @nish_print(i8* %10)
  store i8* bitcast ({ i64, [25 x i8] }* @.str.7 to i8*), i8** %file.addr, align 8
  %11 = load i8*, i8** %file.addr, align 8
  call void @nish_write_file(i8* %11, i8* bitcast ({ i64, [17 x i8] }* @.str.8 to i8*))
  %12 = load i8*, i8** %file.addr, align 8
  %13 = call zeroext i1 @nish_mkdir(i8* %12)
  %14 = select i1 %13, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %15 = call i8* @nish_str_concat(i8* bitcast ({ i64, [14 x i8] }* @.str.9 to i8*), i8* %14)
