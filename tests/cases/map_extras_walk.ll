...
entry:
  ...
  %got.addr = alloca double, align 8
  ...
  %4 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* %4)
  %5 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %4, i32 0)
  store i32 %5, i32* %walk.idx, align 4
  br label %walk.cond

walk.cond:
  %6 = load i32, i32* %walk.idx, align 4
  %7 = icmp sge i32 %6, 0
  br i1 %7, label %walk.body, label %walk.end

walk.body:
  %8 = call i8* @nish.Map$str$f64.keyAt(%struct.Map$str$f64* %4, i32 %6)
  store i8* %8, i8** %k.addr, align 8
  %9 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @nish.Map$str$f64.reserveSlots(%struct.Map$str$f64* %9, double 0x4050000000000000)
  %10 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %11 = load i8*, i8** %k.addr, align 8
  %12 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %10, i8* %11)
  %13 = icmp sge i64 %12, 0
  br i1 %13, label %nullish.value, label %nullish.default

nullish.value:
  %14 = trunc i64 %12 to i32
  %15 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %10, i32 %14)
...
nullish.end:
  %16 = phi double [ %15, %nullish.value ], [ 0x0000000000000000, %nullish.default ]
  store double %16, double* %v.addr, align 8
  %17 = load double, double* %v.addr, align 8
  %18 = fcmp olt double %17, 0x4010000000000000
  br i1 %18, label %if.then, label %if.end

if.then:
  %19 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %20 = load i8*, i8** %k.addr, align 8
  %21 = call i8* @nish_str_concat(i8* %20, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %22 = load double, double* %v.addr, align 8
  %23 = fadd double %22, 0x3FF0000000000000
  %24 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %19, i8* %21)
  %25 = icmp sge i64 %24, 0
  br i1 %25, label %get.found, label %get.insert

get.found:
  %26 = trunc i64 %24 to i32
  %27 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %19, i32 %26)
  br label %get.end

get.insert:
  call void @nish.Map$str$f64.insertAt(%struct.Map$str$f64* %19, i64 %24, i8* %21, double %23)
  br label %get.end

get.end:
  %28 = phi double [ %27, %get.found ], [ %23, %get.insert ]
  store double %28, double* %got.addr, align 8
  %29 = load i8*, i8** %k.addr, align 8
  %30 = call i8* @nish_str_concat(i8* %29, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*))
  %31 = load double, double* %got.addr, align 8
...
if.end:
  ...
  %38 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %36, i8* %37)
  %39 = icmp sge i64 %38, 0
  br i1 %39, label %get.found.1, label %get.insert.1

get.found.1:
  %40 = trunc i64 %38 to i32
  %41 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %36, i32 %40)
  br label %get.end.1

get.insert.1:
  call void @nish.Map$str$f64.insertAt(%struct.Map$str$f64* %36, i64 %38, i8* %37, double 0x4059000000000000)
  br label %get.end.1

get.end.1:
  %42 = phi double [ %41, %get.found.1 ], [ 0x4059000000000000, %get.insert.1 ]
  %43 = call i8* @nish_str_from_f64(double %42)
  %44 = call i8* @nish_str_concat(i8* %35, i8* %43)
  call void @nish_print(i8* %44)
  br label %walk.inc

walk.inc:
  %45 = add i32 %6, 1
  %46 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %4, i32 %45)
  store i32 %46, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %4)
  %47 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
...
cond.end:
  ...
  %7 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %6, i64 0, i32 0
  %8 = load i64, i64* %7, align 8, !alias.scope !10, !noalias !11, !tbaa !15
