...
@.str.1 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c" sum \00" }, align 8
...
entry:
  ...
  %3 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %2, double 0x0000000000000000, double 0x0000000000000000)
  ...
  call void @nish.Map$f64$f64.walkOpen(%struct.Map$f64$f64* %4)
  %5 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %4, i32 0)
...
walk.body:
  %8 = call double @nish.Map$f64$f64.keyAt(%struct.Map$f64$f64* %4, i32 %6)
  store double %8, double* %k.addr, align 8
  %9 = load double, double* %visited.addr, align 8
  %10 = fadd double %9, 0x3FF0000000000000
  store double %10, double* %visited.addr, align 8
  %11 = load double, double* %sum.addr, align 8
  %12 = load double, double* %k.addr, align 8
  %13 = fadd double %11, %12
  store double %13, double* %sum.addr, align 8
  %14 = load double, double* %k.addr, align 8
  %15 = fcmp olt double %14, 0x408F380000000000
...
if.then:
  ...
  %20 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %16, double %18, double %19)
  br label %if.end
