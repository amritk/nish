%struct.sts_result.void.str = type { i1, i8* }
...
define noundef nonnull align 8 dereferenceable(16) %struct.sts_result.void.str* @checkPort(i32 noundef %port) #0 {
entry:
...
if.then:
  ...
  %2 = bitcast i8* %1 to %struct.sts_result.void.str*
  %3 = getelementptr inbounds %struct.sts_result.void.str, %struct.sts_result.void.str* %2, i32 0, i32 0
  store i1 false, i1* %3, align 1
  %4 = getelementptr inbounds %struct.sts_result.void.str, %struct.sts_result.void.str* %2, i32 0, i32 1
  store i8* bitcast ({ i64, [22 x i8] }* @.str.0 to i8*), i8** %4, align 8
  ret %struct.sts_result.void.str* %2

if.end:
  %5 = call i8* @sts_alloc_struct(i64 16)
  %6 = bitcast i8* %5 to %struct.sts_result.void.str*
  %7 = getelementptr inbounds %struct.sts_result.void.str, %struct.sts_result.void.str* %6, i32 0, i32 0
  store i1 true, i1* %7, align 1
  ret %struct.sts_result.void.str* %6
}

define noundef i32 @sts_main() #1 {
entry:
  %bad.addr = alloca %struct.sts_result.void.str*, align 8
  %arena.mark = call i64 @sts_arena_mark()
  %0 = call %struct.sts_result.void.str* @checkPort(i32 0)
  store %struct.sts_result.void.str* %0, %struct.sts_result.void.str** %bad.addr, align 8
  %1 = load %struct.sts_result.void.str*, %struct.sts_result.void.str** %bad.addr, align 8
  %2 = getelementptr inbounds %struct.sts_result.void.str, %struct.sts_result.void.str* %1, i32 0, i32 0
  %3 = load i1, i1* %2, align 1
  %4 = xor i1 %3, true
  br i1 %4, label %if.then, label %if.end

if.then:
  %5 = load %struct.sts_result.void.str*, %struct.sts_result.void.str** %bad.addr, align 8
  %6 = getelementptr inbounds %struct.sts_result.void.str, %struct.sts_result.void.str* %5, i32 0, i32 1
  %7 = load i8*, i8** %6, align 8
  call void @sts_print(i8* %7)
  br label %if.end

if.end:
  %8 = call %struct.sts_result.void.str* @checkPort(i32 443)
  %9 = getelementptr inbounds %struct.sts_result.void.str, %struct.sts_result.void.str* %8, i32 0, i32 0
  %10 = load i1, i1* %9, align 1
  br i1 %10, label %res.ok, label %res.panic

res.panic:
  call void @sts_write(i8* bitcast ({ i64, [14 x i8] }* @.str.1 to i8*), i32 2, i1 true)
  call void @sts_exit(i32 1)
  unreachable

res.ok:
  call void @sts_print(i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*))
