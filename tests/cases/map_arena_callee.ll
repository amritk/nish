...
@.str.0 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"r\00" }, align 8
@.str.1 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"k\00" }, align 8
@.str.2 = private unnamed_addr constant { i64, [8 x i8] } { i64 7, [8 x i8] c"scratch\00" }, align 8
@.str.3 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c" \00" }, align 8
@.str.4 = private unnamed_addr constant { i64, [9 x i8] } { i64 8, [9 x i8] c"scratch3\00" }, align 8
...
@.str.7 = private unnamed_addr constant { i64, [5 x i8] } { i64 4, [5 x i8] c"r4k0\00" }, align 8
@.str.8 = private unnamed_addr constant { i64, [26 x i8] } { i64 25, [26 x i8] c"Map maximum size exceeded\00" }, align 8
@.str.9 = private unnamed_addr constant { i64, [32 x i8] } { i64 31, [32 x i8] c"Map: a probe ran out of buckets\00" }, align 8
...
define internal void @fill(%struct.Map$str$i32* noundef nonnull align 8 dereferenceable(48) %m, i32 noundef %round) #0 {
entry:
...
for.body:
  %2 = call i8* @nish_str_from_i32(i32 %round)
  %3 = call i8* @nish_str_concat(i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8* %2)
  %4 = call i8* @nish_str_concat(i8* %3, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %5 = load i32, i32* %i.addr, align 4
  %6 = call i8* @nish_str_from_i32(i32 %5)
  %7 = call i8* @nish_str_concat(i8* %4, i8* %6)
  %8 = mul nsw i32 %round, 1000
  %9 = load i32, i32* %i.addr, align 4
  %10 = add nsw i32 %8, %9
  %11 = call %struct.Map$str$i32* @nish.Map$str$i32.set(%struct.Map$str$i32* %m, i8* %7, i32 %10)
  br label %for.inc
...
entry:
  ...
  %round.addr.1 = alloca i32, align 4
  %i.addr = alloca i32, align 4
...
for.body:
  ...
  call void @fill(%struct.Map$str$i32* %4, i32 %5)
  %6 = load i32, i32* %round.addr, align 4
  %7 = call i8* @nish_str_from_i32(i32 %6)
  %8 = call i8* @nish_str_concat(i8* bitcast ({ i64, [8 x i8] }* @.str.2 to i8*), i8* %7)
  store i8* %8, i8** %scratch.addr, align 8
  %9 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %10 = load i8*, i8** %scratch.addr, align 8
  %11 = load i32, i32* %round.addr, align 4
  %12 = call %struct.Map$str$i32* @nish.Map$str$i32.set(%struct.Map$str$i32* %9, i8* %10, i32 %11)
  br label %for.inc

for.inc:
  %13 = load i32, i32* %round.addr, align 4
  %14 = add nsw i32 %13, 1
  store i32 %14, i32* %round.addr, align 4
  br label %for.cond

for.end:
  store i32 0, i32* %found.addr, align 4
  store i32 0, i32* %round.addr.1, align 4
  br label %for.cond.1

for.cond.1:
  %15 = load i32, i32* %round.addr.1, align 4
...
for.cond.2:
  ...
  br i1 %18, label %for.body.2, label %for.end.2

for.body.2:
  %19 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %20 = load i32, i32* %round.addr.1, align 4
  %21 = call i8* @nish_str_from_i32(i32 %20)
  %22 = call i8* @nish_str_concat(i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8* %21)
  %23 = call i8* @nish_str_concat(i8* %22, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %24 = load i32, i32* %i.addr, align 4
  %25 = call i8* @nish_str_from_i32(i32 %24)
  %26 = call i8* @nish_str_concat(i8* %23, i8* %25)
  %27 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %19, i8* %26)
  br i1 %27, label %if.then, label %if.end

if.then:
  %28 = load i32, i32* %found.addr, align 4
  %29 = add nsw i32 %28, 1
  store i32 %29, i32* %found.addr, align 4
  br label %if.end
...
for.inc.1:
  %32 = load i32, i32* %round.addr.1, align 4
  %33 = add nsw i32 %32, 1
  store i32 %33, i32* %round.addr.1, align 4
  br label %for.cond.1

for.end.1:
  %34 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %35 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %34, i32 0, i32 0
  %36 = load i32, i32* %35, align 4, !tbaa !5
  %37 = call i8* @nish_str_from_i32(i32 %36)
  %38 = call i8* @nish_str_concat(i8* %37, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*))
  ...
  %43 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %44 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %43, i8* bitcast ({ i64, [9 x i8] }* @.str.4 to i8*))
  %45 = select i1 %44, i8* bitcast ({ i64, [5 x i8] }* @.str.5 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.6 to i8*)
  %46 = call i8* @nish_str_concat(i8* %42, i8* %45)
  %47 = call i8* @nish_str_concat(i8* %46, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*))
  %48 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %49 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %48, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*))
  %50 = select i1 %49, i8* bitcast ({ i64, [5 x i8] }* @.str.5 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.6 to i8*)
...
while.end:
  call void @nish_write(i8* bitcast ({ i64, [32 x i8] }* @.str.9 to i8*), i32 2, i1 true)
  call void @nish_exit(i32 1)
  unreachable
}
