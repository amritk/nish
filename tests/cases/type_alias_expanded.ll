...
declare noalias noundef nonnull align 8 i8* @amrit_arena_grow(i64 noundef) #5
declare noundef i64 @amrit_arena_mark() #4
declare void @amrit_arena_release(i64 noundef) #4
declare void @amrit_print(i8* noundef nonnull readonly align 8 nocapture) #4
...
define internal noundef i32 @sum(%struct.amrit_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %data) #1 {
entry:
...
forof.cond:
  ...
  %1 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %data, i64 0, i32 0
  %2 = load i64, i64* %1, align 8, !alias.scope !3, !noalias !4
  %3 = icmp ult i64 %0, %2
  br i1 %3, label %forof.body, label %forof.end

forof.body:
  %4 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %data, i64 0, i32 2
...
define internal noundef i32 @first(%struct.amrit_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %view) #2 {
entry:
  %0 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %view, i64 0, i32 0
...
cond.true:
  %4 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %view, i64 0, i32 0
  %5 = load i64, i64* %4, align 8, !alias.scope !3, !noalias !4
  %6 = icmp ult i64 0, %5
  br i1 %6, label %bounds.ok, label %bounds.fail

bounds.fail:
  call void @amrit_panic_index(i64 0, i64 %5)
  unreachable

bounds.ok:
  %7 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %view, i64 0, i32 2
...
define internal noundef nonnull align 8 dereferenceable(16) %struct.amrit_result.i32.str* @parsed(i32 noundef %n) #4 {
entry:
  %0 = icmp slt i32 %n, 0
  br i1 %0, label %if.then, label %if.end
...
if.then:
  ...
  %2 = bitcast i8* %1 to %struct.amrit_result.i32.str*
  %3 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %2, i32 0, i32 0
  store i1 false, i1* %3, align 1
  %4 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %2, i32 0, i32 2
  store i8* bitcast ({ i64, [9 x i8] }* @.str.3 to i8*), i8** %4, align 8
  ret %struct.amrit_result.i32.str* %2
...
if.end:
  ...
  %8 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %6, i32 0, i32 1
...
entry:
  ...
  %view.addr = alloca %struct.amrit_array*, align 8
  %arr.hdr.1 = alloca %struct.amrit_array, align 8
  %arr.data.1 = alloca [2 x i32], align 8
  %r.addr = alloca %struct.Sample*, align 8
  %p.addr = alloca %struct.amrit_result.i32.str*, align 8
  %arena.mark = call i64 @amrit_arena_mark()
  %0 = trunc i32 1 to i8
  %1 = trunc i32 2 to i8
  %2 = trunc i32 3 to i8
  %3 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr, i64 0, i32 0
  store i64 3, i64* %3, align 8, !alias.scope !3, !noalias !4
  %4 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr, i64 0, i32 1
  ...
  %11 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 0
  store i64 2, i64* %11, align 8, !alias.scope !3, !noalias !4
  %12 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 1
  store i64 2, i64* %12, align 8, !alias.scope !3, !noalias !4
  %13 = bitcast [2 x i32]* %arr.data.1 to i8*
  %14 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 2
  ...
  store %struct.amrit_array* %arr.hdr.1, %struct.amrit_array** %view.addr, align 8
  %18 = load %struct.amrit_array*, %struct.amrit_array** %data.addr, align 8
  %19 = call i32 @sum(%struct.amrit_array* %18)
  ...
  %24 = load %struct.amrit_array*, %struct.amrit_array** %view.addr, align 8
  %25 = call i32 @first(%struct.amrit_array* %24)
  %26 = call %struct.amrit_result.i32.str* @parsed(i32 %25)
  store %struct.amrit_result.i32.str* %26, %struct.amrit_result.i32.str** %p.addr, align 8
  %27 = load %struct.amrit_result.i32.str*, %struct.amrit_result.i32.str** %p.addr, align 8
  %28 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %27, i32 0, i32 0
  %29 = load i1, i1* %28, align 1
  br i1 %29, label %cond.true, label %cond.false

cond.true:
  %30 = load %struct.amrit_result.i32.str*, %struct.amrit_result.i32.str** %p.addr, align 8
  %31 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %30, i32 0, i32 1
