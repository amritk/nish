...
walk.inc:
  %39 = load i32, i32* %walk.idx, align 4
  %40 = add i32 %39, 1
  %41 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %10, i32 %40)
...
walk.end:
  ...
  %46 = call i8* @nish_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.0 to i8*), i8* %45)
