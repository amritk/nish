...
@.str.0 = private unnamed_addr constant { i64, [3 x i8] } { i64 2, [3 x i8] c"pi\00" }, align 8
@.str.1 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"e\00" }, align 8
...
entry:
  ...
  %3 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %2, i8* bitcast ({ i64, [3 x i8] }* @.str.0 to i8*), double 0x400A000000000000)
  %4 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %5 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [3 x i8] }* @.str.0 to i8*))
  %6 = icmp sge i64 %5, 0
  br i1 %6, label %get.found, label %get.end

get.found:
  %7 = trunc i64 %5 to i32
  %8 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %4, i32 %7)
  br label %get.end

get.end:
  %9 = phi double [ %8, %get.found ], [ 0.000000e+00, %entry ]
  %10 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %11 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %10, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %12 = icmp sge i64 %11, 0
  br i1 %12, label %get.found.1, label %get.end.1

get.found.1:
  %13 = trunc i64 %11 to i32
  %14 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %10, i32 %13)
  br label %get.end.1

get.end.1:
  %15 = phi double [ %14, %get.found.1 ], [ 0.000000e+00, %get.end ]
  %16 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %17 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %16, i8* bitcast ({ i64, [3 x i8] }* @.str.0 to i8*))
  %18 = icmp sge i64 %17, 0
  br i1 %18, label %nullish.value, label %nullish.default

nullish.value:
  %19 = trunc i64 %17 to i32
  %20 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %16, i32 %19)
...
nullish.end:
  %21 = phi double [ %20, %nullish.value ], [ 0x3FE0000000000000, %nullish.default ]
  %22 = call i8* @nish_str_from_f64(double %21)
  %23 = call i8* @nish_str_concat(i8* %22, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  %24 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %25 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %24, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %26 = icmp sge i64 %25, 0
  br i1 %26, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %27 = trunc i64 %25 to i32
  %28 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %24, i32 %27)
...
nullish.end.1:
  %29 = phi double [ %28, %nullish.value.1 ], [ 0x3FE0000000000000, %nullish.default.1 ]
  %30 = call i8* @nish_str_from_f64(double %29)
  %31 = call i8* @nish_str_concat(i8* %23, i8* %30)
  %32 = call i8* @nish_str_concat(i8* %31, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
...
cond.end:
  %33 = phi double [ %9, %cond.true ], [ 0x0000000000000000, %cond.false ]
  %34 = call i8* @nish_str_from_f64(double %33)
  %35 = call i8* @nish_str_concat(i8* %32, i8* %34)
  %36 = call i8* @nish_str_concat(i8* %35, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  %37 = xor i1 %12, true
  %38 = select i1 %37, i8* bitcast ({ i64, [5 x i8] }* @.str.3 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.4 to i8*)
  %39 = call i8* @nish_str_concat(i8* %36, i8* %38)
