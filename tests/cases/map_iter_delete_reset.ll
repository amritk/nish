...
@.str.1 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"y\00" }, align 8
@.str.2 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"z\00" }, align 8
@.str.3 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c" \00" }, align 8
@.str.4 = private unnamed_addr constant { i64, [8 x i8] } { i64 7, [8 x i8] c"visits \00" }, align 8
...
entry:
  ...
  %visits.addr = alloca double, align 8
  ...
  store double 0x0000000000000000, double* %visits.addr, align 8
...
walk.body:
  ...
  %11 = load double, double* %visits.addr, align 8
  %12 = fadd double %11, 0x3FF0000000000000
  store double %12, double* %visits.addr, align 8
  ...
  %16 = load i8*, i8** %k.addr, align 8
  %17 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %15, i8* %16)
  %18 = icmp sge i64 %17, 0
  br i1 %18, label %nullish.value, label %nullish.default

nullish.value:
  %19 = trunc i64 %17 to i32
  %20 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %15, i32 %19)
...
nullish.end:
  ...
  %23 = call i8* @nish_str_concat(i8* %14, i8* %22)
  call void @nish_print(i8* %23)
  %24 = load i8*, i8** %k.addr, align 8
  %25 = call zeroext i1 @nish_str_eq(i8* %24, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  br i1 %25, label %land.rhs, label %land.end

land.rhs:
  %26 = load double, double* %visits.addr, align 8
  %27 = fcmp oeq double %26, 0x3FF0000000000000
  br label %land.end

land.end:
  %28 = phi i1 [ false, %nullish.end ], [ %27, %land.rhs ]
  br i1 %28, label %if.then, label %if.end

if.then:
  %29 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %30 = call i1 @nish.Map$str$f64.delete(%struct.Map$str$f64* %29, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %31 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %32 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %31, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), double 0x4059000000000000)
  br label %if.end
...
walk.inc:
  %33 = load i32, i32* %walk.idx, align 4
  %34 = add i32 %33, 1
  %35 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %6, i32 %34)
  store i32 %35, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %6)
  %36 = load double, double* %visits.addr, align 8
  %37 = call i8* @nish_str_from_f64(double %36)
  %38 = call i8* @nish_str_concat(i8* bitcast ({ i64, [8 x i8] }* @.str.4 to i8*), i8* %37)
...
if.then:
  ...
  store i32 16777216, i32* %17, align 4, !alias.scope !4, !noalias !3, !tbaa !13
  br label %if.end
...
if.then.1:
  ...
  store i32 0, i32* %32, align 4, !alias.scope !4, !noalias !3, !tbaa !13
  br label %if.end.1
...
define internal noundef zeroext i1 @nish.Map$str$f64.delete(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) nocapture %this, i8* noundef nonnull noalias readonly align 8 %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %this, i8* %key)
  store i64 %0, i64* %found.addr, align 8
...
if.end:
  %3 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 1
  ...
  %10 = sub nsw i32 %9, 1
  %11 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 3
  store i32 %10, i32* %11, align 4, !tbaa !21
  %12 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 0
  %13 = load double, double* %12, align 8, !tbaa !19
  %14 = fsub double %13, 0x3FF0000000000000
  %15 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 0
  store double %14, double* %15, align 8, !tbaa !19
  ret i1 true
}

define internal void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) nocapture %this) #2 {
entry:
...
define internal noundef i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %from) #3 {
entry:
...
define internal void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %this, i32 0, i32 7
  %1 = load i32, i32* %0, align 4, !tbaa !22
  %2 = sub nsw i32 %1, 1
...
bounds.ok:
  ...
  %19 = load i8*, i8** %18, align 8, !alias.scope !4, !noalias !3, !tbaa !28
  ret i8* %19
}
