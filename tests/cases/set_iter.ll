...
entry:
  ...
  %5 = call %struct.Set$str* @nish.Set$str.add(%struct.Set$str* %4, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*))
  %6 = call %struct.Set$str* @nish.Set$str.add(%struct.Set$str* %5, i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*))
  %7 = load %struct.Set$str*, %struct.Set$str** %s.addr, align 8
  %8 = call i1 @nish.Set$str.delete(%struct.Set$str* %7, i8* bitcast ({ i64, [6 x i8] }* @.str.1 to i8*))
  %9 = load %struct.Set$str*, %struct.Set$str** %s.addr, align 8
  %10 = call %struct.Set$str* @nish.Set$str.add(%struct.Set$str* %9, i8* bitcast ({ i64, [6 x i8] }* @.str.1 to i8*))
  %11 = load %struct.Set$str*, %struct.Set$str** %s.addr, align 8
  call void @nish.Set$str.walkOpen(%struct.Set$str* %11)
  %12 = call i32 @nish.Set$str.walkNext(%struct.Set$str* %11, i32 0)
...
walk.body:
  %15 = call i8* @nish.Set$str.keyAt(%struct.Set$str* %11, i32 %13)
  store i8* %15, i8** %x.addr, align 8
...
walk.end:
  call void @nish.Set$str.walkClose(%struct.Set$str* %11)
...
define internal noundef zeroext i1 @nish.Set$str.delete(%struct.Set$str* noundef nonnull align 8 dereferenceable(48) nocapture %this, i8* noundef nonnull noalias readonly align 8 %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Set$str.probe(%struct.Set$str* %this, i8* %key)
  store i64 %0, i64* %found.addr, align 8
...
if.end:
  %3 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 1
  ...
  %8 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 3
  ...
  %12 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 0
  %13 = load double, double* %12, align 8, !tbaa !19
  %14 = fsub double %13, 0x3FF0000000000000
  %15 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 0
  store double %14, double* %15, align 8, !tbaa !19
  ret i1 true
}

define internal void @nish.Set$str.walkOpen(%struct.Set$str* noundef nonnull align 8 dereferenceable(48) nocapture %this) #2 {
entry:
...
define internal void @nish.Set$str.walkClose(%struct.Set$str* noundef nonnull align 8 dereferenceable(48) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Set$str, %struct.Set$str* %this, i32 0, i32 6
  %1 = load i32, i32* %0, align 4, !tbaa !22
  %2 = sub nsw i32 %1, 1
...
bounds.ok:
  ...
  %19 = load i8*, i8** %18, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  ret i8* %19
}
...
push.store:
  ...
  store i8* %key, i8** %32, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %33 = add i64 %25, 1
