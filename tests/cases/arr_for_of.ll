...
entry:
  ...
  store i32 500, i32* %9, align 4, !alias.scope !4, !noalias !3, !tbaa !13
  ...
  store i64 2, i64* %13, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %14 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr.1, i64 0, i32 1
  store i64 2, i64* %14, align 8, !alias.scope !3, !noalias !4, !tbaa !14
  ...
  store i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i8** %18, align 8, !alias.scope !4, !noalias !3, !tbaa !16
  %19 = getelementptr inbounds i8*, i8** %17, i64 1
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %19, align 8, !alias.scope !4, !noalias !3, !tbaa !16
  store i64 0, i64* %forof.idx, align 8
  br label %forof.cond
...
forof.body:
  ...
  %28 = load i8*, i8** %27, align 8, !alias.scope !4, !noalias !3, !tbaa !16
