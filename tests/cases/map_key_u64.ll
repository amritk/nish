%struct.Map$u64$i32 = type { i32, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array*, i32 }
...
entry:
  ...
  %7 = call i8* @nish_alloc_struct(i64 56)
...
define internal void @nish.Map$u64$i32.constructor(%struct.Map$u64$i32* noundef nonnull noalias align 8 dereferenceable(56) nocapture %this) #2 {
entry:
  ...
  %3 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 7
  ...
  %12 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 1
  ...
  %18 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 4
  ...
  %24 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 5
  ...
  %30 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 6
  store %struct.nish_array* %26, %struct.nish_array** %30, align 8, !tbaa !25
  ret void
}

define internal noundef i64 @nish.Map$u64$i32.probe(%struct.Map$u64$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i64 noundef %key) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$u64$i32.has(%struct.Map$u64$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i64 noundef %key) #0 {
entry:
...
define internal noundef nonnull align 8 dereferenceable(56) %struct.Map$u64$i32* @nish.Map$u64$i32.set(%struct.Map$u64$i32* noundef nonnull align 8 dereferenceable(56) %this, i64 noundef %key, i32 noundef %value) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$u64$i32.delete(%struct.Map$u64$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this, i64 noundef %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$u64$i32.probe(%struct.Map$u64$i32* %this, i64 %key)
  store i64 %0, i64* %found.addr, align 8
...
define internal void @nish.Map$u64$i32.insertAt(%struct.Map$u64$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this, i64 noundef %absent, i64 noundef %key, i32 noundef %value) #0 {
entry:
...
lor.rhs:
  %16 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 7
...
if.end:
  %21 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 4
...
push.store:
  ...
  %33 = trunc i64 %32 to i32
  %34 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 5
...
push.store.1:
  ...
  %47 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 6
...
push.store.2:
  ...
  %61 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 3
  ...
  %67 = add nsw i32 %66, 1
  %68 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 0
  store i32 %67, i32* %68, align 4, !tbaa !5
  %69 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 4
  ...
  %75 = mul nsw i32 %74, 4
  %76 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 1
...
if.else:
  %83 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 1
  %84 = load %struct.nish_array*, %struct.nish_array** %83, align 8, !tbaa !22
  %85 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 2
...
entry:
  ...
  %5 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 7
  %6 = load i32, i32* %5, align 4, !tbaa !21
  %7 = icmp sgt i32 %6, 0
  store i1 %7, i1* %walking.addr, align 1
  %8 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 1
...
cond.false:
  %12 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 3
...
land.rhs:
  %19 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 3
...
if.then:
  %24 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 4
  %25 = load %struct.nish_array*, %struct.nish_array** %24, align 8, !tbaa !23
  %26 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 6
  %27 = load %struct.nish_array*, %struct.nish_array** %26, align 8, !tbaa !25
  call void @nish.compactEntries$u64(%struct.nish_array* %25, %struct.nish_array* %27)
  %28 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 5
  ...
  %32 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 6
...
if.end:
  ...
  %35 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 1
  ...
  %40 = sub nsw i32 %39, 1
  %41 = getelementptr inbounds %struct.Map$u64$i32, %struct.Map$u64$i32* %this, i32 0, i32 2
...
!2 = !{!"i32", !1, i64 0}
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"Map$u64$i32", !2, i64 0, !3, i64 8, !2, i64 16, !2, i64 20, !3, i64 24, !3, i64 32, !3, i64 40, !2, i64 48}
!5 = !{!4, !2, i64 0}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
!8 = !{!"elements", !6}
