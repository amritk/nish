...
entry:
  ...
  %3 = sub nsw i32 0, 7
  %4 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %2, i32 3, i32 %3)
  %5 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %6 = call i64 @nish.Map$i32$i32.probe(%struct.Map$i32$i32* %5, i32 3)
  %7 = icmp sge i64 %6, 0
  br i1 %7, label %get.found, label %get.end

get.found:
  %8 = trunc i64 %6 to i32
  %9 = call i32 @nish.Map$i32$i32.valueAt(%struct.Map$i32$i32* %5, i32 %8)
  br label %get.end

get.end:
  %10 = phi i32 [ %9, %get.found ], [ 0, %entry ]
  %11 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %12 = call i64 @nish.Map$i32$i32.probe(%struct.Map$i32$i32* %11, i32 4)
  %13 = icmp sge i64 %12, 0
  br i1 %13, label %get.found.1, label %get.end.1

get.found.1:
  %14 = trunc i64 %12 to i32
  %15 = call i32 @nish.Map$i32$i32.valueAt(%struct.Map$i32$i32* %11, i32 %14)
  br label %get.end.1

get.end.1:
  %16 = phi i32 [ %15, %get.found.1 ], [ 0, %get.end ]
  %17 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %18 = call i64 @nish.Map$i32$i32.probe(%struct.Map$i32$i32* %17, i32 3)
  %19 = icmp sge i64 %18, 0
  br i1 %19, label %nullish.value, label %nullish.default

nullish.value:
  %20 = trunc i64 %18 to i32
  %21 = call i32 @nish.Map$i32$i32.valueAt(%struct.Map$i32$i32* %17, i32 %20)
...
nullish.end:
  %22 = phi i32 [ %21, %nullish.value ], [ 0, %nullish.default ]
  %23 = call i8* @nish_str_from_i32(i32 %22)
  %24 = call i8* @nish_str_concat(i8* %23, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %25 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %m.addr, align 8
  %26 = call i64 @nish.Map$i32$i32.probe(%struct.Map$i32$i32* %25, i32 4)
  %27 = icmp sge i64 %26, 0
  br i1 %27, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %28 = trunc i64 %26 to i32
  %29 = call i32 @nish.Map$i32$i32.valueAt(%struct.Map$i32$i32* %25, i32 %28)
...
nullish.end.1:
  %30 = phi i32 [ %29, %nullish.value.1 ], [ 0, %nullish.default.1 ]
  %31 = call i8* @nish_str_from_i32(i32 %30)
  %32 = call i8* @nish_str_concat(i8* %24, i8* %31)
...
cond.end:
  %34 = phi i32 [ %10, %cond.true ], [ 0, %cond.false ]
