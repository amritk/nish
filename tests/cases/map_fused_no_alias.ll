...
define internal void @bump(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %m, i8* noundef nonnull noalias readonly align 8 %k) #0 {
entry:
  %n.addr = alloca %struct.Map$str$f64*, align 8
  store %struct.Map$str$f64* %m, %struct.Map$str$f64** %n.addr, align 8
  %0 = load %struct.Map$str$f64*, %struct.Map$str$f64** %n.addr, align 8
  %1 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %m, i8* %k)
  %2 = icmp sge i64 %1, 0
  br i1 %2, label %nullish.value, label %nullish.default

nullish.value:
  %3 = trunc i64 %1 to i32
  %4 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %m, i32 %3)
...
nullish.end:
  %5 = phi double [ %4, %nullish.value ], [ 0x0000000000000000, %nullish.default ]
  %6 = fadd double %5, 0x3FF0000000000000
  %7 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %0, i8* %k, double %6)
  ret void
}
...
entry:
  ...
  call void @bump(%struct.Map$str$f64* %2, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %3 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @bump(%struct.Map$str$f64* %3, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %4 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @bump(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
...
nullish.end:
  ...
  %15 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %14, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %16 = icmp sge i64 %15, 0
  br i1 %16, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %17 = trunc i64 %15 to i32
  %18 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %14, i32 %17)
  br label %nullish.end.1

nullish.default.1:
  %19 = fneg double 0x3FF0000000000000
  br label %nullish.end.1

nullish.end.1:
  %20 = phi double [ %18, %nullish.value.1 ], [ %19, %nullish.default.1 ]
  %21 = call i8* @nish_str_from_f64(double %20)
  %22 = call i8* @nish_str_concat(i8* %13, i8* %21)
  ...
  %28 = call i8* @nish_str_concat(i8* %23, i8* %27)
