...
entry:
  ...
  store i8* bitcast ({ i64, [3 x i8] }* @.str.1 to i8*), i8** %6, align 8
  %7 = getelementptr inbounds i8*, i8** %4, i64 2
  store i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*), i8** %7, align 8
  ...
  %8 = load %struct.amrit_array*, %struct.amrit_array** %parts.addr, align 8
...
forof.body:
  ...
  %19 = call i8* @amrit_str_concat(i8* %18, i8* bitcast ({ i64, [2 x i8] }* @.str.4 to i8*))
...
for.body:
  ...
  %25 = call i8* @amrit_str_concat(i8* %24, i8* bitcast ({ i64, [2 x i8] }* @.str.5 to i8*))
...
for.end:
  ...
  %35 = call i8* @amrit_str_concat(i8* %34, i8* bitcast ({ i64, [2 x i8] }* @.str.6 to i8*))
