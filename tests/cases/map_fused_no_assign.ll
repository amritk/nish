...
define internal noundef double @step(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %m, i8* noundef nonnull noalias readonly align 8 %k, double noundef %i) #0 {
entry:
  %at.addr = alloca double, align 8
  store double %i, double* %at.addr, align 8
...
nullish.end:
  ...
  %5 = load double, double* %at.addr, align 8
  %6 = fadd double %5, 0x3FF0000000000000
  store double %6, double* %at.addr, align 8
  %7 = fadd double %4, %5
  %8 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %m, i8* %k, double %7)
  %9 = load double, double* %at.addr, align 8
  ret double %9
}
...
entry:
  ...
  %3 = call double @step(%struct.Map$str$f64* %2, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), double 0x4014000000000000)
  ...
  %6 = call double @step(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), double %5)
  store double %6, double* %b.addr, align 8
  %7 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %8 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %7, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %9 = icmp sge i64 %8, 0
  br i1 %9, label %nullish.value, label %nullish.default

nullish.value:
  %10 = trunc i64 %8 to i32
  %11 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %7, i32 %10)
  br label %nullish.end

nullish.default:
  %12 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %13 = phi double [ %11, %nullish.value ], [ %12, %nullish.default ]
  %14 = call i8* @nish_str_from_f64(double %13)
  %15 = call i8* @nish_str_concat(i8* %14, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %16 = load double, double* %a.addr, align 8
  %17 = call i8* @nish_str_from_f64(double %16)
  %18 = call i8* @nish_str_concat(i8* %15, i8* %17)
