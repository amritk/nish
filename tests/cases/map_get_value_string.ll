%struct.Map$i32$str = type { i32, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array* }
...
entry:
  %m.addr = alloca %struct.Map$i32$str*, align 8
  %arena.mark = call i64 @nish_arena_mark()
  %0 = call i8* @nish_alloc_struct(i64 48)
  %1 = bitcast i8* %0 to %struct.Map$i32$str*
  call void @nish.Map$i32$str.constructor(%struct.Map$i32$str* %1)
  store %struct.Map$i32$str* %1, %struct.Map$i32$str** %m.addr, align 8
  %2 = load %struct.Map$i32$str*, %struct.Map$i32$str** %m.addr, align 8
  %3 = call %struct.Map$i32$str* @nish.Map$i32$str.set(%struct.Map$i32$str* %2, i32 1, i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*))
  %4 = call %struct.Map$i32$str* @nish.Map$i32$str.set(%struct.Map$i32$str* %3, i32 2, i8* bitcast ({ i64, [1 x i8] }* @.str.1 to i8*))
  %5 = load %struct.Map$i32$str*, %struct.Map$i32$str** %m.addr, align 8
  %6 = call i64 @nish.Map$i32$str.probe(%struct.Map$i32$str* %5, i32 1)
  %7 = icmp sge i64 %6, 0
  br i1 %7, label %get.found, label %get.end

get.found:
  %8 = trunc i64 %6 to i32
  %9 = call i8* @nish.Map$i32$str.valueAt(%struct.Map$i32$str* %5, i32 %8)
  br label %get.end

get.end:
  %10 = phi i8* [ %9, %get.found ], [ null, %entry ]
...
if.then:
  ...
  %15 = call i8* @nish_str_concat(i8* %14, i8* bitcast ({ i64, [3 x i8] }* @.str.2 to i8*))
  %16 = load %struct.Map$i32$str*, %struct.Map$i32$str** %m.addr, align 8
  %17 = call i64 @nish.Map$i32$str.probe(%struct.Map$i32$str* %16, i32 2)
  %18 = icmp sge i64 %17, 0
  br i1 %18, label %nullish.value, label %nullish.default

nullish.value:
  %19 = trunc i64 %17 to i32
  %20 = call i8* @nish.Map$i32$str.valueAt(%struct.Map$i32$str* %16, i32 %19)
...
nullish.end:
  %21 = phi i8* [ %20, %nullish.value ], [ bitcast ({ i64, [5 x i8] }* @.str.3 to i8*), %nullish.default ]
  %22 = call i8* @nish_str_concat(i8* %15, i8* %21)
  %23 = call i8* @nish_str_concat(i8* %22, i8* bitcast ({ i64, [4 x i8] }* @.str.4 to i8*))
  %24 = load %struct.Map$i32$str*, %struct.Map$i32$str** %m.addr, align 8
  %25 = call i64 @nish.Map$i32$str.probe(%struct.Map$i32$str* %24, i32 3)
  %26 = icmp sge i64 %25, 0
  br i1 %26, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %27 = trunc i64 %25 to i32
  %28 = call i8* @nish.Map$i32$str.valueAt(%struct.Map$i32$str* %24, i32 %27)
...
nullish.end.1:
  %29 = phi i8* [ %28, %nullish.value.1 ], [ bitcast ({ i64, [5 x i8] }* @.str.3 to i8*), %nullish.default.1 ]
  %30 = call i8* @nish_str_concat(i8* %23, i8* %29)
  %31 = call i8* @nish_str_concat(i8* %30, i8* bitcast ({ i64, [2 x i8] }* @.str.5 to i8*))
...
define internal void @nish.Map$i32$str.constructor(%struct.Map$i32$str* noundef nonnull noalias align 8 dereferenceable(48) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 0
  store i32 0, i32* %0, align 4, !tbaa !18
  %1 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !19
  %2 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 3
  ...
  %11 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 1
  ...
  %17 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 4
  ...
  %23 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 5
  ...
  %29 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 6
  store %struct.nish_array* %25, %struct.nish_array** %29, align 8, !tbaa !24
  ret void
}

define internal noundef i64 @nish.Map$i32$str.probe(%struct.Map$i32$str* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %key) #0 {
entry:
  %0 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !21
  %2 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !19
  %4 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 6
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !24
  %6 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 4
...
define internal noundef nonnull align 8 dereferenceable(48) %struct.Map$i32$str* @nish.Map$i32$str.set(%struct.Map$i32$str* noundef nonnull align 8 dereferenceable(48) %this, i32 noundef %key, i8* noundef nonnull noalias readonly align 8 %value) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$i32$str.probe(%struct.Map$i32$str* %this, i32 %key)
...
if.then:
  ...
  call void @nish.Map$i32$str.setValueAt(%struct.Map$i32$str* %this, i32 %4, i8* %value)
  br label %if.end

if.else:
  %5 = load i64, i64* %found.addr, align 8
  call void @nish.Map$i32$str.insertAt(%struct.Map$i32$str* %this, i64 %5, i32 %key, i8* %value)
  br label %if.end

if.end:
  ret %struct.Map$i32$str* %this
}

define internal noundef nonnull align 8 i8* @nish.Map$i32$str.valueAt(%struct.Map$i32$str* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index) #0 {
entry:
  %0 = icmp slt i32 %index, 0
  br i1 %0, label %lor.end, label %lor.rhs

lor.rhs:
  %1 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 5
...
if.end:
  %8 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 5
...
bounds.ok:
  ...
  %18 = load i8*, i8** %17, align 8, !alias.scope !4, !noalias !3, !tbaa !26
  ret i8* %18
}

define internal void @nish.Map$i32$str.setValueAt(%struct.Map$i32$str* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index, i8* noundef nonnull noalias readonly align 8 %value) #2 {
entry:
...
if.then:
  ...
  store i8* %value, i8** %14, align 8, !alias.scope !4, !noalias !3, !tbaa !26
  br label %if.end
...
define internal void @nish.Map$i32$str.insertAt(%struct.Map$i32$str* noundef nonnull align 8 dereferenceable(48) nocapture %this, i64 noundef %absent, i32 noundef %key, i8* noundef nonnull noalias readonly align 8 %value) #0 {
entry:
  ...
  %7 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 4
...
if.then:
  %13 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 3
...
if.end.1:
  call void @nish.Map$i32$str.rebuild(%struct.Map$i32$str* %this)
  %16 = sub nsw i32 0, 1
...
push.store:
  ...
  %30 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 5
...
push.store.1:
  ...
  store i8* %value, i8** %40, align 8, !alias.scope !4, !noalias !3, !tbaa !26
  %41 = add i64 %33, 1
  store i64 %41, i64* %32, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %42 = trunc i64 %41 to i32
  %43 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 6
...
push.store.2:
  ...
  %57 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 3
  %58 = load i32, i32* %57, align 4, !tbaa !20
  %59 = add nsw i32 %58, 1
  %60 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 3
  store i32 %59, i32* %60, align 4, !tbaa !20
  %61 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 0
  %62 = load i32, i32* %61, align 4, !tbaa !18
  %63 = add nsw i32 %62, 1
  %64 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 0
  store i32 %63, i32* %64, align 4, !tbaa !18
  %65 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 4
  ...
  %71 = mul nsw i32 %70, 4
  %72 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 1
...
if.else:
  %79 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 1
  %80 = load %struct.nish_array*, %struct.nish_array** %79, align 8, !tbaa !21
  %81 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 2
...
define internal void @nish.Map$i32$str.rebuild(%struct.Map$i32$str* noundef nonnull align 8 dereferenceable(48) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  %slots.addr = alloca %struct.nish_array*, align 8
  %0 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 4
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !22
  %2 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %1, i64 0, i32 0
  %3 = load i64, i64* %2, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %4 = trunc i64 %3 to i32
  store i32 %4, i32* %used.addr, align 4
  %5 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 1
  %6 = load %struct.nish_array*, %struct.nish_array** %5, align 8, !tbaa !21
  %7 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 3
  ...
  %11 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 3
...
if.then:
  %15 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 4
  %16 = load %struct.nish_array*, %struct.nish_array** %15, align 8, !tbaa !22
  %17 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 6
  ...
  %19 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 5
  %20 = load %struct.nish_array*, %struct.nish_array** %19, align 8, !tbaa !23
  %21 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 6
  ...
  %23 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 6
...
if.end:
  ...
  %26 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 1
  ...
  %31 = sub nsw i32 %30, 1
  %32 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 2
  store i32 %31, i32* %32, align 4, !tbaa !19
  %33 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %34 = getelementptr inbounds %struct.Map$i32$str, %struct.Map$i32$str* %this, i32 0, i32 6
...
!15 = !{!"i32", !6, i64 0}
!16 = !{!"ptr", !6, i64 0}
!17 = !{!"Map$i32$str", !15, i64 0, !16, i64 8, !15, i64 16, !15, i64 20, !16, i64 24, !16, i64 32, !16, i64 40}
!18 = !{!17, !15, i64 0}
!19 = !{!17, !15, i64 16}
!20 = !{!17, !15, i64 20}
!21 = !{!17, !16, i64 8}
