...
@.str.0 = private unnamed_addr constant { i64, [28 x i8] } { i64 27, [28 x i8] c"Set: no entry at this index\00" }, align 8
@.str.1 = private unnamed_addr constant { i64, [26 x i8] } { i64 25, [26 x i8] c"Set maximum size exceeded\00" }, align 8
...
entry:
  ...
  store double 0x4014000000000000, double* %i.addr, align 8
  br label %for.cond

for.cond:
  %2 = load double, double* %i.addr, align 8
  %3 = fcmp ogt double %2, 0x0000000000000000
  br i1 %3, label %for.body, label %for.end

for.body:
  %4 = load %struct.Set$f64*, %struct.Set$f64** %s.addr, align 8
  %5 = load double, double* %i.addr, align 8
  %6 = fmul double %5, 0x4008000000000000
  %7 = call %struct.Set$f64* @nish.Set$f64.add(%struct.Set$f64* %4, double %6)
  br label %for.inc

for.inc:
  %8 = load double, double* %i.addr, align 8
  %9 = fsub double %8, 0x3FF0000000000000
  store double %9, double* %i.addr, align 8
  br label %for.cond

for.end:
  %10 = load %struct.Set$f64*, %struct.Set$f64** %s.addr, align 8
  %11 = call i1 @nish.Set$f64.delete(%struct.Set$f64* %10, double 0x4022000000000000)
  %12 = load %struct.Set$f64*, %struct.Set$f64** %s.addr, align 8
  %13 = call %struct.Set$f64* @nish.Set$f64.add(%struct.Set$f64* %12, double 0x4022000000000000)
  %14 = load %struct.Set$f64*, %struct.Set$f64** %s.addr, align 8
  call void @nish.Set$f64.walkOpen(%struct.Set$f64* %14)
  %15 = call i32 @nish.Set$f64.walkNext(%struct.Set$f64* %14, i32 0)
  store i32 %15, i32* %walk.idx, align 4
  br label %walk.cond

walk.cond:
  %16 = load i32, i32* %walk.idx, align 4
  %17 = icmp sge i32 %16, 0
  br i1 %17, label %walk.body, label %walk.end

walk.body:
  %18 = call double @nish.Set$f64.keyAt(%struct.Set$f64* %14, i32 %16)
...
walk.end:
  call void @nish.Set$f64.walkClose(%struct.Set$f64* %14)
...
define internal void @nish.Set$f64.constructor(%struct.Set$f64* noundef nonnull noalias align 8 dereferenceable(48) nocapture %this) #2 {
entry:
...
define internal noundef zeroext i1 @nish.Set$f64.delete(%struct.Set$f64* noundef nonnull align 8 dereferenceable(48) nocapture %this, double noundef %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Set$f64.probe(%struct.Set$f64* %this, double %key)
  store i64 %0, i64* %found.addr, align 8
...
if.end:
  %3 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 1
  %4 = load %struct.nish_array*, %struct.nish_array** %3, align 8, !tbaa !23
  %5 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 5
  ...
  %8 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 3
  %9 = load i32, i32* %8, align 4, !tbaa !21
  %10 = sub nsw i32 %9, 1
  %11 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 3
  store i32 %10, i32* %11, align 4, !tbaa !21
  %12 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 0
  %13 = load double, double* %12, align 8, !tbaa !19
  %14 = fsub double %13, 0x3FF0000000000000
  %15 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 0
  store double %14, double* %15, align 8, !tbaa !19
  ret i1 true
}

define internal void @nish.Set$f64.walkOpen(%struct.Set$f64* noundef nonnull align 8 dereferenceable(48) nocapture %this) #2 {
entry:
...
define internal void @nish.Set$f64.walkClose(%struct.Set$f64* noundef nonnull align 8 dereferenceable(48) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 6
  %1 = load i32, i32* %0, align 4, !tbaa !22
  %2 = sub nsw i32 %1, 1
...
push.store:
  ...
  store double %key, double* %32, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %33 = add i64 %25, 1
  store i64 %33, i64* %24, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %34 = sitofp i64 %33 to double
  %35 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 5
...
push.store.1:
  ...
  %49 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 3
  %50 = load i32, i32* %49, align 4, !tbaa !21
  %51 = add nsw i32 %50, 1
  %52 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 3
  store i32 %51, i32* %52, align 4, !tbaa !21
  %53 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 0
  %54 = load double, double* %53, align 8, !tbaa !19
  %55 = fadd double %54, 0x3FF0000000000000
  %56 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 0
  store double %55, double* %56, align 8, !tbaa !19
  %57 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 4
  ...
  %64 = mul nsw i32 %63, 4
  %65 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 1
...
if.else:
  %73 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 1
  %74 = load %struct.nish_array*, %struct.nish_array** %73, align 8, !tbaa !23
  %75 = getelementptr inbounds %struct.Set$f64, %struct.Set$f64* %this, i32 0, i32 2
...
land.rhs.3:
  ...
  %69 = load i32, i32* %68, align 4, !alias.scope !4, !noalias !3, !tbaa !13
...
land.rhs.1:
  ...
  %82 = load double, double* %81, align 8, !alias.scope !4, !noalias !3, !tbaa !27
...
!16 = !{!"ptr", !6, i64 0}
!17 = !{!"i32", !6, i64 0}
!18 = !{!"Set$f64", !15, i64 0, !16, i64 8, !17, i64 16, !17, i64 20, !16, i64 24, !16, i64 32, !17, i64 40}
!19 = !{!18, !15, i64 0}
!20 = !{!18, !17, i64 16}
!21 = !{!18, !17, i64 20}
!22 = !{!18, !17, i64 40}
