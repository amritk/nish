...
if.end:
  ...
  %29 = load i64, i64* %28, align 8, !alias.scope !13, !noalias !14, !tbaa !18
  %30 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %27, i64 0, i32 2
  %31 = load i8*, i8** %30, align 8, !alias.scope !13, !noalias !14, !tbaa !20
  br label %for.cond
...
bounds.ok:
  ...
  store %struct.ArrayTree* %37, %struct.ArrayTree** %42, align 8, !alias.scope !14, !noalias !13, !tbaa !22
  br label %for.inc
