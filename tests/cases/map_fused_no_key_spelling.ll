...
@.str.1 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"q\00" }, align 8
...
define internal void @count(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %m, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %words) #0 {
entry:
...
bounds.ok:
  ...
  store i8* %15, i8** %j.addr, align 8
  %16 = load i8*, i8** %w.addr, align 8
  %17 = load double, double* %i.addr, align 8
  %18 = fptosi double %17 to i64
  %19 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 0
...
bounds.ok.1:
  %22 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 2
  %23 = load i8*, i8** %22, align 8, !alias.scope !3, !noalias !4, !tbaa !11
  %24 = bitcast i8* %23 to i8**
  %25 = getelementptr inbounds i8*, i8** %24, i64 %18
  %26 = load i8*, i8** %25, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %27 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %m, i8* %26)
  %28 = icmp sge i64 %27, 0
  br i1 %28, label %nullish.value, label %nullish.default

nullish.value:
  %29 = trunc i64 %27 to i32
  %30 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %m, i32 %29)
...
nullish.end:
  %31 = phi double [ %30, %nullish.value ], [ 0x0000000000000000, %nullish.default ]
  %32 = fadd double %31, 0x3FF0000000000000
  %33 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %m, i8* %16, double %32)
  %34 = load i8*, i8** %j.addr, align 8
  %35 = load i8*, i8** %w.addr, align 8
  %36 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %m, i8* %35)
  %37 = icmp sge i64 %36, 0
  br i1 %37, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %38 = trunc i64 %36 to i32
  %39 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %m, i32 %38)
...
nullish.end.1:
  %40 = phi double [ %39, %nullish.value.1 ], [ 0x0000000000000000, %nullish.default.1 ]
  %41 = fadd double %40, 0x3FF0000000000000
  %42 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %m, i8* %34, double %41)
  br label %for.inc

for.inc:
  %43 = load double, double* %i.addr, align 8
  %44 = fadd double %43, 0x3FF0000000000000
  store double %44, double* %i.addr, align 8
  br label %for.cond
...
entry:
  ...
  store i64 3, i64* %4, align 8, !alias.scope !3, !noalias !4, !tbaa !14
  ...
  %12 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %11, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %13 = icmp sge i64 %12, 0
  br i1 %13, label %nullish.value, label %nullish.default

nullish.value:
  %14 = trunc i64 %12 to i32
  %15 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %11, i32 %14)
  br label %nullish.end
...
nullish.end:
  %17 = phi double [ %15, %nullish.value ], [ %16, %nullish.default ]
  %18 = call i8* @nish_str_from_f64(double %17)
  %19 = call i8* @nish_str_concat(i8* %18, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  ...
  br i1 %22, label %nullish.value.1, label %nullish.default.1
...
nullish.default.1:
  %25 = fneg double 0x3FF0000000000000
  br label %nullish.end.1

nullish.end.1:
  %26 = phi double [ %24, %nullish.value.1 ], [ %25, %nullish.default.1 ]
  %27 = call i8* @nish_str_from_f64(double %26)
  %28 = call i8* @nish_str_concat(i8* %19, i8* %27)
