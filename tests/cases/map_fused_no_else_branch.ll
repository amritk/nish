...
@.str.0 = private unnamed_addr constant { i64, [7 x i8] } { i64 6, [7 x i8] c"again \00" }, align 8
...
define internal void @put(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %g, i8* noundef nonnull noalias readonly align 8 %w) #0 {
entry:
  %0 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %g, i8* %w)
  %1 = icmp sge i64 %0, 0
  br i1 %1, label %if.then, label %if.else

if.then:
  %2 = trunc i64 %0 to i32
  call void @nish.Map$str$f64.setValueAt(%struct.Map$str$f64* %g, i32 %2, double 0x4059000000000000)
  %3 = call i8* @nish_str_concat(i8* bitcast ({ i64, [7 x i8] }* @.str.0 to i8*), i8* %w)
  call void @nish_print(i8* %3)
  br label %if.end

if.else:
  %4 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %g, i8* %w, double 0x4014000000000000)
  br label %if.end
...
entry:
  %g.addr = alloca %struct.Map$str$f64*, align 8
  ...
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %g.addr, align 8
  %2 = load %struct.Map$str$f64*, %struct.Map$str$f64** %g.addr, align 8
  call void @put(%struct.Map$str$f64* %2, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %3 = load %struct.Map$str$f64*, %struct.Map$str$f64** %g.addr, align 8
  call void @put(%struct.Map$str$f64* %3, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  %4 = load %struct.Map$str$f64*, %struct.Map$str$f64** %g.addr, align 8
  call void @put(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %5 = load %struct.Map$str$f64*, %struct.Map$str$f64** %g.addr, align 8
  %6 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %5, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %7 = icmp sge i64 %6, 0
...
nullish.end:
  ...
  %14 = load %struct.Map$str$f64*, %struct.Map$str$f64** %g.addr, align 8
  %15 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %14, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
...
nullish.end.1:
  ...
  %23 = call i8* @nish_str_concat(i8* %22, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*))
  %24 = load %struct.Map$str$f64*, %struct.Map$str$f64** %g.addr, align 8
