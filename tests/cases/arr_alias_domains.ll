...
define void @scale(%struct.amrit_array* noundef nonnull align 8 dereferenceable(24) nocapture %dst, %struct.amrit_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %src) #0 {
entry:
...
while.cond:
  ...
  %1 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %src, i64 0, i32 0
...
while.body:
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %src, i64 0, i32 0
  %10 = load i64, i64* %9, align 8, !alias.scope !3, !noalias !4
  %11 = icmp ult i64 %8, %10
  br i1 %11, label %bounds.ok, label %bounds.fail

bounds.fail:
  call void @amrit_panic_index(i64 %8, i64 %10)
  unreachable

bounds.ok:
  %12 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %src, i64 0, i32 2
  ...
  %17 = mul nsw i32 %16, 2
  %18 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %dst, i64 0, i32 0
  %19 = load i64, i64* %18, align 8, !alias.scope !3, !noalias !4
  %20 = icmp ult i64 %6, %19
  br i1 %20, label %bounds.ok.1, label %bounds.fail.1

bounds.fail.1:
  call void @amrit_panic_index(i64 %6, i64 %19)
  unreachable

bounds.ok.1:
  %21 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %dst, i64 0, i32 2
...
entry:
  %src.addr = alloca %struct.amrit_array*, align 8
  %arr.hdr = alloca %struct.amrit_array, align 8
  %arr.data = alloca [4 x i32], align 8
  %dst.addr = alloca %struct.amrit_array*, align 8
  ...
  store %struct.amrit_array* %arr.hdr, %struct.amrit_array** %src.addr, align 8
  %9 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 0
  store i64 4, i64* %9, align 8, !alias.scope !3, !noalias !4
  %10 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 1
  ...
  %13 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 2
  store i8* %12, i8** %13, align 8, !alias.scope !3, !noalias !4
  store %struct.amrit_array* %arr.hdr.1, %struct.amrit_array** %dst.addr, align 8
  %14 = load %struct.amrit_array*, %struct.amrit_array** %dst.addr, align 8
  %15 = load %struct.amrit_array*, %struct.amrit_array** %src.addr, align 8
  call void @scale(%struct.amrit_array* %14, %struct.amrit_array* %15)
  %16 = load %struct.amrit_array*, %struct.amrit_array** %dst.addr, align 8
...
bounds.fail:
  call void @amrit_panic_index(i64 0, i64 %18)
  unreachable
...
bounds.ok:
  ...
  %25 = load %struct.amrit_array*, %struct.amrit_array** %dst.addr, align 8
...
bounds.fail.1:
  call void @amrit_panic_index(i64 1, i64 %27)
  unreachable
...
bounds.ok.1:
  ...
  %35 = load %struct.amrit_array*, %struct.amrit_array** %dst.addr, align 8
...
bounds.fail.2:
  call void @amrit_panic_index(i64 2, i64 %37)
  unreachable
...
bounds.ok.2:
  ...
  %45 = load %struct.amrit_array*, %struct.amrit_array** %dst.addr, align 8
...
bounds.fail.3:
  call void @amrit_panic_index(i64 3, i64 %47)
  unreachable
