...
entry:
  ...
  %2 = call i32 @via$str(i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), i32 9)
...
define internal noundef i32 @via$str(i8* noundef nonnull noalias readonly align 8 nocapture %x, i32 noundef %i) #0 {
entry:
  %0 = tail call i32 @at9(i32 %i)
  ret i32 %0
}
