...
entry:
  ...
  %0 = call i8* @sts_str_from_f64(double 0x3FF8000000000000)
  %1 = call i8* @sts_str_concat(i8* %0, i8* bitcast ({ i64, [6 x i8] }* @.str.0 to i8*))
  %2 = call double @len(i8* bitcast ({ i64, [4 x i8] }* @.str.1 to i8*))
  %3 = call i8* @sts_str_from_f64(double %2)
  %4 = call i8* @sts_str_concat(i8* %1, i8* %3)
  call void @sts_print(i8* %4)
  %5 = call i8* @sts_str_from_f64(double 0x3FD0000000000000)
