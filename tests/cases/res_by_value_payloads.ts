// Every payload shape the packed word has to carry (WP17). `f32` is a
...
// differ. The two constructions are also the two ends of the encoding: the ok
// arm is a shift plus `or i64 ..., 1`, the error arm the bare shift.
