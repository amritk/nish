...
walk.inc:
  ...
  %20 = add i32 %19, 1
  %21 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %5, i32 %20)
...
walk.end:
  ...
  %23 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %22, i32 0, i32 0
  %24 = load double, double* %23, align 8, !tbaa !6
  %25 = call i8* @nish_str_from_f64(double %24)
  %26 = call i8* @nish_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.4 to i8*), i8* %25)
