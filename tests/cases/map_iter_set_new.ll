...
@.str.3 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"d\00" }, align 8
@.str.4 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c"size \00" }, align 8
...
entry:
  ...
  call void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* %5)
  %6 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %5, i32 0)
...
walk.body:
  %9 = call i8* @nish.Map$str$f64.keyAt(%struct.Map$str$f64* %5, i32 %7)
  store i8* %9, i8** %k.addr, align 8
  %10 = load i8*, i8** %k.addr, align 8
  call void @nish_print(i8* %10)
  %11 = load i8*, i8** %k.addr, align 8
  %12 = call zeroext i1 @nish_str_eq(i8* %11, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  br i1 %12, label %if.then, label %if.end

if.then:
  %13 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %14 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %13, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), double 0x4008000000000000)
  br label %if.end

if.end:
  %15 = load i8*, i8** %k.addr, align 8
  %16 = call zeroext i1 @nish_str_eq(i8* %15, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  br i1 %16, label %if.then.1, label %if.end.1

if.then.1:
  %17 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %18 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %17, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*), double 0x4010000000000000)
  br label %if.end.1
...
walk.inc:
  %19 = add i32 %7, 1
  %20 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %5, i32 %19)
  store i32 %20, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %5)
  %21 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %22 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %21, i32 0, i32 0
  %23 = load double, double* %22, align 8, !tbaa !6
  %24 = call i8* @nish_str_from_f64(double %23)
  %25 = call i8* @nish_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.4 to i8*), i8* %24)
