...
@.str.0 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c"apple\00" }, align 8
@.str.1 = private unnamed_addr constant { i64, [1 x i8] } { i64 0, [1 x i8] c"\00" }, align 8
@.str.2 = private unnamed_addr constant { i64, [4 x i8] } { i64 3, [4 x i8] c"app\00" }, align 8
@.str.3 = private unnamed_addr constant { i64, [3 x i8] } { i64 2, [3 x i8] c"ap\00" }, align 8
@.str.4 = private unnamed_addr constant { i64, [4 x i8] } { i64 3, [4 x i8] c"ple\00" }, align 8
@.str.5 = private unnamed_addr constant { i64, [7 x i8] } { i64 6, [7 x i8] c"apples\00" }, align 8
@.str.6 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c"appla\00" }, align 8
...
entry:
  ...
  %2 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %3 = call %struct.Map$str$i32* @nish.Map$str$i32.set(%struct.Map$str$i32* %2, i8* bitcast ({ i64, [6 x i8] }* @.str.0 to i8*), i32 1)
  %4 = call %struct.Map$str$i32* @nish.Map$str$i32.set(%struct.Map$str$i32* %3, i8* bitcast ({ i64, [1 x i8] }* @.str.1 to i8*), i32 2)
  %5 = call %struct.Map$str$i32* @nish.Map$str$i32.set(%struct.Map$str$i32* %4, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*), i32 3)
  %6 = call i8* @nish_str_concat(i8* bitcast ({ i64, [3 x i8] }* @.str.3 to i8*), i8* bitcast ({ i64, [4 x i8] }* @.str.4 to i8*))
  store i8* %6, i8** %built.addr, align 8
  %7 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %8 = load i8*, i8** %built.addr, align 8
  %9 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %7, i8* %8)
  br i1 %9, label %land.rhs.3, label %land.end.3

land.rhs.3:
  %10 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %11 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %10, i8* bitcast ({ i64, [1 x i8] }* @.str.1 to i8*))
  br label %land.end.3

land.end.3:
  %12 = phi i1 [ false, %entry ], [ %11, %land.rhs.3 ]
  br i1 %12, label %land.rhs.2, label %land.end.2

land.rhs.2:
  %13 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %14 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %13, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*))
  br label %land.end.2

land.end.2:
  %15 = phi i1 [ false, %land.end.3 ], [ %14, %land.rhs.2 ]
  br i1 %15, label %land.rhs.1, label %land.end.1

land.rhs.1:
  %16 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %17 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %16, i8* bitcast ({ i64, [7 x i8] }* @.str.5 to i8*))
  %18 = xor i1 %17, true
  br label %land.end.1

land.end.1:
  %19 = phi i1 [ false, %land.end.2 ], [ %18, %land.rhs.1 ]
  br i1 %19, label %land.rhs, label %land.end

land.rhs:
  %20 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %21 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %20, i8* bitcast ({ i64, [6 x i8] }* @.str.6 to i8*))
  %22 = xor i1 %21, true
  br label %land.end

land.end:
  %23 = phi i1 [ false, %land.end.1 ], [ %22, %land.rhs ]
  store i1 %23, i1* %found.addr, align 1
  %24 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %25 = load i8*, i8** %built.addr, align 8
  %26 = call %struct.Map$str$i32* @nish.Map$str$i32.set(%struct.Map$str$i32* %24, i8* %25, i32 10)
  %27 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %28 = call i1 @nish.Map$str$i32.delete(%struct.Map$str$i32* %27, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*))
  store i1 %28, i1* %gone.addr, align 1
  %29 = load i1, i1* %found.addr, align 1
  %30 = select i1 %29, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.8 to i8*)
  %31 = call i8* @nish_str_concat(i8* %30, i8* bitcast ({ i64, [2 x i8] }* @.str.9 to i8*))
  %32 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %33 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %32, i32 0, i32 0
  %34 = load i32, i32* %33, align 4, !tbaa !5
  %35 = call i8* @nish_str_from_i32(i32 %34)
  %36 = call i8* @nish_str_concat(i8* %31, i8* %35)
  %37 = call i8* @nish_str_concat(i8* %36, i8* bitcast ({ i64, [2 x i8] }* @.str.9 to i8*))
  %38 = load i1, i1* %gone.addr, align 1
  %39 = select i1 %38, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.8 to i8*)
  %40 = call i8* @nish_str_concat(i8* %37, i8* %39)
  %41 = call i8* @nish_str_concat(i8* %40, i8* bitcast ({ i64, [2 x i8] }* @.str.9 to i8*))
  %42 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %43 = call i1 @nish.Map$str$i32.delete(%struct.Map$str$i32* %42, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*))
  %44 = select i1 %43, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.8 to i8*)
  %45 = call i8* @nish_str_concat(i8* %41, i8* %44)
  %46 = call i8* @nish_str_concat(i8* %45, i8* bitcast ({ i64, [2 x i8] }* @.str.9 to i8*))
  %47 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %48 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %47, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*))
  %49 = select i1 %48, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.8 to i8*)
  %50 = call i8* @nish_str_concat(i8* %46, i8* %49)
  %51 = call i8* @nish_str_concat(i8* %50, i8* bitcast ({ i64, [2 x i8] }* @.str.9 to i8*))
  %52 = load %struct.Map$str$i32*, %struct.Map$str$i32** %m.addr, align 8
  %53 = call i1 @nish.Map$str$i32.has(%struct.Map$str$i32* %52, i8* bitcast ({ i64, [6 x i8] }* @.str.0 to i8*))
  %54 = select i1 %53, i8* bitcast ({ i64, [5 x i8] }* @.str.7 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.8 to i8*)
  %55 = call i8* @nish_str_concat(i8* %51, i8* %54)
...
define internal noundef zeroext i1 @nish.Map$str$i32.delete(%struct.Map$str$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this, i8* noundef nonnull noalias readonly align 8 %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$str$i32.probe(%struct.Map$str$i32* %this, i8* %key)
  store i64 %0, i64* %found.addr, align 8
...
if.end:
  %3 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %this, i32 0, i32 1
  %4 = load %struct.nish_array*, %struct.nish_array** %3, align 8, !tbaa !21
  %5 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %this, i32 0, i32 6
  ...
  %8 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %this, i32 0, i32 3
  ...
  %12 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %this, i32 0, i32 0
  %13 = load i32, i32* %12, align 4, !tbaa !5
  %14 = sub nsw i32 %13, 1
  %15 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %this, i32 0, i32 0
...
push.store.2:
  ...
  %70 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %this, i32 0, i32 1
  %71 = load %struct.nish_array*, %struct.nish_array** %70, align 8, !tbaa !21
  %72 = getelementptr inbounds %struct.Map$str$i32, %struct.Map$str$i32* %this, i32 0, i32 2
