...
@.str.0 = private unnamed_addr constant { i64, [5 x i8] } { i64 4, [5 x i8] c"new \00" }, align 8
...
@.str.3 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"z\00" }, align 8
...
define internal void @firstIndex(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %m, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %words) #0 {
entry:
...
for.body:
  ...
  %7 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 0
...
bounds.ok:
  %10 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %words, i64 0, i32 2
  ...
  store i8* %14, i8** %w.addr, align 8
  %15 = load i8*, i8** %w.addr, align 8
  %16 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %m, i8* %15)
  %17 = icmp sge i64 %16, 0
  %18 = xor i1 %17, true
  br i1 %18, label %if.then, label %if.end

if.then:
  %19 = load double, double* %i.addr, align 8
  call void @nish.Map$str$f64.insertAt(%struct.Map$str$f64* %m, i64 %16, i8* %15, double %19)
  %20 = load i8*, i8** %w.addr, align 8
  %21 = call i8* @nish_str_concat(i8* bitcast ({ i64, [5 x i8] }* @.str.0 to i8*), i8* %20)
...
for.inc:
  %22 = load double, double* %i.addr, align 8
  %23 = fadd double %22, 0x3FF0000000000000
  store double %23, double* %i.addr, align 8
  br label %for.cond
...
entry:
  ...
  store i64 5, i64* %3, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %4 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 1
  store i64 5, i64* %4, align 8, !alias.scope !3, !noalias !4, !tbaa !14
  %5 = bitcast [5 x i8*]* %arr.data to i8*
  ...
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %8, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %9 = getelementptr inbounds i8*, i8** %7, i64 1
  store i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), i8** %9, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %10 = getelementptr inbounds i8*, i8** %7, i64 2
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %10, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %11 = getelementptr inbounds i8*, i8** %7, i64 3
  store i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*), i8** %11, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %12 = getelementptr inbounds i8*, i8** %7, i64 4
  store i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), i8** %12, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  call void @firstIndex(%struct.Map$str$f64* %2, %struct.nish_array* %arr.hdr)
  %13 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* %13)
  %14 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %13, i32 0)
  store i32 %14, i32* %walk.idx, align 4
  br label %walk.cond

walk.cond:
  %15 = load i32, i32* %walk.idx, align 4
  %16 = icmp sge i32 %15, 0
  br i1 %16, label %walk.body, label %walk.end

walk.body:
  %17 = call i8* @nish.Map$str$f64.keyAt(%struct.Map$str$f64* %13, i32 %15)
  store i8* %17, i8** %w.addr, align 8
  ...
  %26 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %24, i8* %25)
  %27 = icmp sge i64 %26, 0
  br i1 %27, label %nullish.value, label %nullish.default

nullish.value:
  %28 = trunc i64 %26 to i32
  %29 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %24, i32 %28)
  br label %nullish.end

nullish.default:
  %30 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %31 = phi double [ %29, %nullish.value ], [ %30, %nullish.default ]
  %32 = call i8* @nish_str_from_f64(double %31)
  %33 = call i8* @nish_str_concat(i8* %23, i8* %32)
...
walk.inc:
  %40 = add i32 %15, 1
  %41 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %13, i32 %40)
  store i32 %41, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %13)
...
for.body:
  ...
  %15 = load i32, i32* %14, align 4, !alias.scope !4, !noalias !3, !tbaa !16
  %16 = icmp ne i32 %15, 0
