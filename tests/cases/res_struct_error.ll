...
define noundef nonnull align 8 dereferenceable(16) %struct.sts_result.i32.$IoError* @openFile(i8* noundef nonnull noalias readonly align 8 %path) #0 {
entry:
...
entry:
  %opened.addr = alloca %struct.sts_result.i32.$IoError*, align 8
  %failure.addr = alloca %struct.IoError*, align 8
  %0 = call %struct.sts_result.i32.$IoError* @openFile(i8* %path)
  store %struct.sts_result.i32.$IoError* %0, %struct.sts_result.i32.$IoError** %opened.addr, align 8
  %1 = load %struct.sts_result.i32.$IoError*, %struct.sts_result.i32.$IoError** %opened.addr, align 8
  %2 = getelementptr inbounds %struct.sts_result.i32.$IoError, %struct.sts_result.i32.$IoError* %1, i32 0, i32 0
  %3 = load i1, i1* %2, align 1
  %4 = xor i1 %3, true
  br i1 %4, label %if.then, label %if.end

if.then:
  %5 = load %struct.sts_result.i32.$IoError*, %struct.sts_result.i32.$IoError** %opened.addr, align 8
  %6 = getelementptr inbounds %struct.sts_result.i32.$IoError, %struct.sts_result.i32.$IoError* %5, i32 0, i32 2
  ...
  %12 = call i8* @sts_str_concat(i8* bitcast ({ i64, [7 x i8] }* @.str.1 to i8*), i8* %11)
  ret i8* %12

if.end:
  %13 = load %struct.sts_result.i32.$IoError*, %struct.sts_result.i32.$IoError** %opened.addr, align 8
  %14 = getelementptr inbounds %struct.sts_result.i32.$IoError, %struct.sts_result.i32.$IoError* %13, i32 0, i32 1
  %15 = load i32, i32* %14, align 4
  %16 = call i8* @sts_str_from_i32(i32 %15)
  %17 = call i8* @sts_str_concat(i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*), i8* %16)
  ret i8* %17
}
