...
walk.body:
  %10 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %6, i32 %8)
  store double %10, double* %v.addr, align 8
  %11 = load double, double* %v.addr, align 8
  %12 = call i8* @nish_str_from_f64(double %11)
  call void @nish_print(i8* %12)
  %13 = load double, double* %v.addr, align 8
  %14 = fcmp oeq double %13, 0x4000000000000000
  br i1 %14, label %if.then, label %if.end

if.then:
  %15 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %16 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %15, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), double 0x403E000000000000)
  %17 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %18 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %17, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), double 0x4024000000000000)
  br label %if.end
