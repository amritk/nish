...
define internal void @nish.Map$f64$str.constructor(%struct.Map$f64$str* noundef nonnull noalias align 8 dereferenceable(56) nocapture %this) #2 {
entry:
...
define internal noundef zeroext i1 @nish.Map$f64$str.has(%struct.Map$f64$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, double noundef %key) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$f64$str.delete(%struct.Map$f64$str* noundef nonnull align 8 dereferenceable(56) nocapture %this, double noundef %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$f64$str.probe(%struct.Map$f64$str* %this, double %key)
  store i64 %0, i64* %found.addr, align 8
...
if.end:
  %3 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 1
  %4 = load %struct.nish_array*, %struct.nish_array** %3, align 8, !tbaa !23
  %5 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 6
  ...
  %10 = sub nsw i32 %9, 1
  %11 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 3
  store i32 %10, i32* %11, align 4, !tbaa !21
  %12 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 0
  %13 = load double, double* %12, align 8, !tbaa !6
  %14 = fsub double %13, 0x3FF0000000000000
  %15 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 0
  store double %14, double* %15, align 8, !tbaa !6
  ret i1 true
}

define internal void @nish.Map$f64$str.setValueAt(%struct.Map$f64$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index, i8* noundef nonnull noalias readonly align 8 %value) #2 {
entry:
...
push.store:
  ...
  store double %key, double* %32, align 8, !alias.scope !11, !noalias !10, !tbaa !30
  %33 = add i64 %25, 1
  store i64 %33, i64* %24, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %34 = sitofp i64 %33 to double
  %35 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 5
...
push.store.1:
  ...
  %48 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 6
...
push.store.2:
  ...
  %62 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 3
  %63 = load i32, i32* %62, align 4, !tbaa !21
  %64 = add nsw i32 %63, 1
  %65 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 3
  store i32 %64, i32* %65, align 4, !tbaa !21
  %66 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 0
  %67 = load double, double* %66, align 8, !tbaa !6
  %68 = fadd double %67, 0x3FF0000000000000
  %69 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 0
  store double %68, double* %69, align 8, !tbaa !6
  %70 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 4
  ...
  %77 = mul nsw i32 %76, 4
  %78 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 1
...
if.else:
  %86 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 1
  %87 = load %struct.nish_array*, %struct.nish_array** %86, align 8, !tbaa !23
  %88 = getelementptr inbounds %struct.Map$f64$str, %struct.Map$f64$str* %this, i32 0, i32 2
...
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"i32", !1, i64 0}
!5 = !{!"Map$f64$str", !2, i64 0, !3, i64 8, !4, i64 16, !4, i64 20, !3, i64 24, !3, i64 32, !3, i64 40, !4, i64 48}
!6 = !{!5, !2, i64 0}
!7 = !{!"nish array"}
!8 = !{!"header", !7}
!9 = !{!"elements", !7}
