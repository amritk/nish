...
entry:
  ...
  %9 = call double @mean(%struct.amrit_array* %8)
  %10 = call i8* @amrit_str_from_f64(double %9)
  ...
  %13 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %11, i64 0, i32 0
  %14 = load i64, i64* %13, align 8
  %15 = icmp ult i64 %12, %14
  br i1 %15, label %bounds.ok, label %bounds.fail

bounds.fail:
  call void @amrit_panic_index(i64 %12, i64 %14)
  unreachable

bounds.ok:
  %16 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %11, i64 0, i32 2
