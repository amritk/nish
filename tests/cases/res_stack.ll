...
div.ok:
  %6 = sdiv i32 %n, 10
  %7 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %nish_result.i32.str.obj, i32 0, i32 0
  store i1 true, i1* %7, align 1
  %8 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %nish_result.i32.str.obj, i32 0, i32 1
  store i32 %6, i32* %8, align 4
  br label %cond.end

cond.false:
  %9 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %nish_result.i32.str.obj.1, i32 0, i32 0
  store i1 false, i1* %9, align 1
  %10 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %nish_result.i32.str.obj.1, i32 0, i32 2
  store i8* bitcast ({ i64, [10 x i8] }* @.str.0 to i8*), i8** %10, align 8
  br label %cond.end

cond.end:
  %11 = phi %struct.nish_result.i32.str* [ %nish_result.i32.str.obj, %div.ok ], [ %nish_result.i32.str.obj.1, %cond.false ]
  store %struct.nish_result.i32.str* %11, %struct.nish_result.i32.str** %r.addr, align 8
...
res.ok:
  %15 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %12, i32 0, i32 1
