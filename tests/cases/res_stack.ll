...
entry:
  ...
  %amrit_result.i32.str.obj.1 = alloca %struct.amrit_result.i32.str, align 8
  %0 = icmp sge i32 %n, 10
...
div.ok:
  %6 = sdiv i32 %n, 10
  %7 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %amrit_result.i32.str.obj, i32 0, i32 0
  store i1 true, i1* %7, align 1
  %8 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %amrit_result.i32.str.obj, i32 0, i32 1
  store i32 %6, i32* %8, align 4
  br label %cond.end

cond.false:
  %9 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %amrit_result.i32.str.obj.1, i32 0, i32 0
  store i1 false, i1* %9, align 1
  %10 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %amrit_result.i32.str.obj.1, i32 0, i32 2
  store i8* bitcast ({ i64, [10 x i8] }* @.str.0 to i8*), i8** %10, align 8
  br label %cond.end

cond.end:
  %11 = phi %struct.amrit_result.i32.str* [ %amrit_result.i32.str.obj, %div.ok ], [ %amrit_result.i32.str.obj.1, %cond.false ]
  store %struct.amrit_result.i32.str* %11, %struct.amrit_result.i32.str** %r.addr, align 8
  %12 = load %struct.amrit_result.i32.str*, %struct.amrit_result.i32.str** %r.addr, align 8
  %13 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %12, i32 0, i32 0
  %14 = load i1, i1* %13, align 1
  br i1 %14, label %res.ok, label %res.alt

res.ok:
  %15 = getelementptr inbounds %struct.amrit_result.i32.str, %struct.amrit_result.i32.str* %12, i32 0, i32 1
