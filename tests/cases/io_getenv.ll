@.str.0 = private unnamed_addr constant { i64, [18 x i8] } { i64 17, [18 x i8] c"AMRITC_TEST_VALUE\00" }, align 8
...
@.str.6 = private unnamed_addr constant { i64, [20 x i8] } { i64 19, [20 x i8] c"AMRITC_TEST_NOT_SET\00" }, align 8
...
entry:
  ...
  %0 = call i8* @amrit_getenv(i8* bitcast ({ i64, [18 x i8] }* @.str.0 to i8*))
...
cond.end.2:
  ...
  %19 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [8 x i8] }* @.str.7 to i8*), i8* %18)
...
if.then:
  ...
  %27 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [9 x i8] }* @.str.8 to i8*), i8* %26)
