...
entry:
  ...
  %2 = call i8* @amrit_str_concat(i8* %1, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  ...
  %7 = call i8* @amrit_str_concat(i8* %6, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %8 = getelementptr inbounds %struct.Stats, %struct.Stats* %s, i32 0, i32 2
  %9 = load i32, i32* %8, align 4
  %10 = call i8* @amrit_str_from_i32(i32 %9)
  %11 = call i8* @amrit_str_concat(i8* %7, i8* %10)
  ret i8* %11
}
...
entry:
  ...
  %11 = call i64 @amrit_arena_mark()
  %12 = call i8* @describe(%struct.Stats* %10)
  %13 = call i8* @amrit_arena_keep(i64 %11, i8* %12)
  ...
  %25 = call i64 @amrit_arena_mark()
  %26 = call i8* @describe(%struct.Stats* %24)
  %27 = call i8* @amrit_arena_keep(i64 %25, i8* %26)
  ...
  %32 = call i64 @amrit_arena_mark()
  %33 = call i8* @describe(%struct.Stats* %31)
  %34 = call i8* @amrit_arena_keep(i64 %32, i8* %33)
...
cond.end:
  ...
  %43 = call i8* @amrit_str_from_i32(i32 %42)
  call void @amrit_print(i8* %43)
  ...
  %46 = call i64 @amrit_arena_mark()
  %47 = call i8* @describe(%struct.Stats* %45)
  %48 = call i8* @amrit_arena_keep(i64 %46, i8* %47)
  ...
  %52 = call i8* @amrit_str_from_i32(i32 %51)
  call void @amrit_print(i8* %52)
