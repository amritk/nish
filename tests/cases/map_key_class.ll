...
push.store.2:
  ...
  %71 = mul nsw i32 %70, 4
  %72 = getelementptr inbounds %struct.Map$$Point$str, %struct.Map$$Point$str* %this, i32 0, i32 1
  %73 = load %struct.nish_array*, %struct.nish_array** %72, align 8, !tbaa !24
  %74 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %73, i64 0, i32 0
  %75 = load i64, i64* %74, align 8, !alias.scope !12, !noalias !13, !tbaa !17
...
if.else:
  ...
  %81 = getelementptr inbounds %struct.Map$$Point$str, %struct.Map$$Point$str* %this, i32 0, i32 2
...
if.end:
  ...
  %26 = getelementptr inbounds %struct.Map$$Point$str, %struct.Map$$Point$str* %this, i32 0, i32 1
  store %struct.nish_array* %25, %struct.nish_array** %26, align 8, !tbaa !24
  ...
  %29 = load i64, i64* %28, align 8, !alias.scope !12, !noalias !13, !tbaa !17
  %30 = trunc i64 %29 to i32
  %31 = sub nsw i32 %30, 1
  %32 = getelementptr inbounds %struct.Map$$Point$str, %struct.Map$$Point$str* %this, i32 0, i32 2
  store i32 %31, i32* %32, align 4, !tbaa !22
  %33 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %34 = getelementptr inbounds %struct.Map$$Point$str, %struct.Map$$Point$str* %this, i32 0, i32 6
