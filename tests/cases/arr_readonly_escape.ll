...
entry:
  ...
  store %struct.nish_array* %rows, %struct.nish_array** %0, align 8
  ret void
}
...
entry:
  ...
  %2 = load %struct.nish_array*, %struct.nish_array** %1, align 8
...
bounds.ok.1:
  ...
  store i32 %v, i32* %14, align 4, !alias.scope !4, !noalias !3
