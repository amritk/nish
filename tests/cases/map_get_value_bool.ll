%struct.Map$str$bool = type { double, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array* }
...
@.str.4 = private unnamed_addr constant { i64, [4 x i8] } { i64 3, [4 x i8] c"yes\00" }, align 8
...
entry:
  %m.addr = alloca %struct.Map$str$bool*, align 8
  %arena.mark = call i64 @nish_arena_mark()
  %0 = call i8* @nish_alloc_struct(i64 48)
  %1 = bitcast i8* %0 to %struct.Map$str$bool*
  call void @nish.Map$str$bool.constructor(%struct.Map$str$bool* %1)
  store %struct.Map$str$bool* %1, %struct.Map$str$bool** %m.addr, align 8
  %2 = load %struct.Map$str$bool*, %struct.Map$str$bool** %m.addr, align 8
  %3 = call %struct.Map$str$bool* @nish.Map$str$bool.set(%struct.Map$str$bool* %2, i8* bitcast ({ i64, [3 x i8] }* @.str.0 to i8*), i1 false)
  %4 = load %struct.Map$str$bool*, %struct.Map$str$bool** %m.addr, align 8
  %5 = call i64 @nish.Map$str$bool.probe(%struct.Map$str$bool* %4, i8* bitcast ({ i64, [3 x i8] }* @.str.0 to i8*))
  %6 = icmp sge i64 %5, 0
  br i1 %6, label %get.found, label %get.end

get.found:
  %7 = trunc i64 %5 to i32
  %8 = call i1 @nish.Map$str$bool.valueAt(%struct.Map$str$bool* %4, i32 %7)
  br label %get.end

get.end:
  %9 = phi i1 [ %8, %get.found ], [ false, %entry ]
  %10 = load %struct.Map$str$bool*, %struct.Map$str$bool** %m.addr, align 8
  %11 = call i64 @nish.Map$str$bool.probe(%struct.Map$str$bool* %10, i8* bitcast ({ i64, [3 x i8] }* @.str.0 to i8*))
  %12 = icmp sge i64 %11, 0
  br i1 %12, label %nullish.value, label %nullish.default

nullish.value:
  %13 = trunc i64 %11 to i32
  %14 = call i1 @nish.Map$str$bool.valueAt(%struct.Map$str$bool* %10, i32 %13)
...
nullish.end:
  %15 = phi i1 [ %14, %nullish.value ], [ true, %nullish.default ]
  %16 = select i1 %15, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %17 = call i8* @nish_str_concat(i8* %16, i8* bitcast ({ i64, [2 x i8] }* @.str.3 to i8*))
  %18 = load %struct.Map$str$bool*, %struct.Map$str$bool** %m.addr, align 8
  %19 = call i64 @nish.Map$str$bool.probe(%struct.Map$str$bool* %18, i8* bitcast ({ i64, [4 x i8] }* @.str.4 to i8*))
  %20 = icmp sge i64 %19, 0
  br i1 %20, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %21 = trunc i64 %19 to i32
  %22 = call i1 @nish.Map$str$bool.valueAt(%struct.Map$str$bool* %18, i32 %21)
...
nullish.end.1:
  %23 = phi i1 [ %22, %nullish.value.1 ], [ true, %nullish.default.1 ]
  %24 = select i1 %23, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %25 = call i8* @nish_str_concat(i8* %17, i8* %24)
...
land.end:
  %28 = phi i1 [ false, %nullish.end.1 ], [ %27, %land.rhs ]
...
define internal void @nish.Map$str$bool.constructor(%struct.Map$str$bool* noundef nonnull noalias align 8 dereferenceable(48) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 0
  store double 0x0000000000000000, double* %0, align 8, !tbaa !19
  %1 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !20
  %2 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 3
  ...
  %11 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 1
  ...
  %17 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 4
  ...
  %23 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 5
  ...
  %29 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 6
  store %struct.nish_array* %25, %struct.nish_array** %29, align 8, !tbaa !25
  ret void
}

define internal noundef i64 @nish.Map$str$bool.probe(%struct.Map$str$bool* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i8* noundef nonnull noalias readonly align 8 %key) #0 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !22
  %2 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !20
  %4 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 6
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !25
  %6 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 4
...
define internal noundef nonnull align 8 dereferenceable(48) %struct.Map$str$bool* @nish.Map$str$bool.set(%struct.Map$str$bool* noundef nonnull align 8 dereferenceable(48) %this, i8* noundef nonnull noalias readonly align 8 %key, i1 noundef zeroext %value) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$str$bool.probe(%struct.Map$str$bool* %this, i8* %key)
...
if.then:
  ...
  call void @nish.Map$str$bool.setValueAt(%struct.Map$str$bool* %this, i32 %4, i1 %value)
  br label %if.end

if.else:
  %5 = load i64, i64* %found.addr, align 8
  call void @nish.Map$str$bool.insertAt(%struct.Map$str$bool* %this, i64 %5, i8* %key, i1 %value)
  br label %if.end

if.end:
  ret %struct.Map$str$bool* %this
}

define internal noundef zeroext i1 @nish.Map$str$bool.valueAt(%struct.Map$str$bool* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index) #0 {
entry:
  %0 = icmp slt i32 %index, 0
  br i1 %0, label %lor.end, label %lor.rhs

lor.rhs:
  %1 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 5
...
if.end:
  %9 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 5
...
bounds.ok:
  ...
  %19 = load i1, i1* %18, align 1, !alias.scope !4, !noalias !3, !tbaa !27
  ret i1 %19
}

define internal void @nish.Map$str$bool.setValueAt(%struct.Map$str$bool* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index, i1 noundef zeroext %value) #2 {
entry:
...
if.then:
  ...
  store i1 %value, i1* %15, align 1, !alias.scope !4, !noalias !3, !tbaa !27
  br label %if.end
...
define internal void @nish.Map$str$bool.insertAt(%struct.Map$str$bool* noundef nonnull align 8 dereferenceable(48) nocapture %this, i64 noundef %absent, i8* noundef nonnull noalias readonly align 8 %key, i1 noundef zeroext %value) #0 {
entry:
  ...
  %7 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 4
...
if.then:
  %14 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 3
...
if.end.1:
  call void @nish.Map$str$bool.rebuild(%struct.Map$str$bool* %this)
  %17 = sub nsw i32 0, 1
  store i32 %17, i32* %bucket.addr, align 4
  br label %if.end

if.end:
  %18 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 4
...
push.store:
  ...
  store i8* %key, i8** %28, align 8, !alias.scope !4, !noalias !3, !tbaa !29
  %29 = add i64 %21, 1
  store i64 %29, i64* %20, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %30 = sitofp i64 %29 to double
  %31 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 5
...
push.grow.1:
  call void @nish_array_grow(%struct.nish_array* %32, i64 1)
...
push.store.1:
  ...
  %41 = getelementptr inbounds i1, i1* %40, i64 %34
  store i1 %value, i1* %41, align 1, !alias.scope !4, !noalias !3, !tbaa !27
  %42 = add i64 %34, 1
  store i64 %42, i64* %33, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %43 = sitofp i64 %42 to double
  %44 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 6
...
push.store.2:
  ...
  %58 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 3
  %59 = load i32, i32* %58, align 4, !tbaa !21
  %60 = add nsw i32 %59, 1
  %61 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 3
  store i32 %60, i32* %61, align 4, !tbaa !21
  %62 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 0
  %63 = load double, double* %62, align 8, !tbaa !19
  %64 = fadd double %63, 0x3FF0000000000000
  %65 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 0
  store double %64, double* %65, align 8, !tbaa !19
  %66 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 4
  ...
  %73 = mul nsw i32 %72, 4
  %74 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 1
...
if.else:
  %82 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 1
  %83 = load %struct.nish_array*, %struct.nish_array** %82, align 8, !tbaa !22
  %84 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 2
...
define internal void @nish.Map$str$bool.rebuild(%struct.Map$str$bool* noundef nonnull align 8 dereferenceable(48) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  %slots.addr = alloca %struct.nish_array*, align 8
  %0 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 4
  ...
  %6 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 1
  %7 = load %struct.nish_array*, %struct.nish_array** %6, align 8, !tbaa !22
  %8 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 3
  ...
  %12 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 3
...
if.then:
  %16 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 4
  %17 = load %struct.nish_array*, %struct.nish_array** %16, align 8, !tbaa !23
  %18 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 6
  ...
  %20 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 5
  %21 = load %struct.nish_array*, %struct.nish_array** %20, align 8, !tbaa !24
  %22 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 6
  %23 = load %struct.nish_array*, %struct.nish_array** %22, align 8, !tbaa !25
  call void @nish.compactEntries$bool(%struct.nish_array* %21, %struct.nish_array* %23)
  %24 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 6
...
if.end:
  ...
  %27 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 1
  ...
  %33 = sub nsw i32 %32, 1
  %34 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 2
  store i32 %33, i32* %34, align 4, !tbaa !20
  %35 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %36 = getelementptr inbounds %struct.Map$str$bool, %struct.Map$str$bool* %this, i32 0, i32 6
...
land.rhs.1:
  ...
  %79 = load i8*, i8** %78, align 8, !alias.scope !4, !noalias !3, !tbaa !29
...
if.then:
  ...
  %44 = load i8*, i8** %43, align 8, !alias.scope !4, !noalias !3, !tbaa !29
  %45 = bitcast i8* %11 to i8**
  %46 = getelementptr inbounds i8*, i8** %45, i64 %39
  store i8* %44, i8** %46, align 8, !alias.scope !4, !noalias !3, !tbaa !29
...
pop.ok:
  ...
  %65 = load i8*, i8** %64, align 8, !alias.scope !4, !noalias !3, !tbaa !29
  br label %while.cond
...
if.then:
  ...
  %40 = load i32, i32* %from.addr, align 4
  %41 = sext i32 %40 to i64
  %42 = bitcast i8* %11 to i1*
  %43 = getelementptr inbounds i1, i1* %42, i64 %41
  %44 = load i1, i1* %43, align 1, !alias.scope !4, !noalias !3, !tbaa !27
  %45 = bitcast i8* %11 to i1*
  %46 = getelementptr inbounds i1, i1* %45, i64 %39
  store i1 %44, i1* %46, align 1, !alias.scope !4, !noalias !3, !tbaa !27
  %47 = load i32, i32* %to.addr, align 4
  %48 = add nsw i32 %47, 1
  store i32 %48, i32* %to.addr, align 4
  br label %if.end
...
pop.ok:
  ...
  %64 = getelementptr inbounds i1, i1* %63, i64 %60
  %65 = load i1, i1* %64, align 1, !alias.scope !4, !noalias !3, !tbaa !27
  br label %while.cond
...
!16 = !{!"ptr", !6, i64 0}
!17 = !{!"i32", !6, i64 0}
!18 = !{!"Map$str$bool", !15, i64 0, !16, i64 8, !17, i64 16, !17, i64 20, !16, i64 24, !16, i64 32, !16, i64 40}
!19 = !{!18, !15, i64 0}
!20 = !{!18, !17, i64 16}
!21 = !{!18, !17, i64 20}
!22 = !{!18, !16, i64 8}
...
!24 = !{!18, !16, i64 32}
!25 = !{!18, !16, i64 40}
!26 = !{!"element i1", !6, i64 0}
!27 = !{!26, !26, i64 0}
!28 = !{!"element ptr", !6, i64 0}
!29 = !{!28, !28, i64 0}
