%struct.Shape = type { double }
%struct.Square = type { double }
%struct.Map$str$$Square = type { double, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array* }
...
define internal void @Square.constructor(%struct.Square* noundef nonnull noalias align 8 dereferenceable(8) nocapture %this, double noundef %side) #0 {
entry:
  %0 = getelementptr inbounds %struct.Square, %struct.Square* %this, i32 0, i32 0
  store double %side, double* %0, align 8
  ret void
}

define internal noundef double @area(%struct.Shape* noundef nonnull readonly align 8 dereferenceable(8) nocapture %s) #1 {
entry:
  %0 = getelementptr inbounds %struct.Shape, %struct.Shape* %s, i32 0, i32 0
  %1 = load double, double* %0, align 8
  %2 = getelementptr inbounds %struct.Shape, %struct.Shape* %s, i32 0, i32 0
...
entry:
  %m.addr = alloca %struct.Map$str$$Square*, align 8
  %unit.addr = alloca %struct.Square*, align 8
  %Square.obj = alloca %struct.Square, align 8
  %x.addr = alloca %struct.Shape*, align 8
  %y.addr = alloca %struct.Shape*, align 8
  %arena.mark = call i64 @nish_arena_mark()
  %0 = call i8* @nish_alloc_struct(i64 48)
  %1 = bitcast i8* %0 to %struct.Map$str$$Square*
  call void @nish.Map$str$$Square.constructor(%struct.Map$str$$Square* %1)
  store %struct.Map$str$$Square* %1, %struct.Map$str$$Square** %m.addr, align 8
  call void @Square.constructor(%struct.Square* %Square.obj, double 0x3FF0000000000000)
  store %struct.Square* %Square.obj, %struct.Square** %unit.addr, align 8
  %2 = load %struct.Map$str$$Square*, %struct.Map$str$$Square** %m.addr, align 8
  %3 = call i8* @nish_alloc_struct(i64 8)
  %4 = bitcast i8* %3 to %struct.Square*
  call void @Square.constructor(%struct.Square* %4, double 0x4010000000000000)
  %5 = call %struct.Map$str$$Square* @nish.Map$str$$Square.set(%struct.Map$str$$Square* %2, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*), %struct.Square* %4)
  %6 = load %struct.Map$str$$Square*, %struct.Map$str$$Square** %m.addr, align 8
  %7 = call i64 @nish.Map$str$$Square.probe(%struct.Map$str$$Square* %6, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %8 = icmp sge i64 %7, 0
  br i1 %8, label %nullish.value, label %nullish.default

nullish.value:
  %9 = trunc i64 %7 to i32
  %10 = call %struct.Square* @nish.Map$str$$Square.valueAt(%struct.Map$str$$Square* %6, i32 %9)
  br label %nullish.end

nullish.default:
  %11 = load %struct.Square*, %struct.Square** %unit.addr, align 8
  br label %nullish.end

nullish.end:
  %12 = phi %struct.Square* [ %10, %nullish.value ], [ %11, %nullish.default ]
  %13 = bitcast %struct.Square* %12 to %struct.Shape*
  store %struct.Shape* %13, %struct.Shape** %x.addr, align 8
  %14 = load %struct.Map$str$$Square*, %struct.Map$str$$Square** %m.addr, align 8
  %15 = call i64 @nish.Map$str$$Square.probe(%struct.Map$str$$Square* %14, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %16 = icmp sge i64 %15, 0
  br i1 %16, label %get.found, label %get.end

get.found:
  %17 = trunc i64 %15 to i32
  %18 = call %struct.Square* @nish.Map$str$$Square.valueAt(%struct.Map$str$$Square* %14, i32 %17)
  br label %get.end

get.end:
  %19 = phi %struct.Square* [ %18, %get.found ], [ null, %nullish.end ]
  %20 = load %struct.Square*, %struct.Square** %unit.addr, align 8
  %21 = select i1 %16, %struct.Square* %19, %struct.Square* %20
  %22 = bitcast %struct.Square* %21 to %struct.Shape*
  store %struct.Shape* %22, %struct.Shape** %y.addr, align 8
  %23 = load %struct.Shape*, %struct.Shape** %x.addr, align 8
  ...
  %28 = load %struct.Shape*, %struct.Shape** %y.addr, align 8
  %29 = getelementptr inbounds %struct.Shape, %struct.Shape* %28, i32 0, i32 0
  %30 = load double, double* %29, align 8
  %31 = call i8* @nish_str_from_f64(double %30)
  %32 = call i8* @nish_str_concat(i8* %27, i8* %31)
  %33 = call i8* @nish_str_concat(i8* %32, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  %34 = load %struct.Map$str$$Square*, %struct.Map$str$$Square** %m.addr, align 8
  %35 = call i64 @nish.Map$str$$Square.probe(%struct.Map$str$$Square* %34, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %36 = icmp sge i64 %35, 0
  br i1 %36, label %nullish.value.1, label %nullish.default.1

nullish.value.1:
  %37 = trunc i64 %35 to i32
  %38 = call %struct.Square* @nish.Map$str$$Square.valueAt(%struct.Map$str$$Square* %34, i32 %37)
  br label %nullish.end.1

nullish.default.1:
  %39 = load %struct.Square*, %struct.Square** %unit.addr, align 8
  br label %nullish.end.1

nullish.end.1:
  %40 = phi %struct.Square* [ %38, %nullish.value.1 ], [ %39, %nullish.default.1 ]
  %41 = bitcast %struct.Square* %40 to %struct.Shape*
  %42 = call double @area(%struct.Shape* %41)
...
define internal noundef i32 @nish.homeBucket(i32 noundef %h, i32 noundef %mask) #3 {
entry:
  %0 = lshr i32 %h, 16
  %1 = xor i32 %h, %0
  %2 = and i32 %1, %mask
...
define internal noundef i32 @nish.slotWord(i32 noundef %h, i32 noundef %index) #3 {
entry:
  %0 = lshr i32 %h, 24
  %1 = shl i32 %0, 24
...
define internal noundef i64 @nish.foundAt(i32 noundef %bucket, i32 noundef %index) #3 {
entry:
...
define internal noundef i64 @nish.absentAt(i32 noundef %bucket, i32 noundef %h) #3 {
entry:
...
define internal void @nish.fileEntry(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %slots, i32 noundef %mask, i32 noundef %h, i32 noundef %index) #2 {
entry:
...
define internal void @nish.compactHashes(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %hashes) #2 {
entry:
...
define internal void @nish.refile(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %slots, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %hashes) #2 {
entry:
...
define internal void @nish.clearSlots(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %slots) #2 {
entry:
  %i.addr = alloca i32, align 4
  store i32 0, i32* %i.addr, align 4
  %0 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %slots, i64 0, i32 0
...
define internal void @nish.fileAppended(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %slots, i32 noundef %mask, i32 noundef %bucket, i32 noundef %h, i32 noundef %used) #2 {
entry:
...
define internal void @nish.Map$str$$Square.constructor(%struct.Map$str$$Square* noundef nonnull noalias align 8 dereferenceable(48) nocapture %this) #0 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 0
  store double 0x0000000000000000, double* %0, align 8, !tbaa !19
  %1 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !20
  %2 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 3
  ...
  %11 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 1
  ...
  %17 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 4
  ...
  %23 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 5
  ...
  %29 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 6
  store %struct.nish_array* %25, %struct.nish_array** %29, align 8, !tbaa !25
  ret void
}

define internal noundef i64 @nish.Map$str$$Square.probe(%struct.Map$str$$Square* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i8* noundef nonnull noalias readonly align 8 %key) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !22
  %2 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !20
  %4 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 6
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !25
  %6 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 4
...
define internal noundef nonnull align 8 dereferenceable(48) %struct.Map$str$$Square* @nish.Map$str$$Square.set(%struct.Map$str$$Square* noundef nonnull align 8 dereferenceable(48) %this, i8* noundef nonnull noalias readonly align 8 %key, %struct.Square* noundef nonnull align 8 dereferenceable(8) %value) #2 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$str$$Square.probe(%struct.Map$str$$Square* %this, i8* %key)
...
if.then:
  ...
  call void @nish.Map$str$$Square.setValueAt(%struct.Map$str$$Square* %this, i32 %4, %struct.Square* %value)
  br label %if.end

if.else:
  %5 = load i64, i64* %found.addr, align 8
  call void @nish.Map$str$$Square.insertAt(%struct.Map$str$$Square* %this, i64 %5, i8* %key, %struct.Square* %value)
  br label %if.end

if.end:
  ret %struct.Map$str$$Square* %this
}

define internal noundef nonnull align 8 dereferenceable(8) %struct.Square* @nish.Map$str$$Square.valueAt(%struct.Map$str$$Square* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index) #2 {
entry:
  %0 = icmp slt i32 %index, 0
  br i1 %0, label %lor.end, label %lor.rhs

lor.rhs:
  %1 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 5
...
bounds.ok:
  ...
  %19 = load %struct.Square*, %struct.Square** %18, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  ret %struct.Square* %19
}

define internal void @nish.Map$str$$Square.setValueAt(%struct.Map$str$$Square* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index, %struct.Square* noundef nonnull align 8 dereferenceable(8) %value) #0 {
entry:
...
if.then:
  ...
  store %struct.Square* %value, %struct.Square** %15, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  br label %if.end
...
define internal void @nish.Map$str$$Square.insertAt(%struct.Map$str$$Square* noundef nonnull align 8 dereferenceable(48) nocapture %this, i64 noundef %absent, i8* noundef nonnull noalias readonly align 8 %key, %struct.Square* noundef nonnull align 8 dereferenceable(8) %value) #2 {
entry:
  ...
  %7 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 4
...
if.then:
  %14 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 3
...
if.end.1:
  call void @nish.Map$str$$Square.rebuild(%struct.Map$str$$Square* %this)
  %17 = sub nsw i32 0, 1
  store i32 %17, i32* %bucket.addr, align 4
  br label %if.end

if.end:
  %18 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 4
  ...
  %23 = load i64, i64* %22, align 8, !alias.scope !3, !noalias !4, !tbaa !14
...
push.store:
  ...
  store i8* %key, i8** %28, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %29 = add i64 %21, 1
  store i64 %29, i64* %20, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %30 = sitofp i64 %29 to double
  %31 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 5
...
push.store.1:
  ...
  %40 = bitcast i8* %39 to %struct.Square**
  %41 = getelementptr inbounds %struct.Square*, %struct.Square** %40, i64 %34
  store %struct.Square* %value, %struct.Square** %41, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %42 = add i64 %34, 1
  store i64 %42, i64* %33, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %43 = sitofp i64 %42 to double
  %44 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 6
  ...
  %50 = load i64, i64* %49, align 8, !alias.scope !3, !noalias !4, !tbaa !14
...
push.store.2:
  ...
  store i32 %46, i32* %55, align 4, !alias.scope !4, !noalias !3, !tbaa !13
  %56 = add i64 %48, 1
  store i64 %56, i64* %47, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %57 = sitofp i64 %56 to double
  %58 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 3
  %59 = load i32, i32* %58, align 4, !tbaa !21
  %60 = add nsw i32 %59, 1
  %61 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 3
  store i32 %60, i32* %61, align 4, !tbaa !21
  %62 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 0
  %63 = load double, double* %62, align 8, !tbaa !19
  %64 = fadd double %63, 0x3FF0000000000000
  %65 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 0
  store double %64, double* %65, align 8, !tbaa !19
  %66 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 4
  ...
  %73 = mul nsw i32 %72, 4
  %74 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 1
...
if.else:
  %82 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 1
  %83 = load %struct.nish_array*, %struct.nish_array** %82, align 8, !tbaa !22
  %84 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 2
...
define internal void @nish.Map$str$$Square.rebuild(%struct.Map$str$$Square* noundef nonnull align 8 dereferenceable(48) nocapture %this) #2 {
entry:
  %used.addr = alloca i32, align 4
  %slots.addr = alloca %struct.nish_array*, align 8
  %0 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 4
  ...
  %6 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 1
  %7 = load %struct.nish_array*, %struct.nish_array** %6, align 8, !tbaa !22
  %8 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 3
  ...
  %12 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 3
...
if.then:
  %16 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 4
  %17 = load %struct.nish_array*, %struct.nish_array** %16, align 8, !tbaa !23
  %18 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 6
  ...
  %20 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 5
  %21 = load %struct.nish_array*, %struct.nish_array** %20, align 8, !tbaa !24
  %22 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 6
  %23 = load %struct.nish_array*, %struct.nish_array** %22, align 8, !tbaa !25
  call void @nish.compactEntries$$Square(%struct.nish_array* %21, %struct.nish_array* %23)
  %24 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 6
...
if.end:
  ...
  %27 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 1
  store %struct.nish_array* %26, %struct.nish_array** %27, align 8, !tbaa !22
  ...
  %33 = sub nsw i32 %32, 1
  %34 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 2
  store i32 %33, i32* %34, align 4, !tbaa !20
  %35 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %36 = getelementptr inbounds %struct.Map$str$$Square, %struct.Map$str$$Square* %this, i32 0, i32 6
...
land.rhs.1:
  ...
  %79 = load i8*, i8** %78, align 8, !alias.scope !4, !noalias !3, !tbaa !27
...
define internal void @nish.compactEntries$str(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %items, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %hashes) #2 {
entry:
  %used.addr = alloca i32, align 4
  %to.addr = alloca i32, align 4
  %from.addr = alloca i32, align 4
...
if.then:
  ...
  %44 = load i8*, i8** %43, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %45 = bitcast i8* %11 to i8**
  %46 = getelementptr inbounds i8*, i8** %45, i64 %39
  store i8* %44, i8** %46, align 8, !alias.scope !4, !noalias !3, !tbaa !27
...
pop.ok:
  ...
  %65 = load i8*, i8** %64, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  br label %while.cond
...
define internal void @nish.compactEntries$$Square(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %items, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %hashes) #2 {
entry:
  %used.addr = alloca i32, align 4
  %to.addr = alloca i32, align 4
  %from.addr = alloca i32, align 4
...
if.then:
  ...
  %40 = load i32, i32* %from.addr, align 4
  %41 = sext i32 %40 to i64
  %42 = bitcast i8* %11 to %struct.Square**
  %43 = getelementptr inbounds %struct.Square*, %struct.Square** %42, i64 %41
  %44 = load %struct.Square*, %struct.Square** %43, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %45 = bitcast i8* %11 to %struct.Square**
  %46 = getelementptr inbounds %struct.Square*, %struct.Square** %45, i64 %39
  store %struct.Square* %44, %struct.Square** %46, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  %47 = load i32, i32* %to.addr, align 4
  %48 = add nsw i32 %47, 1
  store i32 %48, i32* %to.addr, align 4
  br label %if.end
...
pop.ok:
  ...
  %61 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %items, i64 0, i32 2
  %62 = load i8*, i8** %61, align 8, !alias.scope !3, !noalias !4, !tbaa !11
  %63 = bitcast i8* %62 to %struct.Square**
  %64 = getelementptr inbounds %struct.Square*, %struct.Square** %63, i64 %60
  %65 = load %struct.Square*, %struct.Square** %64, align 8, !alias.scope !4, !noalias !3, !tbaa !27
  br label %while.cond
...
!16 = !{!"ptr", !6, i64 0}
!17 = !{!"i32", !6, i64 0}
!18 = !{!"Map$str$$Square", !15, i64 0, !16, i64 8, !17, i64 16, !17, i64 20, !16, i64 24, !16, i64 32, !16, i64 40}
!19 = !{!18, !15, i64 0}
!20 = !{!18, !17, i64 16}
!21 = !{!18, !17, i64 20}
!22 = !{!18, !16, i64 8}
