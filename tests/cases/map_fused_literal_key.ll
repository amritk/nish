...
@.str.0 = private unnamed_addr constant { i64, [4 x i8] } { i64 3, [4 x i8] c"sum\00" }, align 8
...
define internal void @add(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %totals, double noundef %x) #0 {
entry:
  %0 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %totals, i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*))
  %1 = icmp sge i64 %0, 0
  br i1 %1, label %nullish.value, label %nullish.default

nullish.value:
  %2 = trunc i64 %0 to i32
  %3 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %totals, i32 %2)
...
set.found:
  ...
  call void @nish.Map$str$f64.setValueAt(%struct.Map$str$f64* %totals, i32 %6, double %5)
  br label %set.end

set.insert:
  call void @nish.Map$str$f64.insertAt(%struct.Map$str$f64* %totals, i64 %0, i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*), double %5)
  br label %set.end
...
entry:
  %totals.addr = alloca %struct.Map$str$f64*, align 8
  ...
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %totals.addr, align 8
  %2 = load %struct.Map$str$f64*, %struct.Map$str$f64** %totals.addr, align 8
  call void @add(%struct.Map$str$f64* %2, double 0x4004000000000000)
  %3 = load %struct.Map$str$f64*, %struct.Map$str$f64** %totals.addr, align 8
  call void @add(%struct.Map$str$f64* %3, double 0x4010000000000000)
  %4 = load %struct.Map$str$f64*, %struct.Map$str$f64** %totals.addr, align 8
  %5 = fneg double 0x3FF0000000000000
  call void @add(%struct.Map$str$f64* %4, double %5)
  %6 = load %struct.Map$str$f64*, %struct.Map$str$f64** %totals.addr, align 8
  %7 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %6, i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*))
  %8 = icmp sge i64 %7, 0
  br i1 %8, label %nullish.value, label %nullish.default

nullish.value:
  %9 = trunc i64 %7 to i32
  %10 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %6, i32 %9)
  br label %nullish.end

nullish.default:
  %11 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %12 = phi double [ %10, %nullish.value ], [ %11, %nullish.default ]
  %13 = call i8* @nish_str_from_f64(double %12)
  %14 = call i8* @nish_str_concat(i8* %13, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %15 = load %struct.Map$str$f64*, %struct.Map$str$f64** %totals.addr, align 8
