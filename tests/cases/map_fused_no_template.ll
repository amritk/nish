%struct.Map$str$str = type { double, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array*, i32 }
%struct.nish_array = type { i64, i64, i8* }
%struct.nish_arena = type { i8*, i64, i64, i8* }

@.str.0 = private unnamed_addr constant { i64, [1 x i8] } { i64 0, [1 x i8] c"\00" }, align 8
@.str.1 = private unnamed_addr constant { i64, [2 x i8] } { i64 1, [2 x i8] c"!\00" }, align 8
@.str.2 = private unnamed_addr constant { i64, [4 x i8] } { i64 3, [4 x i8] c"hey\00" }, align 8
...
define internal void @shout(%struct.Map$str$str* noundef nonnull align 8 dereferenceable(56) %m, i8* noundef nonnull noalias readonly align 8 %k) #0 {
entry:
  %0 = call i64 @nish.Map$str$str.probe(%struct.Map$str$str* %m, i8* %k)
  %1 = icmp sge i64 %0, 0
  br i1 %1, label %nullish.value, label %nullish.default

nullish.value:
  %2 = trunc i64 %0 to i32
  %3 = call i8* @nish.Map$str$str.valueAt(%struct.Map$str$str* %m, i32 %2)
...
nullish.end:
  %4 = phi i8* [ %3, %nullish.value ], [ bitcast ({ i64, [1 x i8] }* @.str.0 to i8*), %nullish.default ]
  %5 = call i8* @nish_str_concat(i8* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
  %6 = call %struct.Map$str$str* @nish.Map$str$str.set(%struct.Map$str$str* %m, i8* %k, i8* %5)
  ret void
}

define noundef i32 @nish_main() #0 {
entry:
  %m.addr = alloca %struct.Map$str$str*, align 8
  %arena.mark = call i64 @nish_arena_mark()
  %0 = call i8* @nish_alloc_struct(i64 56)
  %1 = bitcast i8* %0 to %struct.Map$str$str*
  call void @nish.Map$str$str.constructor(%struct.Map$str$str* %1)
  store %struct.Map$str$str* %1, %struct.Map$str$str** %m.addr, align 8
  %2 = load %struct.Map$str$str*, %struct.Map$str$str** %m.addr, align 8
  call void @shout(%struct.Map$str$str* %2, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*))
  %3 = load %struct.Map$str$str*, %struct.Map$str$str** %m.addr, align 8
  call void @shout(%struct.Map$str$str* %3, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*))
  %4 = load %struct.Map$str$str*, %struct.Map$str$str** %m.addr, align 8
  %5 = call i64 @nish.Map$str$str.probe(%struct.Map$str$str* %4, i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*))
  %6 = icmp sge i64 %5, 0
  br i1 %6, label %nullish.value, label %nullish.default

nullish.value:
  %7 = trunc i64 %5 to i32
  %8 = call i8* @nish.Map$str$str.valueAt(%struct.Map$str$str* %4, i32 %7)
  br label %nullish.end
...
nullish.end:
  %9 = phi i8* [ %8, %nullish.value ], [ bitcast ({ i64, [2 x i8] }* @.str.3 to i8*), %nullish.default ]
  %10 = call i8* @nish_str_concat(i8* %9, i8* bitcast ({ i64, [2 x i8] }* @.str.4 to i8*))
  %11 = load %struct.Map$str$str*, %struct.Map$str$str** %m.addr, align 8
  %12 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %11, i32 0, i32 0
...
define internal void @nish.Map$str$str.constructor(%struct.Map$str$str* noundef nonnull noalias align 8 dereferenceable(56) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 0
  store double 0x0000000000000000, double* %0, align 8, !tbaa !6
  %1 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !20
  %2 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 3
  store i32 0, i32* %2, align 4, !tbaa !21
  %3 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 7
  ...
  %12 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 1
  ...
  %18 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 4
  ...
  %24 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 5
  ...
  %30 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 6
  store %struct.nish_array* %26, %struct.nish_array** %30, align 8, !tbaa !26
  ret void
}

define internal noundef i64 @nish.Map$str$str.probe(%struct.Map$str$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i8* noundef nonnull noalias readonly align 8 %key) #0 {
entry:
  %0 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !23
  %2 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !20
  %4 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 6
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !26
  %6 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 4
...
define internal noundef nonnull align 8 dereferenceable(56) %struct.Map$str$str* @nish.Map$str$str.set(%struct.Map$str$str* noundef nonnull align 8 dereferenceable(56) %this, i8* noundef nonnull noalias readonly align 8 %key, i8* noundef nonnull noalias readonly align 8 %value) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$str$str.probe(%struct.Map$str$str* %this, i8* %key)
...
if.then:
  ...
  call void @nish.Map$str$str.setValueAt(%struct.Map$str$str* %this, i32 %4, i8* %value)
  br label %if.end

if.else:
  %5 = load i64, i64* %found.addr, align 8
  call void @nish.Map$str$str.insertAt(%struct.Map$str$str* %this, i64 %5, i8* %key, i8* %value)
  br label %if.end

if.end:
  ret %struct.Map$str$str* %this
}

define internal noundef nonnull align 8 i8* @nish.Map$str$str.valueAt(%struct.Map$str$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index) #0 {
entry:
  %0 = icmp slt i32 %index, 0
  br i1 %0, label %lor.end, label %lor.rhs

lor.rhs:
  %1 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 5
...
if.end:
  %9 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 5
...
bounds.ok:
  ...
  %19 = load i8*, i8** %18, align 8, !alias.scope !11, !noalias !10, !tbaa !28
  ret i8* %19
}

define internal void @nish.Map$str$str.setValueAt(%struct.Map$str$str* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index, i8* noundef nonnull noalias readonly align 8 %value) #2 {
entry:
...
if.then:
  ...
  store i8* %value, i8** %15, align 8, !alias.scope !11, !noalias !10, !tbaa !28
  br label %if.end
...
define internal void @nish.Map$str$str.insertAt(%struct.Map$str$str* noundef nonnull align 8 dereferenceable(56) nocapture %this, i64 noundef %absent, i8* noundef nonnull noalias readonly align 8 %key, i8* noundef nonnull noalias readonly align 8 %value) #0 {
entry:
  ...
  %7 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 4
...
if.then:
  %14 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 3
  %15 = load i32, i32* %14, align 4, !tbaa !21
  %16 = icmp sge i32 %15, 16777215
  br i1 %16, label %lor.end, label %lor.rhs

lor.rhs:
  %17 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 7
...
if.end.1:
  call void @nish.Map$str$str.rebuild(%struct.Map$str$str* %this)
  %21 = sub nsw i32 0, 1
  store i32 %21, i32* %bucket.addr, align 4
  br label %if.end

if.end:
  %22 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 4
...
push.store:
  ...
  store i8* %key, i8** %32, align 8, !alias.scope !11, !noalias !10, !tbaa !28
  %33 = add i64 %25, 1
  store i64 %33, i64* %24, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %34 = sitofp i64 %33 to double
  %35 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 5
...
push.store.1:
  ...
  store i8* %value, i8** %45, align 8, !alias.scope !11, !noalias !10, !tbaa !28
  %46 = add i64 %38, 1
  store i64 %46, i64* %37, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %47 = sitofp i64 %46 to double
  %48 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 6
...
push.store.2:
  ...
  %62 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 3
  %63 = load i32, i32* %62, align 4, !tbaa !21
  %64 = add nsw i32 %63, 1
  %65 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 3
  store i32 %64, i32* %65, align 4, !tbaa !21
  %66 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 0
  %67 = load double, double* %66, align 8, !tbaa !6
  %68 = fadd double %67, 0x3FF0000000000000
  %69 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 0
  store double %68, double* %69, align 8, !tbaa !6
  %70 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 4
  ...
  %77 = mul nsw i32 %76, 4
  %78 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 1
...
if.else:
  %86 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 1
  %87 = load %struct.nish_array*, %struct.nish_array** %86, align 8, !tbaa !23
  %88 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 2
...
define internal void @nish.Map$str$str.rebuild(%struct.Map$str$str* noundef nonnull align 8 dereferenceable(56) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  %walking.addr = alloca i1, align 1
  %slots.addr = alloca %struct.nish_array*, align 8
  %0 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 4
  ...
  %6 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 7
  %7 = load i32, i32* %6, align 4, !tbaa !22
  %8 = icmp sgt i32 %7, 0
  store i1 %8, i1* %walking.addr, align 1
  %9 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 1
...
cond.false:
  %13 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 3
...
land.rhs:
  %20 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 3
...
if.then:
  %25 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 4
  %26 = load %struct.nish_array*, %struct.nish_array** %25, align 8, !tbaa !24
  %27 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 6
  ...
  %29 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 5
  %30 = load %struct.nish_array*, %struct.nish_array** %29, align 8, !tbaa !25
  %31 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 6
  ...
  %33 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 6
...
if.end:
  ...
  %36 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 1
  ...
  %42 = sub nsw i32 %41, 1
  %43 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 2
  store i32 %42, i32* %43, align 4, !tbaa !20
  %44 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %45 = getelementptr inbounds %struct.Map$str$str, %struct.Map$str$str* %this, i32 0, i32 6
...
hash.done:
  ...
  %22 = load i8*, i8** %21, align 8, !alias.scope !10, !noalias !11, !tbaa !16
  ...
  %28 = load i64, i64* %27, align 8, !alias.scope !10, !noalias !11, !tbaa !15
...
while.body:
  ...
  %42 = load i32, i32* %41, align 4, !alias.scope !11, !noalias !10, !tbaa !18
...
land.rhs.3:
  ...
  %66 = load i32, i32* %65, align 4, !alias.scope !11, !noalias !10, !tbaa !18
...
land.rhs.1:
  ...
  %79 = load i8*, i8** %78, align 8, !alias.scope !11, !noalias !10, !tbaa !28
...
if.then:
  ...
  %44 = load i8*, i8** %43, align 8, !alias.scope !11, !noalias !10, !tbaa !28
  %45 = bitcast i8* %11 to i8**
  %46 = getelementptr inbounds i8*, i8** %45, i64 %39
  store i8* %44, i8** %46, align 8, !alias.scope !11, !noalias !10, !tbaa !28
...
pop.ok:
  ...
  %65 = load i8*, i8** %64, align 8, !alias.scope !11, !noalias !10, !tbaa !28
  br label %while.cond
...
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"i32", !1, i64 0}
!5 = !{!"Map$str$str", !2, i64 0, !3, i64 8, !4, i64 16, !4, i64 20, !3, i64 24, !3, i64 32, !3, i64 40, !4, i64 48}
!6 = !{!5, !2, i64 0}
!7 = !{!"nish array"}
!8 = !{!"header", !7}
!9 = !{!"elements", !7}
