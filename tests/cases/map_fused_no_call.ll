...
define internal noundef double @bump(double noundef %n) #0 {
entry:
  %0 = fadd double %n, 0x3FF0000000000000
  ret double %0
}

define internal void @touch(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %m, i8* noundef nonnull noalias readonly align 8 %k) #1 {
entry:
...
nullish.end:
  ...
  %5 = call double @bump(double %4)
  %6 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %m, i8* %k, double %5)
  ret void
}
...
entry:
  ...
  call void @touch(%struct.Map$str$f64* %2, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %3 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @touch(%struct.Map$str$f64* %3, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %4 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  call void @touch(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
...
define internal noundef i32 @nish.homeBucket(i32 noundef %h, i32 noundef %mask) #0 {
entry:
  %0 = lshr i32 %h, 16
  %1 = xor i32 %h, %0
  %2 = and i32 %1, %mask
...
define internal noundef i64 @nish.foundAt(i32 noundef %bucket, i32 noundef %index) #0 {
entry:
...
define internal noundef nonnull align 8 dereferenceable(56) %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %this, i8* noundef nonnull noalias readonly align 8 %key, double noundef %value) #1 {
entry:
