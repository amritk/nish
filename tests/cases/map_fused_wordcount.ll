...
define internal void @count(%struct.Map$str$f64* noundef nonnull align 8 dereferenceable(56) %counts, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %words) #0 {
entry:
...
forof.body:
  ...
  %10 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %counts, i8* %9)
  %11 = icmp sge i64 %10, 0
  br i1 %11, label %nullish.value, label %nullish.default

nullish.value:
  %12 = trunc i64 %10 to i32
  %13 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %counts, i32 %12)
...
nullish.end:
  %14 = phi double [ %13, %nullish.value ], [ 0x0000000000000000, %nullish.default ]
  %15 = fadd double %14, 0x3FF0000000000000
  br i1 %11, label %set.found, label %set.insert

set.found:
  %16 = trunc i64 %10 to i32
  call void @nish.Map$str$f64.setValueAt(%struct.Map$str$f64* %counts, i32 %16, double %15)
  br label %set.end

set.insert:
  call void @nish.Map$str$f64.insertAt(%struct.Map$str$f64* %counts, i64 %10, i8* %9, double %15)
  br label %set.end
...
entry:
  ...
  store %struct.Map$str$f64* %1, %struct.Map$str$f64** %counts.addr, align 8
  %2 = load %struct.Map$str$f64*, %struct.Map$str$f64** %counts.addr, align 8
  %3 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 0
  store i64 10, i64* %3, align 8, !alias.scope !3, !noalias !4, !tbaa !10
  %4 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 1
  store i64 10, i64* %4, align 8, !alias.scope !3, !noalias !4, !tbaa !14
  %5 = bitcast [10 x i8*]* %arr.data to i8*
  ...
  store i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*), i8** %8, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %9 = getelementptr inbounds i8*, i8** %7, i64 1
  store i8* bitcast ({ i64, [4 x i8] }* @.str.1 to i8*), i8** %9, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %10 = getelementptr inbounds i8*, i8** %7, i64 2
  store i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*), i8** %10, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %11 = getelementptr inbounds i8*, i8** %7, i64 3
  store i8* bitcast ({ i64, [3 x i8] }* @.str.3 to i8*), i8** %11, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %12 = getelementptr inbounds i8*, i8** %7, i64 4
  store i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*), i8** %12, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %13 = getelementptr inbounds i8*, i8** %7, i64 5
  store i8* bitcast ({ i64, [4 x i8] }* @.str.4 to i8*), i8** %13, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %14 = getelementptr inbounds i8*, i8** %7, i64 6
  store i8* bitcast ({ i64, [4 x i8] }* @.str.5 to i8*), i8** %14, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %15 = getelementptr inbounds i8*, i8** %7, i64 7
  store i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*), i8** %15, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %16 = getelementptr inbounds i8*, i8** %7, i64 8
  store i8* bitcast ({ i64, [4 x i8] }* @.str.1 to i8*), i8** %16, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %17 = getelementptr inbounds i8*, i8** %7, i64 9
  store i8* bitcast ({ i64, [4 x i8] }* @.str.6 to i8*), i8** %17, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  call void @count(%struct.Map$str$f64* %2, %struct.nish_array* %arr.hdr)
  %18 = load %struct.Map$str$f64*, %struct.Map$str$f64** %counts.addr, align 8
  call void @nish.Map$str$f64.walkOpen(%struct.Map$str$f64* %18)
  %19 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %18, i32 0)
  store i32 %19, i32* %walk.idx, align 4
  br label %walk.cond

walk.cond:
  %20 = load i32, i32* %walk.idx, align 4
  %21 = icmp sge i32 %20, 0
  br i1 %21, label %walk.body, label %walk.end

walk.body:
  %22 = call i8* @nish.Map$str$f64.keyAt(%struct.Map$str$f64* %18, i32 %20)
  store i8* %22, i8** %w.addr, align 8
  ...
  %28 = call i8* @nish_str_concat(i8* %27, i8* bitcast ({ i64, [2 x i8] }* @.str.7 to i8*))
  %29 = load %struct.Map$str$f64*, %struct.Map$str$f64** %counts.addr, align 8
  %30 = load i8*, i8** %w.addr, align 8
  %31 = call i64 @nish.Map$str$f64.probe(%struct.Map$str$f64* %29, i8* %30)
  %32 = icmp sge i64 %31, 0
  br i1 %32, label %nullish.value, label %nullish.default

nullish.value:
  %33 = trunc i64 %31 to i32
  %34 = call double @nish.Map$str$f64.valueAt(%struct.Map$str$f64* %29, i32 %33)
  br label %nullish.end

nullish.default:
  %35 = fneg double 0x3FF0000000000000
  br label %nullish.end

nullish.end:
  %36 = phi double [ %34, %nullish.value ], [ %35, %nullish.default ]
  ...
  %41 = icmp eq i8* %40, %24
  br i1 %41, label %pass.rewind, label %pass.free
...
walk.inc:
  %45 = add i32 %20, 1
  %46 = call i32 @nish.Map$str$f64.walkNext(%struct.Map$str$f64* %18, i32 %45)
  store i32 %46, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$str$f64.walkClose(%struct.Map$str$f64* %18)
  %47 = load %struct.Map$str$f64*, %struct.Map$str$f64** %counts.addr, align 8
  %48 = getelementptr inbounds %struct.Map$str$f64, %struct.Map$str$f64* %47, i32 0, i32 0
  %49 = load double, double* %48, align 8, !tbaa !19
  %50 = call i8* @nish_str_from_f64(double %49)
  %51 = call i8* @nish_str_concat(i8* %50, i8* bitcast ({ i64, [7 x i8] }* @.str.8 to i8*))
...
bounds.ok:
  ...
  %19 = load i8*, i8** %18, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  ret i8* %19
}
...
land.rhs.1:
  ...
  %79 = load i8*, i8** %78, align 8, !alias.scope !4, !noalias !3, !tbaa !13
...
if.then:
  ...
  %44 = load i8*, i8** %43, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  %45 = bitcast i8* %11 to i8**
  %46 = getelementptr inbounds i8*, i8** %45, i64 %39
  store i8* %44, i8** %46, align 8, !alias.scope !4, !noalias !3, !tbaa !13
...
pop.ok:
  ...
  %65 = load i8*, i8** %64, align 8, !alias.scope !4, !noalias !3, !tbaa !13
  br label %while.cond
