...
@.str.2 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c"flat \00" }, align 8
...
@.str.5 = private unnamed_addr constant { i64, [7 x i8] } { i64 6, [7 x i8] c" size \00" }, align 8
...
entry:
  ...
  %3 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %2, double 0x3FF0000000000000, double 0x3FF0000000000000)
  %4 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %3, double 0x4000000000000000, double 0x4000000000000000)
  %5 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %4, double 0x4008000000000000, double 0x4008000000000000)
...
walk.body:
  ...
  store double %10, double* %a.addr, align 8
  ...
  store i8* %13, i8** %row.addr, align 8
  %14 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  call void @nish.Map$f64$f64.walkOpen(%struct.Map$f64$f64* %14)
  %15 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %14, i32 0)
  store i32 %15, i32* %walk.idx.1, align 4
  br label %walk.cond.1

walk.cond.1:
  %16 = load i32, i32* %walk.idx.1, align 4
  %17 = icmp sge i32 %16, 0
  br i1 %17, label %walk.body.1, label %walk.end.1

walk.body.1:
  %18 = call double @nish.Map$f64$f64.keyAt(%struct.Map$f64$f64* %14, i32 %16)
  store double %18, double* %b.addr, align 8
  %19 = load i8*, i8** %row.addr, align 8
  ...
  store i8* %23, i8** %row.addr, align 8
  %24 = load double, double* %a.addr, align 8
  %25 = fcmp oeq double %24, 0x3FF0000000000000
  br i1 %25, label %land.rhs, label %land.end

land.rhs:
  %26 = load double, double* %b.addr, align 8
  %27 = fcmp oeq double %26, 0x4000000000000000
  br label %land.end

land.end:
  %28 = phi i1 [ false, %walk.body.1 ], [ %27, %land.rhs ]
  br i1 %28, label %if.then, label %if.end

if.then:
  %29 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %30 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %29, double 0x4010000000000000, double 0x4010000000000000)
  %31 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %32 = call i1 @nish.Map$f64$f64.delete(%struct.Map$f64$f64* %31, double 0x4008000000000000)
  br label %if.end
...
walk.inc.1:
  %33 = load i32, i32* %walk.idx.1, align 4
  %34 = add i32 %33, 1
  %35 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %14, i32 %34)
  store i32 %35, i32* %walk.idx.1, align 4
  br label %walk.cond.1

walk.end.1:
  call void @nish.Map$f64$f64.walkClose(%struct.Map$f64$f64* %14)
  %36 = load i8*, i8** %row.addr, align 8
  call void @nish_print(i8* %36)
  br label %walk.inc

walk.inc:
  %37 = load i32, i32* %walk.idx, align 4
  %38 = add i32 %37, 1
  %39 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %6, i32 %38)
  store i32 %39, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$f64$f64.walkClose(%struct.Map$f64$f64* %6)
  %40 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %41 = call i1 @churnsFlat(%struct.Map$f64$f64* %40)
  %42 = select i1 %41, i8* bitcast ({ i64, [5 x i8] }* @.str.3 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.4 to i8*)
  %43 = call i8* @nish_str_concat(i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*), i8* %42)
  %44 = call i8* @nish_str_concat(i8* %43, i8* bitcast ({ i64, [7 x i8] }* @.str.5 to i8*))
  %45 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %46 = getelementptr inbounds %struct.Map$f64$f64, %struct.Map$f64$f64* %45, i32 0, i32 0
