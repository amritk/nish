%struct.Map$i64$i32 = type { i32, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array* }
...
entry:
  ...
  %1 = sub nsw i64 0, 4294967296
  store i64 %1, i64* %k4.addr, align 8
  %2 = call i8* @nish_alloc_struct(i64 48)
  %3 = bitcast i8* %2 to %struct.Map$i64$i32*
  call void @nish.Map$i64$i32.constructor(%struct.Map$i64$i32* %3)
  store %struct.Map$i64$i32* %3, %struct.Map$i64$i32** %m.addr, align 8
  %4 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %5 = load i64, i64* %k0.addr, align 8
  %6 = call %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* %4, i64 %5, i32 1)
  %7 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %8 = load i64, i64* %k1.addr, align 8
  %9 = call %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* %7, i64 %8, i32 2)
  %10 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %11 = load i64, i64* %k2.addr, align 8
  %12 = call %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* %10, i64 %11, i32 3)
  %13 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %14 = load i64, i64* %k3.addr, align 8
  %15 = call %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* %13, i64 %14, i32 4)
  %16 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %17 = load i64, i64* %k4.addr, align 8
  %18 = call %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* %16, i64 %17, i32 5)
  store i32 0, i32* %found.addr, align 4
  %19 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %20 = load i64, i64* %k0.addr, align 8
  %21 = call i1 @nish.Map$i64$i32.has(%struct.Map$i64$i32* %19, i64 %20)
  br i1 %21, label %if.then, label %if.end

if.then:
  %22 = load i32, i32* %found.addr, align 4
  %23 = add nsw i32 %22, 1
  store i32 %23, i32* %found.addr, align 4
  br label %if.end

if.end:
  %24 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %25 = load i64, i64* %k1.addr, align 8
  %26 = call i1 @nish.Map$i64$i32.has(%struct.Map$i64$i32* %24, i64 %25)
...
if.end.2:
  %34 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %35 = load i64, i64* %k3.addr, align 8
  %36 = call i1 @nish.Map$i64$i32.has(%struct.Map$i64$i32* %34, i64 %35)
  br i1 %36, label %if.then.3, label %if.end.3
...
if.end.3:
  %39 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %40 = load i64, i64* %k4.addr, align 8
  %41 = call i1 @nish.Map$i64$i32.has(%struct.Map$i64$i32* %39, i64 %40)
  br i1 %41, label %if.then.4, label %if.end.4
...
if.end.4:
  %44 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %45 = load i64, i64* %k0.addr, align 8
  %46 = call %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* %44, i64 %45, i32 10)
  %47 = load i64, i64* %k1.addr, align 8
  %48 = call %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* %46, i64 %47, i32 20)
  %49 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %50 = load i64, i64* %k2.addr, align 8
  %51 = call i1 @nish.Map$i64$i32.delete(%struct.Map$i64$i32* %49, i64 %50)
  store i1 %51, i1* %gone.addr, align 1
  %52 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %53 = load i64, i64* %k2.addr, align 8
  %54 = call i1 @nish.Map$i64$i32.delete(%struct.Map$i64$i32* %52, i64 %53)
  store i1 %54, i1* %again.addr, align 1
  %55 = load i32, i32* %found.addr, align 4
  ...
  %59 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %58, i32 0, i32 0
  ...
  %64 = load i1, i1* %gone.addr, align 1
  %65 = select i1 %64, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %66 = call i8* @nish_str_concat(i8* %63, i8* %65)
  %67 = call i8* @nish_str_concat(i8* %66, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %68 = load i1, i1* %again.addr, align 1
  %69 = select i1 %68, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %70 = call i8* @nish_str_concat(i8* %67, i8* %69)
  %71 = call i8* @nish_str_concat(i8* %70, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %72 = load %struct.Map$i64$i32*, %struct.Map$i64$i32** %m.addr, align 8
  %73 = load i64, i64* %k2.addr, align 8
  %74 = call i1 @nish.Map$i64$i32.has(%struct.Map$i64$i32* %72, i64 %73)
  %75 = select i1 %74, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %76 = call i8* @nish_str_concat(i8* %71, i8* %75)
  ...
  %79 = load i64, i64* %k3.addr, align 8
...
define internal void @nish.Map$i64$i32.constructor(%struct.Map$i64$i32* noundef nonnull noalias align 8 dereferenceable(48) nocapture %this) #2 {
entry:
  ...
  %11 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 1
  ...
  %17 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 4
  ...
  %23 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 5
  ...
  %29 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 6
  store %struct.nish_array* %25, %struct.nish_array** %29, align 8, !tbaa !24
  ret void
}

define internal noundef i64 @nish.Map$i64$i32.probe(%struct.Map$i64$i32* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i64 noundef %key) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$i64$i32.has(%struct.Map$i64$i32* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i64 noundef %key) #0 {
entry:
...
define internal noundef nonnull align 8 dereferenceable(48) %struct.Map$i64$i32* @nish.Map$i64$i32.set(%struct.Map$i64$i32* noundef nonnull align 8 dereferenceable(48) %this, i64 noundef %key, i32 noundef %value) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$i64$i32.delete(%struct.Map$i64$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this, i64 noundef %key) #0 {
entry:
  %found.addr = alloca i64, align 8
...
if.then.1:
  %18 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 1
...
if.then.2:
  %36 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 6
...
if.end.2:
  %44 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 3
  %45 = load i32, i32* %44, align 4, !tbaa !20
  %46 = sub nsw i32 %45, 1
  %47 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 3
  store i32 %46, i32* %47, align 4, !tbaa !20
  %48 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 0
  %49 = load i32, i32* %48, align 4, !tbaa !5
  %50 = sub nsw i32 %49, 1
  %51 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 0
  store i32 %50, i32* %51, align 4, !tbaa !5
  ret i1 true
}

define internal void @nish.Map$i64$i32.setValueAt(%struct.Map$i64$i32* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index, i32 noundef %value) #2 {
entry:
...
define internal void @nish.Map$i64$i32.insertAt(%struct.Map$i64$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this, i64 noundef %absent, i64 noundef %key, i32 noundef %value) #0 {
entry:
  ...
  %7 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 4
...
push.store:
  ...
  %30 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 5
...
push.store.2:
  ...
  %57 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 3
  %58 = load i32, i32* %57, align 4, !tbaa !20
  %59 = add nsw i32 %58, 1
  %60 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 3
  store i32 %59, i32* %60, align 4, !tbaa !20
  %61 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 0
  %62 = load i32, i32* %61, align 4, !tbaa !5
  %63 = add nsw i32 %62, 1
  %64 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 0
  store i32 %63, i32* %64, align 4, !tbaa !5
  %65 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 4
...
land.rhs:
  ...
  %73 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 1
...
if.else:
  %95 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 1
  %96 = load %struct.nish_array*, %struct.nish_array** %95, align 8, !tbaa !21
  %97 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 2
...
if.end.2:
  ...
  %104 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 1
...
define internal void @nish.Map$i64$i32.rebuild(%struct.Map$i64$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  ...
  %5 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 1
  %6 = load %struct.nish_array*, %struct.nish_array** %5, align 8, !tbaa !21
  %7 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 3
  ...
  %11 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 3
...
if.then:
  %15 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 4
  %16 = load %struct.nish_array*, %struct.nish_array** %15, align 8, !tbaa !22
  %17 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 6
  %18 = load %struct.nish_array*, %struct.nish_array** %17, align 8, !tbaa !24
  call void @nish.compactEntries$i64(%struct.nish_array* %16, %struct.nish_array* %18)
  %19 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 5
  %20 = load %struct.nish_array*, %struct.nish_array** %19, align 8, !tbaa !23
  %21 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 6
  ...
  %23 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 6
...
if.end:
  ...
  %27 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 1
  ...
  %32 = sub nsw i32 %31, 1
  %33 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 2
  store i32 %32, i32* %33, align 4, !tbaa !19
  %34 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %35 = getelementptr inbounds %struct.Map$i64$i32, %struct.Map$i64$i32* %this, i32 0, i32 6
...
!2 = !{!"i32", !1, i64 0}
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"Map$i64$i32", !2, i64 0, !3, i64 8, !2, i64 16, !2, i64 20, !3, i64 24, !3, i64 32, !3, i64 40}
!5 = !{!4, !2, i64 0}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
!8 = !{!"elements", !6}
