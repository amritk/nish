%struct.Map$u8$i32 = type { i32, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array*, i32 }
...
entry:
  %k0.addr = alloca i8, align 1
  %k1.addr = alloca i8, align 1
  %k2.addr = alloca i8, align 1
  %k3.addr = alloca i8, align 1
  %k4.addr = alloca i8, align 1
  %m.addr = alloca %struct.Map$u8$i32*, align 8
  %found.addr = alloca i32, align 4
  %gone.addr = alloca i1, align 1
  %again.addr = alloca i1, align 1
  %arena.mark = call i64 @nish_arena_mark()
  store i8 0, i8* %k0.addr, align 1
  store i8 1, i8* %k1.addr, align 1
  store i8 127, i8* %k2.addr, align 1
  store i8 128, i8* %k3.addr, align 1
  store i8 255, i8* %k4.addr, align 1
  %0 = call i8* @nish_alloc_struct(i64 56)
  %1 = bitcast i8* %0 to %struct.Map$u8$i32*
  call void @nish.Map$u8$i32.constructor(%struct.Map$u8$i32* %1)
  store %struct.Map$u8$i32* %1, %struct.Map$u8$i32** %m.addr, align 8
  %2 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %3 = load i8, i8* %k0.addr, align 1
  %4 = call %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* %2, i8 %3, i32 1)
  %5 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %6 = load i8, i8* %k1.addr, align 1
  %7 = call %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* %5, i8 %6, i32 2)
  %8 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %9 = load i8, i8* %k2.addr, align 1
  %10 = call %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* %8, i8 %9, i32 3)
  %11 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %12 = load i8, i8* %k3.addr, align 1
  %13 = call %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* %11, i8 %12, i32 4)
  %14 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %15 = load i8, i8* %k4.addr, align 1
  %16 = call %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* %14, i8 %15, i32 5)
  store i32 0, i32* %found.addr, align 4
  %17 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %18 = load i8, i8* %k0.addr, align 1
  %19 = call i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* %17, i8 %18)
...
if.end:
  %22 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %23 = load i8, i8* %k1.addr, align 1
  %24 = call i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* %22, i8 %23)
...
if.end.1:
  %27 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %28 = load i8, i8* %k2.addr, align 1
  %29 = call i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* %27, i8 %28)
...
if.end.2:
  %32 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %33 = load i8, i8* %k3.addr, align 1
  %34 = call i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* %32, i8 %33)
...
if.end.3:
  %37 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %38 = load i8, i8* %k4.addr, align 1
  %39 = call i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* %37, i8 %38)
...
if.end.4:
  %42 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %43 = load i8, i8* %k0.addr, align 1
  %44 = call %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* %42, i8 %43, i32 10)
  %45 = load i8, i8* %k1.addr, align 1
  %46 = call %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* %44, i8 %45, i32 20)
  %47 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %48 = load i8, i8* %k2.addr, align 1
  %49 = call i1 @nish.Map$u8$i32.delete(%struct.Map$u8$i32* %47, i8 %48)
  store i1 %49, i1* %gone.addr, align 1
  %50 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %51 = load i8, i8* %k2.addr, align 1
  %52 = call i1 @nish.Map$u8$i32.delete(%struct.Map$u8$i32* %50, i8 %51)
  ...
  %56 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %57 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %56, i32 0, i32 0
  ...
  %70 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %71 = load i8, i8* %k2.addr, align 1
  %72 = call i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* %70, i8 %71)
  ...
  %76 = load %struct.Map$u8$i32*, %struct.Map$u8$i32** %m.addr, align 8
  %77 = load i8, i8* %k3.addr, align 1
  %78 = call i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* %76, i8 %77)
...
define internal void @nish.Map$u8$i32.constructor(%struct.Map$u8$i32* noundef nonnull noalias align 8 dereferenceable(56) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  store i32 0, i32* %0, align 4, !tbaa !5
  %1 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !19
  %2 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  store i32 0, i32* %2, align 4, !tbaa !20
  %3 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 7
  ...
  %12 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  ...
  %18 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
  ...
  %24 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
  ...
  %30 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
  store %struct.nish_array* %26, %struct.nish_array** %30, align 8, !tbaa !25
  ret void
}

define internal noundef i64 @nish.Map$u8$i32.probe(%struct.Map$u8$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i8 noundef %key) #0 {
entry:
  %0 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !22
  %2 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !19
  %4 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !25
  %6 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
  %7 = load %struct.nish_array*, %struct.nish_array** %6, align 8, !tbaa !23
  %8 = call i64 @nish.probeTable$u8(%struct.nish_array* %1, i32 %3, %struct.nish_array* %5, %struct.nish_array* %7, i8 %key)
  ret i64 %8
}

define internal noundef zeroext i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i8 noundef %key) #0 {
entry:
  %0 = call i64 @nish.Map$u8$i32.probe(%struct.Map$u8$i32* %this, i8 %key)
  %1 = icmp sge i64 %0, 0
  ret i1 %1
}

define internal noundef nonnull align 8 dereferenceable(56) %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(56) %this, i8 noundef %key, i32 noundef %value) #0 {
entry:
...
if.then:
  ...
  call void @nish.Map$u8$i32.setValueAt(%struct.Map$u8$i32* %this, i32 %4, i32 %value)
  br label %if.end

if.else:
  %5 = load i64, i64* %found.addr, align 8
  call void @nish.Map$u8$i32.insertAt(%struct.Map$u8$i32* %this, i64 %5, i8 %key, i32 %value)
  br label %if.end

if.end:
  ret %struct.Map$u8$i32* %this
}

define internal noundef zeroext i1 @nish.Map$u8$i32.delete(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this, i8 noundef %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$u8$i32.probe(%struct.Map$u8$i32* %this, i8 %key)
  store i64 %0, i64* %found.addr, align 8
...
if.end:
  %3 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  %4 = load %struct.nish_array*, %struct.nish_array** %3, align 8, !tbaa !22
  %5 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
  ...
  %8 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  %9 = load i32, i32* %8, align 4, !tbaa !20
  %10 = sub nsw i32 %9, 1
  %11 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  store i32 %10, i32* %11, align 4, !tbaa !20
  %12 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  %13 = load i32, i32* %12, align 4, !tbaa !5
  %14 = sub nsw i32 %13, 1
  %15 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  store i32 %14, i32* %15, align 4, !tbaa !5
  ret i1 true
}

define internal void @nish.Map$u8$i32.setValueAt(%struct.Map$u8$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index, i32 noundef %value) #2 {
entry:
  %0 = icmp sge i32 %index, 0
  br i1 %0, label %land.rhs, label %land.end

land.rhs:
  %1 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
...
if.then:
  %8 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
...
define internal void @nish.Map$u8$i32.insertAt(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this, i64 noundef %absent, i8 noundef %key, i32 noundef %value) #0 {
entry:
  ...
  %7 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
...
if.then:
  %13 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  %14 = load i32, i32* %13, align 4, !tbaa !20
  %15 = icmp sge i32 %14, 16777215
  br i1 %15, label %lor.end, label %lor.rhs

lor.rhs:
  %16 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 7
...
if.end.1:
  call void @nish.Map$u8$i32.rebuild(%struct.Map$u8$i32* %this)
  %20 = sub nsw i32 0, 1
  store i32 %20, i32* %bucket.addr, align 4
  br label %if.end

if.end:
  %21 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
...
push.grow:
  call void @nish_array_grow(%struct.nish_array* %22, i64 1)
  br label %push.store
...
push.store:
  ...
  store i8 %key, i8* %31, align 1, !alias.scope !10, !noalias !9, !tbaa !27
  %32 = add i64 %24, 1
  store i64 %32, i64* %23, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %33 = trunc i64 %32 to i32
  %34 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
...
push.store.1:
  ...
  %47 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
...
push.store.2:
  ...
  %61 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  %62 = load i32, i32* %61, align 4, !tbaa !20
  %63 = add nsw i32 %62, 1
  %64 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  store i32 %63, i32* %64, align 4, !tbaa !20
  %65 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  %66 = load i32, i32* %65, align 4, !tbaa !5
  %67 = add nsw i32 %66, 1
  %68 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  store i32 %67, i32* %68, align 4, !tbaa !5
  %69 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
  ...
  %75 = mul nsw i32 %74, 4
  %76 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
...
if.else:
  %83 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  %84 = load %struct.nish_array*, %struct.nish_array** %83, align 8, !tbaa !22
  %85 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 2
...
define internal void @nish.Map$u8$i32.rebuild(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  %walking.addr = alloca i1, align 1
  %slots.addr = alloca %struct.nish_array*, align 8
  %0 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !23
  %2 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %1, i64 0, i32 0
  %3 = load i64, i64* %2, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %4 = trunc i64 %3 to i32
  store i32 %4, i32* %used.addr, align 4
  %5 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 7
  %6 = load i32, i32* %5, align 4, !tbaa !21
  %7 = icmp sgt i32 %6, 0
  store i1 %7, i1* %walking.addr, align 1
  %8 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
...
cond.false:
  %12 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
...
land.rhs:
  %19 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
...
if.then:
  %24 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
  %25 = load %struct.nish_array*, %struct.nish_array** %24, align 8, !tbaa !23
  %26 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
  %27 = load %struct.nish_array*, %struct.nish_array** %26, align 8, !tbaa !25
  call void @nish.compactEntries$u8(%struct.nish_array* %25, %struct.nish_array* %27)
  %28 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
  ...
  %32 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
...
if.end:
  ...
  %35 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  ...
  %40 = sub nsw i32 %39, 1
  %41 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 2
  store i32 %40, i32* %41, align 4, !tbaa !19
  %42 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %43 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
...
land.rhs.1:
  ...
  %70 = bitcast i8* %26 to i8*
  %71 = getelementptr inbounds i8, i8* %70, i64 %69
  %72 = load i8, i8* %71, align 1, !alias.scope !10, !noalias !9, !tbaa !27
  %73 = icmp eq i8 %72, %key
  br label %land.end.1
...
define internal void @nish.compactEntries$u8(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %items, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %hashes) #0 {
entry:
  %used.addr = alloca i32, align 4
  %to.addr = alloca i32, align 4
  %from.addr = alloca i32, align 4
...
if.then:
  ...
  %41 = load i8, i8* %40, align 1, !alias.scope !10, !noalias !9, !tbaa !27
  %42 = bitcast i8* %10 to i8*
  %43 = getelementptr inbounds i8, i8* %42, i64 %36
  store i8 %41, i8* %43, align 1, !alias.scope !10, !noalias !9, !tbaa !27
...
pop.ok:
  ...
  %61 = load i8, i8* %60, align 1, !alias.scope !10, !noalias !9, !tbaa !27
  br label %while.cond
...
!2 = !{!"i32", !1, i64 0}
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"Map$u8$i32", !2, i64 0, !3, i64 8, !2, i64 16, !2, i64 20, !3, i64 24, !3, i64 32, !3, i64 40, !2, i64 48}
!5 = !{!4, !2, i64 0}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
!8 = !{!"elements", !6}
