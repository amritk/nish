%struct.Map$u8$i32 = type { i32, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array* }
...
define internal void @nish.Map$u8$i32.constructor(%struct.Map$u8$i32* noundef nonnull noalias align 8 dereferenceable(48) nocapture %this) #2 {
entry:
  ...
  %11 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  ...
  %17 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
  ...
  %23 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
  ...
  %29 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
  store %struct.nish_array* %25, %struct.nish_array** %29, align 8, !tbaa !24
  ret void
}

define internal noundef i64 @nish.Map$u8$i32.probe(%struct.Map$u8$i32* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i8 noundef %key) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$u8$i32.has(%struct.Map$u8$i32* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i8 noundef %key) #0 {
entry:
...
define internal noundef nonnull align 8 dereferenceable(48) %struct.Map$u8$i32* @nish.Map$u8$i32.set(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(48) %this, i8 noundef %key, i32 noundef %value) #0 {
entry:
...
define internal noundef zeroext i1 @nish.Map$u8$i32.delete(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this, i8 noundef %key) #0 {
entry:
  %found.addr = alloca i64, align 8
...
if.then.1:
  %18 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
...
if.then.2:
  %36 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
...
if.end.2:
  %44 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  %45 = load i32, i32* %44, align 4, !tbaa !20
  %46 = sub nsw i32 %45, 1
  %47 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  store i32 %46, i32* %47, align 4, !tbaa !20
  %48 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  %49 = load i32, i32* %48, align 4, !tbaa !5
  %50 = sub nsw i32 %49, 1
  %51 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  store i32 %50, i32* %51, align 4, !tbaa !5
  ret i1 true
}

define internal void @nish.Map$u8$i32.setValueAt(%struct.Map$u8$i32* noundef nonnull readonly align 8 dereferenceable(48) nocapture %this, i32 noundef %index, i32 noundef %value) #2 {
entry:
...
define internal void @nish.Map$u8$i32.insertAt(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this, i64 noundef %absent, i8 noundef %key, i32 noundef %value) #0 {
entry:
...
push.store:
  ...
  store i8 %key, i8* %27, align 1, !alias.scope !10, !noalias !9, !tbaa !26
  %28 = add i64 %20, 1
  store i64 %28, i64* %19, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %29 = trunc i64 %28 to i32
  %30 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
...
push.store.2:
  ...
  %57 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  %58 = load i32, i32* %57, align 4, !tbaa !20
  %59 = add nsw i32 %58, 1
  %60 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
  store i32 %59, i32* %60, align 4, !tbaa !20
  %61 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  %62 = load i32, i32* %61, align 4, !tbaa !5
  %63 = add nsw i32 %62, 1
  %64 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 0
  store i32 %63, i32* %64, align 4, !tbaa !5
  %65 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
...
land.rhs:
  ...
  %73 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
...
if.then.2:
  %80 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
...
if.else:
  %95 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  %96 = load %struct.nish_array*, %struct.nish_array** %95, align 8, !tbaa !21
  %97 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 2
...
if.end.2:
  ...
  %104 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
...
define internal void @nish.Map$u8$i32.rebuild(%struct.Map$u8$i32* noundef nonnull align 8 dereferenceable(48) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  ...
  %5 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  %6 = load %struct.nish_array*, %struct.nish_array** %5, align 8, !tbaa !21
  %7 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 3
...
if.then:
  %15 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 4
  %16 = load %struct.nish_array*, %struct.nish_array** %15, align 8, !tbaa !22
  %17 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
  %18 = load %struct.nish_array*, %struct.nish_array** %17, align 8, !tbaa !24
  call void @nish.compactEntries$u8(%struct.nish_array* %16, %struct.nish_array* %18)
  %19 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 5
  %20 = load %struct.nish_array*, %struct.nish_array** %19, align 8, !tbaa !23
  %21 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
  ...
  %23 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
...
if.end:
  ...
  %27 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  ...
  %32 = sub nsw i32 %31, 1
  %33 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 2
  store i32 %32, i32* %33, align 4, !tbaa !19
  %34 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %35 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 6
...
land.rhs.1:
  ...
  %72 = load i8, i8* %71, align 1, !alias.scope !10, !noalias !9, !tbaa !26
...
if.then:
  ...
  %41 = load i8, i8* %40, align 1, !alias.scope !10, !noalias !9, !tbaa !26
  %42 = bitcast i8* %10 to i8*
  %43 = getelementptr inbounds i8, i8* %42, i64 %36
  store i8 %41, i8* %43, align 1, !alias.scope !10, !noalias !9, !tbaa !26
...
pop.ok:
  ...
  %61 = load i8, i8* %60, align 1, !alias.scope !10, !noalias !9, !tbaa !26
  br label %while.cond
...
!2 = !{!"i32", !1, i64 0}
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"Map$u8$i32", !2, i64 0, !3, i64 8, !2, i64 16, !2, i64 20, !3, i64 24, !3, i64 32, !3, i64 40}
!5 = !{!4, !2, i64 0}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
!8 = !{!"elements", !6}
