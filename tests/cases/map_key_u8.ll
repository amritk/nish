...
push.store.2:
  ...
  %70 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 1
  %71 = load %struct.nish_array*, %struct.nish_array** %70, align 8, !tbaa !21
  %72 = getelementptr inbounds %struct.Map$u8$i32, %struct.Map$u8$i32* %this, i32 0, i32 2
