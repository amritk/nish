...
entry:
  ...
  %4 = zext i32 %3 to i64
  %5 = call i8* @amrit_str_from_u64(i64 %4)
  call void @amrit_print(i8* %5)
  %6 = load i8, i8* %b.addr, align 1
  %7 = zext i8 %6 to i64
  %8 = call i8* @amrit_str_from_u64(i64 %7)
  %9 = call i8* @amrit_str_concat(i8* %8, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %10 = load i16, i16* %h.addr, align 2
  %11 = zext i16 %10 to i64
  %12 = call i8* @amrit_str_from_u64(i64 %11)
  %13 = call i8* @amrit_str_concat(i8* %9, i8* %12)
  %14 = call i8* @amrit_str_concat(i8* %13, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %15 = load i32, i32* %w.addr, align 4
  %16 = zext i32 %15 to i64
  %17 = call i8* @amrit_str_from_u64(i64 %16)
  %18 = call i8* @amrit_str_concat(i8* %14, i8* %17)
  %19 = call i8* @amrit_str_concat(i8* %18, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %20 = load i64, i64* %q.addr, align 8
  %21 = call i8* @amrit_str_from_u64(i64 %20)
  %22 = call i8* @amrit_str_concat(i8* %19, i8* %21)
