...
declare void @sts_exit(i32 noundef) #3
declare noundef double @sts_parse_number(i8* noundef nonnull readonly align 8 nocapture, i32 noundef) #0
...
define noundef nonnull align 8 dereferenceable(16) %struct.sts_result.i32.str* @parsePort(i8* noundef nonnull noalias readonly align 8 nocapture %text) #0 {
entry:
  %n.addr = alloca i32, align 4
  %0 = call double @sts_parse_number(i8* %text, i32 2)
...
if.then:
  ...
  %5 = bitcast i8* %4 to %struct.sts_result.i32.str*
  %6 = getelementptr inbounds %struct.sts_result.i32.str, %struct.sts_result.i32.str* %5, i32 0, i32 0
  store i1 false, i1* %6, align 1
  %7 = getelementptr inbounds %struct.sts_result.i32.str, %struct.sts_result.i32.str* %5, i32 0, i32 2
  store i8* bitcast ({ i64, [11 x i8] }* @.str.0 to i8*), i8** %7, align 8
  ret %struct.sts_result.i32.str* %5
...
if.end:
  ...
  %12 = getelementptr inbounds %struct.sts_result.i32.str, %struct.sts_result.i32.str* %10, i32 0, i32 1
...
entry:
  ...
  %0 = call %struct.sts_result.i32.str* @parsePort(i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*))
...
res.ok:
  %3 = getelementptr inbounds %struct.sts_result.i32.str, %struct.sts_result.i32.str* %0, i32 0, i32 1
...
res.end:
  ...
  %8 = call %struct.sts_result.i32.str* @parsePort(i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*))
...
res.panic:
  call void @sts_write(i8* bitcast ({ i64, [15 x i8] }* @.str.3 to i8*), i32 2, i1 true)
  call void @sts_exit(i32 1)
  unreachable

res.ok.1:
  %11 = getelementptr inbounds %struct.sts_result.i32.str, %struct.sts_result.i32.str* %8, i32 0, i32 1
