...
define internal noundef nonnull align 8 dereferenceable(16) %struct.nish_result.i32.str* @parsePort(i8* noundef nonnull noalias readonly align 8 nocapture %text) #0 {
entry:
  %n.addr = alloca i32, align 4
  %0 = call double @nish_parse_number(i8* %text, i32 2)
...
entry:
  ...
  %0 = call %struct.nish_result.i32.str* @parsePort(i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*))
