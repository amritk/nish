%struct.Map$i32$i32 = type { double, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array*, i32 }
...
@.str.0 = private unnamed_addr constant { i64, [8 x i8] } { i64 7, [8 x i8] c"switch \00" }, align 8
@.str.1 = private unnamed_addr constant { i64, [7 x i8] } { i64 6, [7 x i8] c" flat \00" }, align 8
...
@.str.4 = private unnamed_addr constant { i64, [10 x i8] } { i64 9, [10 x i8] c"reassign \00" }, align 8
...
define internal noundef i32 @retInSwitch(%struct.Map$i32$i32* noundef nonnull align 8 dereferenceable(56) nocapture %m) #0 {
entry:
...
walk.body:
  %3 = call i32 @nish.Map$i32$i32.keyAt(%struct.Map$i32$i32* %m, i32 %1)
...
walk.inc:
  %7 = add i32 %1, 1
  %8 = call i32 @nish.Map$i32$i32.walkNext(%struct.Map$i32$i32* %m, i32 %7)
...
define internal noundef double @reassign(%struct.Map$f64$f64* noundef nonnull align 8 dereferenceable(56) %a, %struct.Map$f64$f64* noundef nonnull align 8 dereferenceable(56) %b) #0 {
entry:
  %m.addr = alloca %struct.Map$f64$f64*, align 8
  %n.addr = alloca double, align 8
  %k.addr = alloca double, align 8
  %walk.idx = alloca i32, align 4
  store %struct.Map$f64$f64* %a, %struct.Map$f64$f64** %m.addr, align 8
  store double 0x0000000000000000, double* %n.addr, align 8
  %0 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  call void @nish.Map$f64$f64.walkOpen(%struct.Map$f64$f64* %0)
  %1 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %0, i32 0)
  store i32 %1, i32* %walk.idx, align 4
  br label %walk.cond

walk.cond:
  %2 = load i32, i32* %walk.idx, align 4
  %3 = icmp sge i32 %2, 0
  br i1 %3, label %walk.body, label %walk.end

walk.body:
  %4 = call double @nish.Map$f64$f64.keyAt(%struct.Map$f64$f64* %0, i32 %2)
  store double %4, double* %k.addr, align 8
  %5 = load double, double* %n.addr, align 8
  %6 = load double, double* %k.addr, align 8
  %7 = fadd double %5, %6
  store double %7, double* %n.addr, align 8
  store %struct.Map$f64$f64* %b, %struct.Map$f64$f64** %m.addr, align 8
  br label %walk.inc

walk.inc:
  %8 = add i32 %2, 1
  %9 = call i32 @nish.Map$f64$f64.walkNext(%struct.Map$f64$f64* %0, i32 %8)
  store i32 %9, i32* %walk.idx, align 4
  br label %walk.cond

walk.end:
  call void @nish.Map$f64$f64.walkClose(%struct.Map$f64$f64* %0)
  %10 = load double, double* %n.addr, align 8
  %11 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %m.addr, align 8
  %12 = getelementptr inbounds %struct.Map$f64$f64, %struct.Map$f64$f64* %11, i32 0, i32 0
...
define internal noundef zeroext i1 @churnsFlatI32(%struct.Map$i32$i32* noundef nonnull align 8 dereferenceable(56) %m) #0 {
entry:
...
entry:
  %s.addr = alloca %struct.Map$i32$i32*, align 8
  %keys.addr = alloca %struct.nish_array*, align 8
  ...
  %i.addr = alloca double, align 8
  %a.addr = alloca %struct.Map$f64$f64*, align 8
  %b.addr = alloca %struct.Map$f64$f64*, align 8
  %n.addr = alloca double, align 8
  %i.addr.1 = alloca double, align 8
  ...
  store %struct.Map$i32$i32* %1, %struct.Map$i32$i32** %s.addr, align 8
  %2 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 0
  store i64 4, i64* %2, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %3 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 1
  store i64 4, i64* %3, align 8, !alias.scope !10, !noalias !11, !tbaa !16
  %4 = bitcast [4 x i32]* %arr.data to i8*
  ...
  store i32 1, i32* %7, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %8 = getelementptr inbounds i32, i32* %6, i64 1
  store i32 3, i32* %8, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %9 = getelementptr inbounds i32, i32* %6, i64 2
  store i32 2, i32* %9, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %10 = getelementptr inbounds i32, i32* %6, i64 3
  store i32 4, i32* %10, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  store %struct.nish_array* %arr.hdr, %struct.nish_array** %keys.addr, align 8
  %11 = load %struct.nish_array*, %struct.nish_array** %keys.addr, align 8
...
forof.body:
  ...
  %17 = load i8*, i8** %16, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %18 = bitcast i8* %17 to i32*
  %19 = getelementptr inbounds i32, i32* %18, i64 %12
  %20 = load i32, i32* %19, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  store i32 %20, i32* %k.addr, align 4
  %21 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %s.addr, align 8
  %22 = load i32, i32* %k.addr, align 4
  %23 = load i32, i32* %k.addr, align 4
  %24 = call %struct.Map$i32$i32* @nish.Map$i32$i32.set(%struct.Map$i32$i32* %21, i32 %22, i32 %23)
  br label %forof.inc
...
for.cond:
  %27 = load double, double* %i.addr, align 8
  %28 = fcmp olt double %27, 0x4072C00000000000
  br i1 %28, label %for.body, label %for.end

for.body:
  %29 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %s.addr, align 8
  %30 = call i32 @retInSwitch(%struct.Map$i32$i32* %29)
  store i32 %30, i32* %r.addr, align 4
  br label %for.inc

for.inc:
  %31 = load double, double* %i.addr, align 8
  %32 = fadd double %31, 0x3FF0000000000000
  store double %32, double* %i.addr, align 8
  br label %for.cond

for.end:
  %33 = call i8* @nish_alloc_struct(i64 56)
  %34 = bitcast i8* %33 to %struct.Map$f64$f64*
  call void @nish.Map$f64$f64.constructor(%struct.Map$f64$f64* %34)
  store %struct.Map$f64$f64* %34, %struct.Map$f64$f64** %a.addr, align 8
  %35 = call i8* @nish_alloc_struct(i64 56)
  %36 = bitcast i8* %35 to %struct.Map$f64$f64*
  call void @nish.Map$f64$f64.constructor(%struct.Map$f64$f64* %36)
  store %struct.Map$f64$f64* %36, %struct.Map$f64$f64** %b.addr, align 8
  %37 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %a.addr, align 8
  %38 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %37, double 0x3FF0000000000000, double 0x3FF0000000000000)
  %39 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %38, double 0x4000000000000000, double 0x4000000000000000)
  %40 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %39, double 0x4008000000000000, double 0x4008000000000000)
  %41 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %b.addr, align 8
  %42 = call %struct.Map$f64$f64* @nish.Map$f64$f64.set(%struct.Map$f64$f64* %41, double 0x4024000000000000, double 0x4024000000000000)
  store double 0x0000000000000000, double* %n.addr, align 8
  store double 0x0000000000000000, double* %i.addr.1, align 8
  br label %for.cond.1

for.cond.1:
  %43 = load double, double* %i.addr.1, align 8
  %44 = fcmp olt double %43, 0x4072C00000000000
  br i1 %44, label %for.body.1, label %for.end.1

for.body.1:
  %45 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %a.addr, align 8
  %46 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %b.addr, align 8
  %47 = call double @reassign(%struct.Map$f64$f64* %45, %struct.Map$f64$f64* %46)
  store double %47, double* %n.addr, align 8
  br label %for.inc.1

for.inc.1:
  %48 = load double, double* %i.addr.1, align 8
  %49 = fadd double %48, 0x3FF0000000000000
  store double %49, double* %i.addr.1, align 8
  br label %for.cond.1

for.end.1:
  %50 = load i32, i32* %r.addr, align 4
  %51 = call i8* @nish_str_from_i32(i32 %50)
  %52 = call i8* @nish_str_concat(i8* bitcast ({ i64, [8 x i8] }* @.str.0 to i8*), i8* %51)
  %53 = call i8* @nish_str_concat(i8* %52, i8* bitcast ({ i64, [7 x i8] }* @.str.1 to i8*))
  %54 = load %struct.Map$i32$i32*, %struct.Map$i32$i32** %s.addr, align 8
  %55 = call i1 @churnsFlatI32(%struct.Map$i32$i32* %54)
  %56 = select i1 %55, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %57 = call i8* @nish_str_concat(i8* %53, i8* %56)
  call void @nish_print(i8* %57)
  %58 = load double, double* %n.addr, align 8
  %59 = call i8* @nish_str_from_f64(double %58)
  %60 = call i8* @nish_str_concat(i8* bitcast ({ i64, [10 x i8] }* @.str.4 to i8*), i8* %59)
  %61 = call i8* @nish_str_concat(i8* %60, i8* bitcast ({ i64, [7 x i8] }* @.str.1 to i8*))
  %62 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %a.addr, align 8
  %63 = call i1 @churnsFlat(%struct.Map$f64$f64* %62)
  %64 = select i1 %63, i8* bitcast ({ i64, [5 x i8] }* @.str.2 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*)
  %65 = call i8* @nish_str_concat(i8* %61, i8* %64)
  %66 = call i8* @nish_str_concat(i8* %65, i8* bitcast ({ i64, [2 x i8] }* @.str.5 to i8*))
  %67 = load %struct.Map$f64$f64*, %struct.Map$f64$f64** %b.addr, align 8
  %68 = call i1 @churnsFlat(%struct.Map$f64$f64* %67)
...
entry:
  ...
  %5 = load i8*, i8** %4, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  br label %while.cond
...
while.body:
  ...
  %17 = load i32, i32* %16, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %18 = icmp eq i32 %17, 0
...
if.then:
  ...
  store i32 %21, i32* %23, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  ret void
...
for.body:
  ...
  %13 = load i32, i32* %12, align 4, !alias.scope !11, !noalias !10, !tbaa !19
...
if.then:
  ...
  store i32 %25, i32* %27, align 4, !alias.scope !11, !noalias !10, !tbaa !19
...
pop.ok:
  ...
  %43 = load i8*, i8** %42, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %44 = bitcast i8* %43 to i32*
  %45 = getelementptr inbounds i32, i32* %44, i64 %41
  %46 = load i32, i32* %45, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  br label %while.cond
...
if.end:
  ...
  store i64 %8, i64* %12, align 8, !alias.scope !10, !noalias !11, !tbaa !16
  %13 = mul i64 %8, 4
  ...
  store i8* %14, i8** %15, align 8, !alias.scope !10, !noalias !11, !tbaa !17
...
if.then:
  ...
  store i32 16777216, i32* %17, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  br label %if.end
...
if.then.1:
  ...
  store i32 0, i32* %32, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  br label %if.end.1
...
entry:
  ...
  %3 = load i8*, i8** %2, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  br label %for.cond
...
for.body:
  ...
  store i32 0, i32* %11, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  br label %for.inc
...
for.body:
  ...
  %15 = load i32, i32* %14, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %16 = icmp ne i32 %15, 0
...
if.then:
  ...
  %11 = load i8*, i8** %10, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %12 = bitcast i8* %11 to i32*
  %13 = getelementptr inbounds i32, i32* %12, i64 %7
  store i32 %9, i32* %13, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  br label %if.end
...
entry:
  ...
  store i64 %4, i64* %8, align 8, !alias.scope !10, !noalias !11, !tbaa !16
  %9 = mul i64 %4, 4
  ...
  store i8* %10, i8** %11, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %12 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 1
  ...
  store i64 0, i64* %16, align 8, !alias.scope !10, !noalias !11, !tbaa !16
  %17 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %14, i64 0, i32 2
  store i8* null, i8** %17, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %18 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 4
  ...
  store i64 0, i64* %22, align 8, !alias.scope !10, !noalias !11, !tbaa !16
  %23 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %20, i64 0, i32 2
  store i8* null, i8** %23, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %24 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 5
  ...
  store i64 0, i64* %28, align 8, !alias.scope !10, !noalias !11, !tbaa !16
  %29 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %26, i64 0, i32 2
  store i8* null, i8** %29, align 8, !alias.scope !10, !noalias !11, !tbaa !17
...
if.end:
  ...
  %12 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 0
  %13 = load double, double* %12, align 8, !tbaa !21
  %14 = fsub double %13, 0x3FF0000000000000
  %15 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 0
  store double %14, double* %15, align 8, !tbaa !21
  ret i1 true
}
...
define internal noundef i32 @nish.Map$i32$i32.keyAt(%struct.Map$i32$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index) #0 {
entry:
  %0 = icmp slt i32 %index, 0
  br i1 %0, label %lor.end, label %lor.rhs

lor.rhs:
  %1 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 4
...
if.then:
  ...
  store i32 %value, i32* %15, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  br label %if.end
...
if.then:
  %14 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 3
  %15 = load i32, i32* %14, align 4, !tbaa !23
  %16 = icmp sge i32 %15, 16777215
  br i1 %16, label %lor.end, label %lor.rhs

lor.rhs:
  %17 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 7
...
if.end:
  ...
  %27 = load i64, i64* %26, align 8, !alias.scope !10, !noalias !11, !tbaa !16
...
push.store:
  ...
  store i32 %key, i32* %32, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %33 = add i64 %25, 1
  store i64 %33, i64* %24, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %34 = sitofp i64 %33 to double
  %35 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 5
  ...
  %40 = load i64, i64* %39, align 8, !alias.scope !10, !noalias !11, !tbaa !16
...
push.store.1:
  ...
  store i32 %value, i32* %45, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %46 = add i64 %38, 1
  store i64 %46, i64* %37, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %47 = sitofp i64 %46 to double
  %48 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 6
  ...
  %54 = load i64, i64* %53, align 8, !alias.scope !10, !noalias !11, !tbaa !16
...
push.store.2:
  ...
  %57 = load i8*, i8** %56, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %58 = bitcast i8* %57 to i32*
  %59 = getelementptr inbounds i32, i32* %58, i64 %52
  store i32 %50, i32* %59, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %60 = add i64 %52, 1
  ...
  %64 = add nsw i32 %63, 1
  %65 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 3
  ...
  %69 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 0
  store double %68, double* %69, align 8, !tbaa !21
  %70 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 4
  ...
  %77 = mul nsw i32 %76, 4
  %78 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 1
...
if.else:
  %86 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 1
  %87 = load %struct.nish_array*, %struct.nish_array** %86, align 8, !tbaa !25
  %88 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 2
...
entry:
  ...
  %6 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 7
  %7 = load i32, i32* %6, align 4, !tbaa !24
  %8 = icmp sgt i32 %7, 0
  store i1 %8, i1* %walking.addr, align 1
  %9 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 1
...
land.rhs:
  %20 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 3
...
if.then:
  %25 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 4
  %26 = load %struct.nish_array*, %struct.nish_array** %25, align 8, !tbaa !26
  %27 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 6
  ...
  %29 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 5
  ...
  call void @nish.compactEntries$i32(%struct.nish_array* %30, %struct.nish_array* %32)
  %33 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 6
...
if.end:
  ...
  %36 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 1
  ...
  %42 = sub nsw i32 %41, 1
  %43 = getelementptr inbounds %struct.Map$i32$i32, %struct.Map$i32$i32* %this, i32 0, i32 2
...
entry:
  ...
  store %struct.nish_array* %6, %struct.nish_array** %12, align 8, !tbaa !32
  %13 = call i8* @nish_alloc_struct(i64 24)
  %14 = bitcast i8* %13 to %struct.nish_array*
  %15 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %14, i64 0, i32 0
  store i64 0, i64* %15, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  ...
  store %struct.nish_array* %14, %struct.nish_array** %18, align 8, !tbaa !33
  %19 = call i8* @nish_alloc_struct(i64 24)
  %20 = bitcast i8* %19 to %struct.nish_array*
  %21 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %20, i64 0, i32 0
  store i64 0, i64* %21, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  ...
  store %struct.nish_array* %20, %struct.nish_array** %24, align 8, !tbaa !34
  %25 = call i8* @nish_alloc_struct(i64 24)
  %26 = bitcast i8* %25 to %struct.nish_array*
  %27 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %26, i64 0, i32 0
  store i64 0, i64* %27, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  ...
  store %struct.nish_array* %26, %struct.nish_array** %30, align 8, !tbaa !35
  ret void
}
...
entry:
  ...
  %7 = load %struct.nish_array*, %struct.nish_array** %6, align 8, !tbaa !33
...
if.end:
  ...
  %4 = load %struct.nish_array*, %struct.nish_array** %3, align 8, !tbaa !32
  %5 = getelementptr inbounds %struct.Map$f64$f64, %struct.Map$f64$f64* %this, i32 0, i32 6
  %6 = load %struct.nish_array*, %struct.nish_array** %5, align 8, !tbaa !35
  %7 = load i64, i64* %found.addr, align 8
  call void @nish.killEntry(%struct.nish_array* %4, %struct.nish_array* %6, i64 %7)
...
entry:
  ...
  %1 = load i32, i32* %0, align 4, !tbaa !31
  %2 = add nsw i32 %1, 1
  %3 = getelementptr inbounds %struct.Map$f64$f64, %struct.Map$f64$f64* %this, i32 0, i32 7
  store i32 %2, i32* %3, align 4, !tbaa !31
  ret void
}
...
if.then:
  ...
  store double %value, double* %15, align 8, !alias.scope !11, !noalias !10, !tbaa !37
  br label %if.end
...
entry:
  ...
  %8 = load %struct.nish_array*, %struct.nish_array** %7, align 8, !tbaa !33
  %9 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %8, i64 0, i32 0
  %10 = load i64, i64* %9, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %11 = sitofp i64 %10 to double
  %12 = call i32 @llvm.fptosi.sat.i32.f64(double %11)
...
if.end:
  ...
  %23 = load %struct.nish_array*, %struct.nish_array** %22, align 8, !tbaa !33
  ...
  %28 = load i64, i64* %27, align 8, !alias.scope !10, !noalias !11, !tbaa !16
...
push.store:
  ...
  %31 = load i8*, i8** %30, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %32 = bitcast i8* %31 to double*
  %33 = getelementptr inbounds double, double* %32, i64 %26
  store double %24, double* %33, align 8, !alias.scope !11, !noalias !10, !tbaa !37
  %34 = add i64 %26, 1
  ...
  %37 = load %struct.nish_array*, %struct.nish_array** %36, align 8, !tbaa !34
  %38 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %37, i64 0, i32 0
  %39 = load i64, i64* %38, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %40 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %37, i64 0, i32 1
  %41 = load i64, i64* %40, align 8, !alias.scope !10, !noalias !11, !tbaa !16
...
push.store.1:
  ...
  %44 = load i8*, i8** %43, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %45 = bitcast i8* %44 to double*
  %46 = getelementptr inbounds double, double* %45, i64 %39
  store double %value, double* %46, align 8, !alias.scope !11, !noalias !10, !tbaa !37
  %47 = add i64 %39, 1
  ...
  %50 = load %struct.nish_array*, %struct.nish_array** %49, align 8, !tbaa !35
  ...
  %55 = load i64, i64* %54, align 8, !alias.scope !10, !noalias !11, !tbaa !16
...
push.store.2:
  ...
  store i32 %51, i32* %60, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %61 = add i64 %53, 1
  ...
  %64 = load i32, i32* %63, align 4, !tbaa !30
  %65 = add nsw i32 %64, 1
  ...
  %80 = load %struct.nish_array*, %struct.nish_array** %79, align 8, !tbaa !32
...
if.else:
  ...
  %88 = load %struct.nish_array*, %struct.nish_array** %87, align 8, !tbaa !32
...
entry:
  ...
  %10 = load %struct.nish_array*, %struct.nish_array** %9, align 8, !tbaa !32
  %11 = load i1, i1* %walking.addr, align 1
  br i1 %11, label %cond.true, label %cond.false
...
if.then:
  ...
  %26 = load %struct.nish_array*, %struct.nish_array** %25, align 8, !tbaa !33
  %27 = getelementptr inbounds %struct.Map$f64$f64, %struct.Map$f64$f64* %this, i32 0, i32 6
  %28 = load %struct.nish_array*, %struct.nish_array** %27, align 8, !tbaa !35
  ...
  %30 = load %struct.nish_array*, %struct.nish_array** %29, align 8, !tbaa !34
  %31 = getelementptr inbounds %struct.Map$f64$f64, %struct.Map$f64$f64* %this, i32 0, i32 6
  %32 = load %struct.nish_array*, %struct.nish_array** %31, align 8, !tbaa !35
...
if.end:
  ...
  store %struct.nish_array* %35, %struct.nish_array** %36, align 8, !tbaa !32
  %37 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %38 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %37, i64 0, i32 0
  %39 = load i64, i64* %38, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %40 = sitofp i64 %39 to double
  ...
  %46 = load %struct.nish_array*, %struct.nish_array** %45, align 8, !tbaa !35
  call void @nish.refile(%struct.nish_array* %44, %struct.nish_array* %46)
  ret void
}
...
entry:
  ...
  %15 = load i64, i64* %14, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  ...
  %19 = load i64, i64* %18, align 8, !alias.scope !10, !noalias !11, !tbaa !15
  %20 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %hashes, i64 0, i32 2
  %21 = load i8*, i8** %20, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  ...
  %25 = load i8*, i8** %24, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  br label %while.cond
...
while.body:
  ...
  %37 = load i32, i32* %36, align 4, !alias.scope !11, !noalias !10, !tbaa !19
...
land.rhs.1:
  ...
  %74 = load i32, i32* %73, align 4, !alias.scope !11, !noalias !10, !tbaa !19
...
entry:
  ...
  %7 = load i8*, i8** %6, align 8, !alias.scope !10, !noalias !11, !tbaa !17
...
for.body:
  ...
  %24 = load i32, i32* %23, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  %25 = icmp ne i32 %24, 0
...
if.then:
  ...
  store i32 %44, i32* %46, align 4, !alias.scope !11, !noalias !10, !tbaa !19
...
pop.ok:
  ...
  %62 = load i8*, i8** %61, align 8, !alias.scope !10, !noalias !11, !tbaa !17
  %63 = bitcast i8* %62 to i32*
  %64 = getelementptr inbounds i32, i32* %63, i64 %60
  %65 = load i32, i32* %64, align 4, !alias.scope !11, !noalias !10, !tbaa !19
  br label %while.cond
...
entry:
  ...
  %29 = load i8*, i8** %28, align 8, !alias.scope !10, !noalias !11, !tbaa !17
...
while.body:
  ...
  %45 = load i32, i32* %44, align 4, !alias.scope !11, !noalias !10, !tbaa !19
...
land.rhs.3:
  ...
  %69 = load i32, i32* %68, align 4, !alias.scope !11, !noalias !10, !tbaa !19
...
land.rhs.1:
  ...
  %82 = load double, double* %81, align 8, !alias.scope !11, !noalias !10, !tbaa !37
...
if.then:
  ...
  %44 = load double, double* %43, align 8, !alias.scope !11, !noalias !10, !tbaa !37
  %45 = bitcast i8* %11 to double*
  %46 = getelementptr inbounds double, double* %45, i64 %39
  store double %44, double* %46, align 8, !alias.scope !11, !noalias !10, !tbaa !37
  %47 = load i32, i32* %to.addr, align 4
  %48 = add nsw i32 %47, 1
  store i32 %48, i32* %to.addr, align 4
  br label %if.end
...
pop.ok:
  ...
  %65 = load double, double* %64, align 8, !alias.scope !11, !noalias !10, !tbaa !37
  br label %while.cond
...
!19 = !{!18, !18, i64 0}
!20 = !{!"Map$i32$i32", !2, i64 0, !3, i64 8, !4, i64 16, !4, i64 20, !3, i64 24, !3, i64 32, !3, i64 40, !4, i64 48}
!21 = !{!20, !2, i64 0}
!22 = !{!20, !4, i64 16}
!23 = !{!20, !4, i64 20}
!24 = !{!20, !4, i64 48}
