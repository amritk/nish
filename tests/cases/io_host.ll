...
entry:
  ...
  %0 = call zeroext i1 @nish_str_eq(i8* %arch, i8* bitcast ({ i64, [4 x i8] }* @.str.1 to i8*))
...
if.else:
  %1 = call zeroext i1 @nish_str_eq(i8* %arch, i8* bitcast ({ i64, [6 x i8] }* @.str.3 to i8*))
...
if.end.2:
  %7 = call zeroext i1 @nish_str_eq(i8* %platform, i8* bitcast ({ i64, [6 x i8] }* @.str.5 to i8*))
  br i1 %7, label %if.then.3, label %if.end.3

if.then.3:
  %8 = load i8*, i8** %cpu.addr, align 8
  %9 = call i8* @nish_str_concat(i8* %8, i8* bitcast ({ i64, [19 x i8] }* @.str.6 to i8*))
  ret i8* %9

if.end.3:
  %10 = call zeroext i1 @nish_str_eq(i8* %platform, i8* bitcast ({ i64, [7 x i8] }* @.str.7 to i8*))
  br i1 %10, label %if.then.4, label %if.end.4

if.then.4:
  %11 = load i8*, i8** %cpu.addr, align 8
  %12 = call i8* @nish_str_concat(i8* %11, i8* bitcast ({ i64, [14 x i8] }* @.str.8 to i8*))
  ret i8* %12
...
land.rhs:
  ...
  %8 = call i8* @nish_platform()
  %9 = call zeroext i1 @nish_str_eq(i8* %7, i8* %8)
  br label %land.end

land.end:
  %10 = phi i1 [ false, %entry ], [ %9, %land.rhs ]
  %11 = select i1 %10, i8* bitcast ({ i64, [5 x i8] }* @.str.10 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.11 to i8*)
  %12 = call i8* @nish_str_concat(i8* bitcast ({ i64, [11 x i8] }* @.str.9 to i8*), i8* %11)
...
land.rhs.1:
  ...
  %19 = call i8* @nish_arch()
  %20 = call zeroext i1 @nish_str_eq(i8* %18, i8* %19)
  br label %land.end.1
...
land.end.1:
  ...
  %23 = call i8* @nish_str_concat(i8* bitcast ({ i64, [7 x i8] }* @.str.12 to i8*), i8* %22)
  ...
  %34 = call i8* @nish_str_concat(i8* bitcast ({ i64, [9 x i8] }* @.str.13 to i8*), i8* %33)
