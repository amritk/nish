...
entry:
  %slots.addr = alloca %struct.sts_array*, align 8
  ...
  store %struct.sts_array* %arr.hdr, %struct.sts_array** %slots.addr, align 8
  %5 = call i8* @sts_alloc_struct(i64 4)
  ...
  %10 = load %struct.sts_array*, %struct.sts_array** %slots.addr, align 8
  %11 = load %struct.Node*, %struct.Node** %first.addr, align 8
  %12 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %10, i64 0, i32 0
...
bounds.ok:
  %15 = getelementptr inbounds %struct.sts_array, %struct.sts_array* %10, i64 0, i32 2
  ...
  %19 = load %struct.sts_array*, %struct.sts_array** %slots.addr, align 8
...
bounds.fail.1:
  call void @sts_panic_index(i64 0, i64 %21)
  unreachable
