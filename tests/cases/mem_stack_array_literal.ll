...
entry:
  ...
  store i32 7, i32* %7, align 4, !alias.scope !4, !noalias !3
  store %struct.amrit_array* %arr.hdr, %struct.amrit_array** %ws.addr, align 8
  store i32 0, i32* %total.addr, align 4
  %8 = load %struct.amrit_array*, %struct.amrit_array** %ws.addr, align 8
  store i64 0, i64* %forof.idx, align 8
  br label %forof.cond

forof.cond:
  %9 = load i64, i64* %forof.idx, align 8
  %10 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %8, i64 0, i32 0
...
forof.end:
  ...
  %24 = load %struct.amrit_array*, %struct.amrit_array** %ws.addr, align 8
...
entry:
  ...
  store %struct.amrit_array* %arr.hdr, %struct.amrit_array** %zs.addr, align 8
  %5 = load %struct.amrit_array*, %struct.amrit_array** %zs.addr, align 8
...
bounds.fail:
  call void @amrit_panic_index(i64 2, i64 %7)
  unreachable

bounds.ok:
  %9 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %5, i64 0, i32 2
  %10 = load i8*, i8** %9, align 8, !alias.scope !3, !noalias !4
  %11 = bitcast i8* %10 to i32*
  %12 = getelementptr inbounds i32, i32* %11, i64 2
  store i32 9, i32* %12, align 4, !alias.scope !4, !noalias !3
  %13 = load %struct.amrit_array*, %struct.amrit_array** %zs.addr, align 8
  %14 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %13, i64 0, i32 0
  %15 = load i64, i64* %14, align 8, !alias.scope !3, !noalias !4
  %16 = icmp ult i64 0, %15
  br i1 %16, label %bounds.ok.1, label %bounds.fail.1

bounds.fail.1:
  call void @amrit_panic_index(i64 0, i64 %15)
  unreachable

bounds.ok.1:
  %17 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %13, i64 0, i32 2
  %18 = load i8*, i8** %17, align 8, !alias.scope !3, !noalias !4
  %19 = bitcast i8* %18 to i32*
  %20 = getelementptr inbounds i32, i32* %19, i64 0
  %21 = load i32, i32* %20, align 4, !alias.scope !4, !noalias !3
  %22 = load %struct.amrit_array*, %struct.amrit_array** %zs.addr, align 8
...
bounds.fail.2:
  call void @amrit_panic_index(i64 2, i64 %24)
  unreachable
...
entry:
  ...
  %10 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %7, i64 0, i32 1
  %11 = load i64, i64* %10, align 8, !alias.scope !3, !noalias !4
  %12 = icmp eq i64 %9, %11
...
push.store:
  %13 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %7, i64 0, i32 2
  %14 = load i8*, i8** %13, align 8, !alias.scope !3, !noalias !4
  %15 = bitcast i8* %14 to i32*
  %16 = getelementptr inbounds i32, i32* %15, i64 %9
  ...
  %22 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %19, i64 0, i32 1
  %23 = load i64, i64* %22, align 8, !alias.scope !3, !noalias !4
  %24 = icmp eq i64 %21, %23
  br i1 %24, label %push.grow.1, label %push.store.1

push.grow.1:
  call void @amrit_array_grow(%struct.amrit_array* %19, i64 4)
  br label %push.store.1

push.store.1:
  %25 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %19, i64 0, i32 2
  ...
  %31 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
  ...
  %34 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %31, i64 0, i32 1
  %35 = load i64, i64* %34, align 8, !alias.scope !3, !noalias !4
  %36 = icmp eq i64 %33, %35
  br i1 %36, label %push.grow.2, label %push.store.2

push.grow.2:
  call void @amrit_array_grow(%struct.amrit_array* %31, i64 4)
  br label %push.store.2

push.store.2:
  %37 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %31, i64 0, i32 2
  %38 = load i8*, i8** %37, align 8, !alias.scope !3, !noalias !4
  %39 = bitcast i8* %38 to i32*
  %40 = getelementptr inbounds i32, i32* %39, i64 %33
  store i32 5, i32* %40, align 4, !alias.scope !4, !noalias !3
  %41 = add i64 %33, 1
  store i64 %41, i64* %32, align 8, !alias.scope !3, !noalias !4
  %42 = trunc i64 %41 to i32
  %43 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
...
bounds.fail:
  call void @amrit_panic_index(i64 4, i64 %45)
  unreachable
...
bounds.ok:
  ...
  %52 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
...
entry:
  ...
  %6 = call %struct.amrit_array* @escaped()
...
bounds.fail:
  call void @amrit_panic_index(i64 1, i64 %8)
  unreachable

bounds.ok:
  %10 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %6, i64 0, i32 2
  %11 = load i8*, i8** %10, align 8, !alias.scope !3, !noalias !4
  %12 = bitcast i8* %11 to i32*
  %13 = getelementptr inbounds i32, i32* %12, i64 1
  %14 = load i32, i32* %13, align 4, !alias.scope !4, !noalias !3
