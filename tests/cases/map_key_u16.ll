%struct.Map$u16$i32 = type { i32, %struct.nish_array*, i32, i32, %struct.nish_array*, %struct.nish_array*, %struct.nish_array*, i32 }
...
entry:
  %k0.addr = alloca i16, align 2
  %k1.addr = alloca i16, align 2
  %k2.addr = alloca i16, align 2
  %k3.addr = alloca i16, align 2
  %k4.addr = alloca i16, align 2
  %m.addr = alloca %struct.Map$u16$i32*, align 8
  %found.addr = alloca i32, align 4
  %gone.addr = alloca i1, align 1
  %again.addr = alloca i1, align 1
  %arena.mark = call i64 @nish_arena_mark()
  store i16 0, i16* %k0.addr, align 2
  store i16 1, i16* %k1.addr, align 2
  store i16 32768, i16* %k2.addr, align 2
  store i16 65535, i16* %k3.addr, align 2
  store i16 256, i16* %k4.addr, align 2
  %0 = call i8* @nish_alloc_struct(i64 56)
  %1 = bitcast i8* %0 to %struct.Map$u16$i32*
  call void @nish.Map$u16$i32.constructor(%struct.Map$u16$i32* %1)
  store %struct.Map$u16$i32* %1, %struct.Map$u16$i32** %m.addr, align 8
  %2 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %3 = load i16, i16* %k0.addr, align 2
  %4 = call %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* %2, i16 %3, i32 1)
  %5 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %6 = load i16, i16* %k1.addr, align 2
  %7 = call %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* %5, i16 %6, i32 2)
  %8 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %9 = load i16, i16* %k2.addr, align 2
  %10 = call %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* %8, i16 %9, i32 3)
  %11 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %12 = load i16, i16* %k3.addr, align 2
  %13 = call %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* %11, i16 %12, i32 4)
  %14 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %15 = load i16, i16* %k4.addr, align 2
  %16 = call %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* %14, i16 %15, i32 5)
  store i32 0, i32* %found.addr, align 4
  %17 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %18 = load i16, i16* %k0.addr, align 2
  %19 = call i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* %17, i16 %18)
...
if.end:
  %22 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %23 = load i16, i16* %k1.addr, align 2
  %24 = call i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* %22, i16 %23)
...
if.end.1:
  %27 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %28 = load i16, i16* %k2.addr, align 2
  %29 = call i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* %27, i16 %28)
  br i1 %29, label %if.then.2, label %if.end.2

if.then.2:
  %30 = load i32, i32* %found.addr, align 4
  %31 = add nsw i32 %30, 1
  store i32 %31, i32* %found.addr, align 4
  br label %if.end.2

if.end.2:
  %32 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %33 = load i16, i16* %k3.addr, align 2
  %34 = call i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* %32, i16 %33)
  br i1 %34, label %if.then.3, label %if.end.3

if.then.3:
  %35 = load i32, i32* %found.addr, align 4
  %36 = add nsw i32 %35, 1
  store i32 %36, i32* %found.addr, align 4
  br label %if.end.3

if.end.3:
  %37 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %38 = load i16, i16* %k4.addr, align 2
  %39 = call i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* %37, i16 %38)
  br i1 %39, label %if.then.4, label %if.end.4

if.then.4:
  %40 = load i32, i32* %found.addr, align 4
  %41 = add nsw i32 %40, 1
  store i32 %41, i32* %found.addr, align 4
  br label %if.end.4

if.end.4:
  %42 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %43 = load i16, i16* %k0.addr, align 2
  %44 = call %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* %42, i16 %43, i32 10)
  %45 = load i16, i16* %k1.addr, align 2
  %46 = call %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* %44, i16 %45, i32 20)
  %47 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %48 = load i16, i16* %k2.addr, align 2
  %49 = call i1 @nish.Map$u16$i32.delete(%struct.Map$u16$i32* %47, i16 %48)
  store i1 %49, i1* %gone.addr, align 1
  %50 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %51 = load i16, i16* %k2.addr, align 2
  %52 = call i1 @nish.Map$u16$i32.delete(%struct.Map$u16$i32* %50, i16 %51)
  store i1 %52, i1* %again.addr, align 1
  ...
  %56 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %57 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %56, i32 0, i32 0
  ...
  %62 = load i1, i1* %gone.addr, align 1
  ...
  %65 = call i8* @nish_str_concat(i8* %64, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %66 = load i1, i1* %again.addr, align 1
  %67 = select i1 %66, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %68 = call i8* @nish_str_concat(i8* %65, i8* %67)
  %69 = call i8* @nish_str_concat(i8* %68, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %70 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %71 = load i16, i16* %k2.addr, align 2
  %72 = call i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* %70, i16 %71)
  %73 = select i1 %72, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %74 = call i8* @nish_str_concat(i8* %69, i8* %73)
  %75 = call i8* @nish_str_concat(i8* %74, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %76 = load %struct.Map$u16$i32*, %struct.Map$u16$i32** %m.addr, align 8
  %77 = load i16, i16* %k3.addr, align 2
  %78 = call i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* %76, i16 %77)
  %79 = select i1 %78, i8* bitcast ({ i64, [5 x i8] }* @.str.1 to i8*), i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*)
  %80 = call i8* @nish_str_concat(i8* %75, i8* %79)
...
define internal void @nish.Map$u16$i32.constructor(%struct.Map$u16$i32* noundef nonnull noalias align 8 dereferenceable(56) nocapture %this) #2 {
entry:
  %0 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 0
  store i32 0, i32* %0, align 4, !tbaa !5
  %1 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 2
  store i32 7, i32* %1, align 4, !tbaa !19
  %2 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
  store i32 0, i32* %2, align 4, !tbaa !20
  %3 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 7
  ...
  %12 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 1
  ...
  %18 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 4
  ...
  %24 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 5
  ...
  %30 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 6
  store %struct.nish_array* %26, %struct.nish_array** %30, align 8, !tbaa !25
  ret void
}

define internal noundef i64 @nish.Map$u16$i32.probe(%struct.Map$u16$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i16 noundef %key) #0 {
entry:
  %0 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 1
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !22
  %2 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !19
  %4 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 6
  %5 = load %struct.nish_array*, %struct.nish_array** %4, align 8, !tbaa !25
  %6 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 4
  %7 = load %struct.nish_array*, %struct.nish_array** %6, align 8, !tbaa !23
  %8 = call i64 @nish.probeTable$u16(%struct.nish_array* %1, i32 %3, %struct.nish_array* %5, %struct.nish_array* %7, i16 %key)
  ret i64 %8
}

define internal noundef zeroext i1 @nish.Map$u16$i32.has(%struct.Map$u16$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i16 noundef %key) #0 {
entry:
  %0 = call i64 @nish.Map$u16$i32.probe(%struct.Map$u16$i32* %this, i16 %key)
  %1 = icmp sge i64 %0, 0
  ret i1 %1
}

define internal noundef nonnull align 8 dereferenceable(56) %struct.Map$u16$i32* @nish.Map$u16$i32.set(%struct.Map$u16$i32* noundef nonnull align 8 dereferenceable(56) %this, i16 noundef %key, i32 noundef %value) #0 {
entry:
...
if.then:
  ...
  call void @nish.Map$u16$i32.setValueAt(%struct.Map$u16$i32* %this, i32 %4, i32 %value)
  br label %if.end

if.else:
  %5 = load i64, i64* %found.addr, align 8
  call void @nish.Map$u16$i32.insertAt(%struct.Map$u16$i32* %this, i64 %5, i16 %key, i32 %value)
  br label %if.end

if.end:
  ret %struct.Map$u16$i32* %this
}

define internal noundef zeroext i1 @nish.Map$u16$i32.delete(%struct.Map$u16$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this, i16 noundef %key) #0 {
entry:
  %found.addr = alloca i64, align 8
  %0 = call i64 @nish.Map$u16$i32.probe(%struct.Map$u16$i32* %this, i16 %key)
  store i64 %0, i64* %found.addr, align 8
...
if.end:
  %3 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 1
  %4 = load %struct.nish_array*, %struct.nish_array** %3, align 8, !tbaa !22
  %5 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 6
  ...
  %8 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
  %9 = load i32, i32* %8, align 4, !tbaa !20
  %10 = sub nsw i32 %9, 1
  %11 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
  store i32 %10, i32* %11, align 4, !tbaa !20
  %12 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 0
  %13 = load i32, i32* %12, align 4, !tbaa !5
  %14 = sub nsw i32 %13, 1
  %15 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 0
  store i32 %14, i32* %15, align 4, !tbaa !5
  ret i1 true
}

define internal void @nish.Map$u16$i32.setValueAt(%struct.Map$u16$i32* noundef nonnull readonly align 8 dereferenceable(56) nocapture %this, i32 noundef %index, i32 noundef %value) #2 {
entry:
  %0 = icmp sge i32 %index, 0
  br i1 %0, label %land.rhs, label %land.end

land.rhs:
  %1 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 5
...
if.then:
  %8 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 5
...
define internal void @nish.Map$u16$i32.insertAt(%struct.Map$u16$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this, i64 noundef %absent, i16 noundef %key, i32 noundef %value) #0 {
entry:
  ...
  %7 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 4
...
if.then:
  %13 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
  %14 = load i32, i32* %13, align 4, !tbaa !20
  %15 = icmp sge i32 %14, 16777215
  br i1 %15, label %lor.end, label %lor.rhs

lor.rhs:
  %16 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 7
...
if.end.1:
  call void @nish.Map$u16$i32.rebuild(%struct.Map$u16$i32* %this)
  %20 = sub nsw i32 0, 1
  store i32 %20, i32* %bucket.addr, align 4
  br label %if.end

if.end:
  %21 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 4
...
push.grow:
  call void @nish_array_grow(%struct.nish_array* %22, i64 2)
  br label %push.store
...
push.store:
  ...
  %31 = getelementptr inbounds i16, i16* %30, i64 %24
  store i16 %key, i16* %31, align 2, !alias.scope !10, !noalias !9, !tbaa !27
  %32 = add i64 %24, 1
  store i64 %32, i64* %23, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %33 = trunc i64 %32 to i32
  %34 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 5
...
push.store.1:
  ...
  %47 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 6
...
push.store.2:
  ...
  %61 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
  %62 = load i32, i32* %61, align 4, !tbaa !20
  %63 = add nsw i32 %62, 1
  %64 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
  store i32 %63, i32* %64, align 4, !tbaa !20
  %65 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 0
  %66 = load i32, i32* %65, align 4, !tbaa !5
  %67 = add nsw i32 %66, 1
  %68 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 0
  store i32 %67, i32* %68, align 4, !tbaa !5
  %69 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 4
  ...
  %75 = mul nsw i32 %74, 4
  %76 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 1
...
if.else:
  %83 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 1
  %84 = load %struct.nish_array*, %struct.nish_array** %83, align 8, !tbaa !22
  %85 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 2
...
define internal void @nish.Map$u16$i32.rebuild(%struct.Map$u16$i32* noundef nonnull align 8 dereferenceable(56) nocapture %this) #0 {
entry:
  %used.addr = alloca i32, align 4
  %walking.addr = alloca i1, align 1
  %slots.addr = alloca %struct.nish_array*, align 8
  %0 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 4
  %1 = load %struct.nish_array*, %struct.nish_array** %0, align 8, !tbaa !23
  %2 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %1, i64 0, i32 0
  %3 = load i64, i64* %2, align 8, !alias.scope !9, !noalias !10, !tbaa !14
  %4 = trunc i64 %3 to i32
  store i32 %4, i32* %used.addr, align 4
  %5 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 7
  %6 = load i32, i32* %5, align 4, !tbaa !21
  %7 = icmp sgt i32 %6, 0
  store i1 %7, i1* %walking.addr, align 1
  %8 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 1
...
cond.false:
  %12 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
...
land.rhs:
  %19 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 3
...
if.then:
  %24 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 4
  %25 = load %struct.nish_array*, %struct.nish_array** %24, align 8, !tbaa !23
  %26 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 6
  %27 = load %struct.nish_array*, %struct.nish_array** %26, align 8, !tbaa !25
  call void @nish.compactEntries$u16(%struct.nish_array* %25, %struct.nish_array* %27)
  %28 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 5
  ...
  %32 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 6
...
if.end:
  ...
  %35 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 1
  ...
  %40 = sub nsw i32 %39, 1
  %41 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 2
  store i32 %40, i32* %41, align 4, !tbaa !19
  %42 = load %struct.nish_array*, %struct.nish_array** %slots.addr, align 8
  %43 = getelementptr inbounds %struct.Map$u16$i32, %struct.Map$u16$i32* %this, i32 0, i32 6
...
land.rhs.1:
  ...
  %70 = bitcast i8* %26 to i16*
  %71 = getelementptr inbounds i16, i16* %70, i64 %69
  %72 = load i16, i16* %71, align 2, !alias.scope !10, !noalias !9, !tbaa !27
  %73 = icmp eq i16 %72, %key
  br label %land.end.1
...
define internal void @nish.compactEntries$u16(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) nocapture %items, %struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %hashes) #0 {
entry:
  %used.addr = alloca i32, align 4
  %to.addr = alloca i32, align 4
  %from.addr = alloca i32, align 4
...
if.then:
  ...
  %39 = bitcast i8* %10 to i16*
  %40 = getelementptr inbounds i16, i16* %39, i64 %38
  %41 = load i16, i16* %40, align 2, !alias.scope !10, !noalias !9, !tbaa !27
  %42 = bitcast i8* %10 to i16*
  %43 = getelementptr inbounds i16, i16* %42, i64 %36
  store i16 %41, i16* %43, align 2, !alias.scope !10, !noalias !9, !tbaa !27
...
pop.ok:
  ...
  %61 = load i16, i16* %60, align 2, !alias.scope !10, !noalias !9, !tbaa !27
  br label %while.cond
...
!2 = !{!"i32", !1, i64 0}
!3 = !{!"ptr", !1, i64 0}
!4 = !{!"Map$u16$i32", !2, i64 0, !3, i64 8, !2, i64 16, !2, i64 20, !3, i64 24, !3, i64 32, !3, i64 40, !2, i64 48}
!5 = !{!4, !2, i64 0}
!6 = !{!"nish array"}
!7 = !{!"header", !6}
!8 = !{!"elements", !6}
