...
div.ok.1:
  ...
  %13 = call i8* @amrit_str_concat(i8* %6, i8* %12)
...
div.fail.2:
  call void @amrit_panic_div(i1 zeroext %15)
  unreachable
...
div.fail.3:
  call void @amrit_panic_div(i1 zeroext %18)
  unreachable
...
div.ok.3:
  ...
  %22 = call i8* @amrit_str_from_u64(i64 %21)
