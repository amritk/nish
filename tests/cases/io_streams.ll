...
declare noalias noundef align 8 i8* @amrit_read_file_or_null(i8* noundef nonnull readonly align 8 nocapture) #1
declare void @amrit_write_file(i8* noundef nonnull readonly align 8 nocapture, i8* noundef nonnull readonly align 8 nocapture) #1
...
entry:
  ...
  call void @amrit_write(i8* bitcast ({ i64, [3 x i8] }* @.str.0 to i8*), i32 1, i1 false)
  call void @amrit_write(i8* bitcast ({ i64, [9 x i8] }* @.str.1 to i8*), i32 1, i1 false)
  call void @amrit_write(i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), i32 1, i1 false)
  call void @amrit_write(i8* bitcast ({ i64, [11 x i8] }* @.str.3 to i8*), i32 2, i1 true)
  call void @amrit_write(i8* bitcast ({ i64, [9 x i8] }* @.str.4 to i8*), i32 2, i1 false)
  call void @amrit_write(i8* bitcast ({ i64, [6 x i8] }* @.str.5 to i8*), i32 2, i1 false)
  %0 = call i8* @amrit_read_file_or_null(i8* bitcast ({ i64, [33 x i8] }* @.str.6 to i8*))
  ...
  %4 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [10 x i8] }* @.str.7 to i8*), i8* %3)
  call void @amrit_print(i8* %4)
  call void @amrit_write_file(i8* bitcast ({ i64, [26 x i8] }* @.str.10 to i8*), i8* bitcast ({ i64, [9 x i8] }* @.str.11 to i8*))
  %5 = call i8* @amrit_read_file_or_null(i8* bitcast ({ i64, [26 x i8] }* @.str.10 to i8*))
...
if.then:
  call void @amrit_write(i8* bitcast ({ i64, [51 x i8] }* @.str.12 to i8*), i32 2, i1 true)
...
if.else:
  ...
  %13 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [7 x i8] }* @.str.13 to i8*), i8* %12)
  %14 = call i8* @amrit_str_concat(i8* %13, i8* bitcast ({ i64, [7 x i8] }* @.str.14 to i8*))
