...
forof.end:
  ...
  %15 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 0
...
bounds.fail:
  call void @amrit_panic_index(i64 0, i64 %20)
  unreachable
...
bounds.ok:
  ...
  %28 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 0
...
idx.test:
  %32 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 2
...
define internal noundef nonnull align 8 i8* @label(%struct.amrit_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %parts) #1 {
entry:
...
entry:
  ...
  %9 = call i32 @total(%struct.amrit_array* %8)
  ...
  store i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*), i8** %16, align 8, !alias.scope !4, !noalias !3
  %17 = getelementptr inbounds i8*, i8** %15, i64 1
  store i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*), i8** %17, align 8, !alias.scope !4, !noalias !3
  %18 = call i64 @amrit_arena_mark()
  %19 = call i8* @label(%struct.amrit_array* %arr.hdr.1)
  %20 = call i8* @amrit_arena_keep(i64 %18, i8* %19)
  call void @amrit_print(i8* %20)
  %21 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
  ...
  %24 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %21, i64 0, i32 1
  %25 = load i64, i64* %24, align 8, !alias.scope !3, !noalias !4
  %26 = icmp eq i64 %23, %25
  br i1 %26, label %push.grow, label %push.store

push.grow:
  call void @amrit_array_grow(%struct.amrit_array* %21, i64 4)
  br label %push.store

push.store:
  %27 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %21, i64 0, i32 2
  %28 = load i8*, i8** %27, align 8, !alias.scope !3, !noalias !4
  %29 = bitcast i8* %28 to i32*
  %30 = getelementptr inbounds i32, i32* %29, i64 %23
  store i32 40, i32* %30, align 4, !alias.scope !4, !noalias !3
  %31 = add i64 %23, 1
  store i64 %31, i64* %22, align 8, !alias.scope !3, !noalias !4
  %32 = trunc i64 %31 to i32
  %33 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
  %34 = call i32 @total(%struct.amrit_array* %33)
