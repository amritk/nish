...
entry:
  ...
  %4 = call i8* @sts_str_concat(i8* %3, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  ...
  %10 = call i8* @sts_str_concat(i8* %9, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
  ...
  %16 = call i8* @sts_str_concat(i8* %15, i8* bitcast ({ i64, [2 x i8] }* @.str.2 to i8*))
