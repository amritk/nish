...
while.body:
  ...
  %37 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 0
  %38 = load i64, i64* %37, align 8, !alias.scope !3, !noalias !4
  %39 = icmp ult i64 %36, %38
  br i1 %39, label %bounds.ok.2, label %bounds.fail.2

bounds.fail.2:
  call void @amrit_panic_index(i64 %36, i64 %38)
  unreachable

bounds.ok.2:
  %40 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 2
  ...
  %45 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 0
  %46 = load i64, i64* %45, align 8, !alias.scope !3, !noalias !4
  %47 = icmp ult i64 %34, %46
  br i1 %47, label %bounds.ok.3, label %bounds.fail.3

bounds.fail.3:
  call void @amrit_panic_index(i64 %34, i64 %46)
  unreachable

bounds.ok.3:
  %48 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 2
  %49 = load i8*, i8** %48, align 8, !alias.scope !3, !noalias !4
  %50 = bitcast i8* %49 to i32*
  %51 = getelementptr inbounds i32, i32* %50, i64 %34
  store i32 %44, i32* %51, align 4, !alias.scope !4, !noalias !3
...
bounds.fail.4:
  call void @amrit_panic_index(i64 %56, i64 %59)
  unreachable

bounds.ok.4:
  %61 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %xs, i64 0, i32 2
  %62 = load i8*, i8** %61, align 8, !alias.scope !3, !noalias !4
  %63 = bitcast i8* %62 to i32*
  %64 = getelementptr inbounds i32, i32* %63, i64 %56
  store i32 %57, i32* %64, align 4, !alias.scope !4, !noalias !3
  br label %for.inc
...
entry:
  ...
  %27 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
  call void @insertionSort(%struct.amrit_array* %27)
  store i8* bitcast ({ i64, [1 x i8] }* @.str.0 to i8*), i8** %line.addr, align 8
  %28 = load %struct.amrit_array*, %struct.amrit_array** %xs.addr, align 8
  store i64 0, i64* %forof.idx, align 8
  br label %forof.cond

forof.cond:
  %29 = load i64, i64* %forof.idx, align 8
  %30 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %28, i64 0, i32 0
  %31 = load i64, i64* %30, align 8, !alias.scope !3, !noalias !4
  %32 = icmp ult i64 %29, %31
  br i1 %32, label %forof.body, label %forof.end

forof.body:
  %33 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %28, i64 0, i32 2
  ...
  %41 = call i8* @amrit_str_concat(i8* %38, i8* %40)
  %42 = call i8* @amrit_str_concat(i8* %41, i8* bitcast ({ i64, [2 x i8] }* @.str.1 to i8*))
