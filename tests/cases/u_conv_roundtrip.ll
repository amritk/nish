...
entry:
  ...
  %5 = zext i32 %4 to i64
  %6 = call i8* @amrit_str_from_u64(i64 %5)
  ...
  %10 = call i8* @amrit_str_concat(i8* %7, i8* %9)
  %11 = call i8* @amrit_str_concat(i8* %10, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %12 = load i8, i8* %b.addr, align 1
  %13 = zext i8 %12 to i16
  %14 = zext i16 %13 to i64
  %15 = call i8* @amrit_str_from_u64(i64 %14)
  %16 = call i8* @amrit_str_concat(i8* %11, i8* %15)
  ...
  %24 = call i8* @amrit_str_from_u64(i64 %23)
  %25 = call i8* @amrit_str_concat(i8* %22, i8* %24)
  call void @amrit_print(i8* %25)
  %26 = load i32, i32* %w.addr, align 4
  %27 = trunc i32 %26 to i8
  %28 = zext i8 %27 to i64
  %29 = call i8* @amrit_str_from_u64(i64 %28)
  %30 = call i8* @amrit_str_concat(i8* %29, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %31 = load i32, i32* %w.addr, align 4
  %32 = trunc i32 %31 to i16
  %33 = zext i16 %32 to i64
  %34 = call i8* @amrit_str_from_u64(i64 %33)
  %35 = call i8* @amrit_str_concat(i8* %30, i8* %34)
  %36 = call i8* @amrit_str_concat(i8* %35, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %37 = load i32, i32* %neg.addr, align 4
  %38 = sext i32 %37 to i64
  %39 = call i8* @amrit_str_from_u64(i64 %38)
  ...
  %44 = call i8* @amrit_str_from_f64(double %43)
  %45 = call i8* @amrit_str_concat(i8* %44, i8* bitcast ({ i64, [2 x i8] }* @.str.0 to i8*))
  %46 = load double, double* %f.addr, align 8
  %47 = call i32 @llvm.fptoui.sat.i32.f64(double %46)
  %48 = zext i32 %47 to i64
  %49 = call i8* @amrit_str_from_u64(i64 %48)
  %50 = call i8* @amrit_str_concat(i8* %45, i8* %49)
