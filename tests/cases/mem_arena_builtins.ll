...
declare noalias noundef nonnull align 8 i8* @amrit_str_from_i64(i64 noundef) #0
...
push.grow:
  call void @amrit_array_grow(%struct.amrit_array* %7, i64 8)
  br label %push.store
...
push.store:
  ...
  store %struct.Blob* %9, %struct.Blob** %19, align 8, !alias.scope !4, !noalias !3
  %20 = add i64 %12, 1
...
entry:
  ...
  %xs.addr = alloca %struct.amrit_array*, align 8
  %ys.addr = alloca %struct.amrit_array*, align 8
  %0 = call i64 @amrit_arena_used()
  store i64 %0, i64* %base.addr, align 8
  %1 = call i64 @amrit_arena_mark()
  store i64 %1, i64* %m.addr, align 8
  %2 = call %struct.amrit_array* @fill(i32 1000)
...
bounds.fail:
  call void @amrit_panic_index(i64 999, i64 %5)
  unreachable
...
bounds.ok:
  ...
  %11 = load %struct.Blob*, %struct.Blob** %10, align 8, !alias.scope !4, !noalias !3
  ...
  call void @amrit_arena_release(i64 %19)
  %20 = call i64 @amrit_arena_used()
  ...
  %24 = call %struct.amrit_array* @fill(i32 10)
  store %struct.amrit_array* %24, %struct.amrit_array** %ys.addr, align 8
  %25 = load %struct.amrit_array*, %struct.amrit_array** %ys.addr, align 8
  ...
  %30 = call i64 @amrit_arena_used()
  %31 = call i8* @amrit_str_from_i64(i64 %30)
