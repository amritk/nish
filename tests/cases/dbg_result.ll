...
entry:
  ...
  %0 = extractvalue { i1, i32, i32 } %r, 0, !dbg !55
  %1 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 0, !dbg !55
  store i1 %0, i1* %1, align 1, !dbg !55
  %2 = extractvalue { i1, i32, i32 } %r, 1, !dbg !55
  %3 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 1, !dbg !55
  store i32 %2, i32* %3, align 4, !dbg !55
  %4 = extractvalue { i1, i32, i32 } %r, 2, !dbg !55
  %5 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 2, !dbg !55
  store i32 %4, i32* %5, align 4, !dbg !55
  %6 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 0, !dbg !58
...
if.end:
  %9 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 1, !dbg !63
...
entry:
  ...
  %0 = call { i1, i32, i32 } @half(i32 8), !dbg !69
  %1 = extractvalue { i1, i32, i32 } %0, 0, !dbg !69
  %2 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 0, !dbg !69
  store i1 %1, i1* %2, align 1, !dbg !69
  %3 = extractvalue { i1, i32, i32 } %0, 1, !dbg !69
  %4 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 1, !dbg !69
  store i32 %3, i32* %4, align 4, !dbg !69
  %5 = extractvalue { i1, i32, i32 } %0, 2, !dbg !69
  %6 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 2, !dbg !69
  store i32 %5, i32* %6, align 4, !dbg !69
  ...
  %7 = call %struct.nish_result.i32.str* @tag(i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*)), !dbg !79
  store %struct.nish_result.i32.str* %7, %struct.nish_result.i32.str** %named.addr, align 8, !dbg !78
  call void @llvm.dbg.declare(metadata %struct.nish_result.i32.str** %named.addr, metadata !81, metadata !DIExpression()), !dbg !78
  %8 = load %struct.nish_result.i32.i32*, %struct.nish_result.i32.i32** %r.addr, align 8, !dbg !83
  %9 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %8, i32 0, i32 0, !dbg !83
  %10 = load i1, i1* %9, align 1, !dbg !83
  %11 = xor i1 %10, true, !dbg !83
  br i1 %11, label %lor.end, label %lor.rhs, !dbg !83

lor.rhs:
  %12 = load %struct.nish_result.i32.str*, %struct.nish_result.i32.str** %named.addr, align 8, !dbg !84
  %13 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %12, i32 0, i32 0, !dbg !84
