...
div.fail.1:
  call void @nish_panic_div(i1 zeroext %14), !dbg !26
  unreachable, !dbg !26
...
if.then:
  %1 = call i8* @nish_alloc_struct(i64 16), !dbg !47
  %2 = bitcast i8* %1 to %struct.nish_result.i32.str*, !dbg !47
  %3 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %2, i32 0, i32 0, !dbg !47
  store i1 false, i1* %3, align 1, !dbg !47
  %4 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %2, i32 0, i32 2, !dbg !47
  store i8* bitcast ({ i64, [6 x i8] }* @.str.1 to i8*), i8** %4, align 8, !dbg !47
  ret %struct.nish_result.i32.str* %2, !dbg !46

if.end:
  %5 = bitcast i8* %path to i64*, !dbg !51
  %6 = load i64, i64* %5, align 8, !dbg !51
  %7 = trunc i64 %6 to i32, !dbg !51
  %8 = call i8* @nish_alloc_struct(i64 16), !dbg !50
  %9 = bitcast i8* %8 to %struct.nish_result.i32.str*, !dbg !50
  %10 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %9, i32 0, i32 0, !dbg !50
  store i1 true, i1* %10, align 1, !dbg !50
  %11 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %9, i32 0, i32 1, !dbg !50
...
entry:
  ...
  %7 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 0, !dbg !55
  store i1 %6, i1* %7, align 1, !dbg !55
  %8 = lshr i64 %5, 32, !dbg !55
  %9 = trunc i64 %8 to i32, !dbg !55
  %10 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 1, !dbg !55
  store i32 %9, i32* %10, align 4, !dbg !55
  %11 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 2, !dbg !55
  store i32 %9, i32* %11, align 4, !dbg !55
  %12 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 0, !dbg !58
...
if.end:
  %15 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 1, !dbg !63
...
entry:
  ...
  %nish_result.i32.i32.obj = alloca %struct.nish_result.i32.i32, align 8
  %named.addr = alloca %struct.nish_result.i32.str*, align 8
  %arena.mark = call i64 @nish_arena_mark(), !dbg !67
  ...
  %8 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 0, !dbg !69
  store i1 %7, i1* %8, align 1, !dbg !69
  %9 = lshr i64 %6, 32, !dbg !69
  %10 = trunc i64 %9 to i32, !dbg !69
  %11 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 1, !dbg !69
  store i32 %10, i32* %11, align 4, !dbg !69
  %12 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, i32 0, i32 2, !dbg !69
  store i32 %10, i32* %12, align 4, !dbg !69
  store %struct.nish_result.i32.i32* %nish_result.i32.i32.obj, %struct.nish_result.i32.i32** %r.addr, align 8, !dbg !68
  call void @llvm.dbg.declare(metadata %struct.nish_result.i32.i32** %r.addr, metadata !77, metadata !DIExpression()), !dbg !68
  %13 = call %struct.nish_result.i32.str* @tag(i8* bitcast ({ i64, [4 x i8] }* @.str.2 to i8*)), !dbg !79
  store %struct.nish_result.i32.str* %13, %struct.nish_result.i32.str** %named.addr, align 8, !dbg !78
  call void @llvm.dbg.declare(metadata %struct.nish_result.i32.str** %named.addr, metadata !81, metadata !DIExpression()), !dbg !78
  %14 = load %struct.nish_result.i32.i32*, %struct.nish_result.i32.i32** %r.addr, align 8, !dbg !83
  %15 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %14, i32 0, i32 0, !dbg !83
  %16 = load i1, i1* %15, align 1, !dbg !83
  %17 = xor i1 %16, true, !dbg !83
  br i1 %17, label %lor.end, label %lor.rhs, !dbg !83

lor.rhs:
  %18 = load %struct.nish_result.i32.str*, %struct.nish_result.i32.str** %named.addr, align 8, !dbg !84
  %19 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %18, i32 0, i32 0, !dbg !84
...
if.end:
  %24 = load %struct.nish_result.i32.i32*, %struct.nish_result.i32.i32** %r.addr, align 8, !dbg !91
  %25 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %24, i32 0, i32 0, !dbg !90
  %26 = load i1, i1* %25, align 1, !dbg !90
  %27 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %24, i32 0, i32 2, !dbg !90
  %28 = load i32, i32* %27, align 4, !dbg !90
  %29 = zext i32 %28 to i64, !dbg !90
  %30 = getelementptr inbounds %struct.nish_result.i32.i32, %struct.nish_result.i32.i32* %24, i32 0, i32 1, !dbg !90
  ...
  %43 = load %struct.nish_result.i32.str*, %struct.nish_result.i32.str** %named.addr, align 8, !dbg !92
  %44 = getelementptr inbounds %struct.nish_result.i32.str, %struct.nish_result.i32.str* %43, i32 0, i32 1, !dbg !92
...
!4 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "nish_result.i32.i32.word", file: !1, size: 64, align: 32, elements: !12)
!5 = distinct !DICompositeType(tag: DW_TAG_union_type, name: "nish_result.i32.i32.arms", file: !1, size: 32, elements: !9)
...
!28 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "nish_result.i32.str", file: !1, size: 128, align: 64, elements: !35)
...
!71 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "nish_result.i32.i32", file: !1, size: 96, align: 32, elements: !75)
