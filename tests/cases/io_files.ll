...
entry:
  ...
  call void @nish_write_file(i8* %0, i8* bitcast ({ i64, [7 x i8] }* @.str.1 to i8*))
  %1 = load i8*, i8** %path.addr, align 8
  call void @nish_append_file(i8* %1, i8* bitcast ({ i64, [7 x i8] }* @.str.2 to i8*))
  %2 = load i8*, i8** %path.addr, align 8
  %3 = call i8* @nish_read_file(i8* %2)
