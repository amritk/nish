...
@.str.1 = private unnamed_addr constant { i64, [4 x i8] } { i64 3, [4 x i8] c"two\00" }, align 8
@.str.2 = private unnamed_addr constant { i64, [6 x i8] } { i64 5, [6 x i8] c"three\00" }, align 8
@.str.3 = private unnamed_addr constant { i64, [5 x i8] } { i64 4, [5 x i8] c"four\00" }, align 8
...
entry:
  ...
  %3 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %2, i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*), double 0x3FF0000000000000)
  %4 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %3, i8* bitcast ({ i64, [4 x i8] }* @.str.1 to i8*), double 0x4000000000000000)
  %5 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %4, i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*), double 0x4008000000000000)
  %6 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %5, i8* bitcast ({ i64, [5 x i8] }* @.str.3 to i8*), double 0x4010000000000000)
  %7 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %8 = call i1 @nish.Map$str$f64.delete(%struct.Map$str$f64* %7, i8* bitcast ({ i64, [4 x i8] }* @.str.1 to i8*))
  %9 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %10 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %9, i8* bitcast ({ i64, [4 x i8] }* @.str.0 to i8*), double 0x4024000000000000)
  %11 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %12 = call i1 @nish.Map$str$f64.delete(%struct.Map$str$f64* %11, i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*))
  %13 = load %struct.Map$str$f64*, %struct.Map$str$f64** %m.addr, align 8
  %14 = call %struct.Map$str$f64* @nish.Map$str$f64.set(%struct.Map$str$f64* %13, i8* bitcast ({ i64, [6 x i8] }* @.str.2 to i8*), double 0x403E000000000000)
