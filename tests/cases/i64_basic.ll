...
entry:
  ...
  %3 = call i8* @amrit_str_from_i64(i64 %2)
  call void @amrit_print(i8* %3)
  %4 = load i64, i64* %big.addr, align 8
  %5 = call i8* @amrit_str_from_i64(i64 %4)
  %6 = call i8* @amrit_str_concat(i8* %5, i8* bitcast ({ i64, [8 x i8] }* @.str.0 to i8*))
  %7 = load i64, i64* %big.addr, align 8
  %8 = mul i64 %7, 2
  %9 = call i8* @amrit_str_from_i64(i64 %8)
...
div.fail:
  call void @amrit_panic_div(i1 zeroext %25)
  unreachable
