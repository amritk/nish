...
bounds.fail:
  call void @amrit_panic_index(i64 %1, i64 %3)
  unreachable
...
entry:
  %args.addr = alloca %struct.amrit_array*, align 8
  ...
  %0 = load %struct.amrit_array*, %struct.amrit_array** @amrit_argv, align 8
  store %struct.amrit_array* %0, %struct.amrit_array** %args.addr, align 8
  %1 = call i32 @count()
  %2 = call i8* @amrit_str_from_i32(i32 %1)
  %3 = call i8* @amrit_str_concat(i8* %2, i8* bitcast ({ i64, [13 x i8] }* @.str.0 to i8*))
...
for.body:
  ...
  %12 = call i8* @amrit_str_concat(i8* %11, i8* bitcast ({ i64, [3 x i8] }* @.str.1 to i8*))
  %13 = load i32, i32* %i.addr, align 4
  %14 = call i8* @argument(i32 %13)
  %15 = call i8* @amrit_str_concat(i8* %12, i8* %14)
  %16 = call i8* @amrit_str_concat(i8* %15, i8* bitcast ({ i64, [3 x i8] }* @.str.2 to i8*))
  %17 = load %struct.amrit_array*, %struct.amrit_array** %args.addr, align 8
...
bounds.fail:
  call void @amrit_panic_index(i64 %19, i64 %21)
  unreachable
...
bounds.ok:
  ...
  %32 = call i8* @amrit_str_concat(i8* %16, i8* %31)
  %33 = call i8* @amrit_str_concat(i8* %32, i8* bitcast ({ i64, [8 x i8] }* @.str.3 to i8*))
...
for.end:
  ...
  %36 = load %struct.amrit_array*, %struct.amrit_array** %args.addr, align 8
...
forof.end:
  ...
  %54 = call i8* @amrit_str_from_i32(i32 %53)
  %55 = call i8* @amrit_str_concat(i8* bitcast ({ i64, [26 x i8] }* @.str.4 to i8*), i8* %54)
...
entry:
  call void @amrit_argv_init(i32 %argc, i8** %argv)
