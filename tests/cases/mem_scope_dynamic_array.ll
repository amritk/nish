...
div.ok:
  ...
  %19 = load %struct.amrit_array*, %struct.amrit_array** %counts.addr, align 8
...
div.fail.1:
  call void @amrit_panic_div(i1 zeroext %21)
  unreachable
...
bounds.fail:
  call void @amrit_panic_index(i64 %27, i64 %29)
  unreachable
...
for.body.1:
  %41 = load %struct.amrit_array*, %struct.amrit_array** %counts.addr, align 8
...
bounds.fail.1:
  call void @amrit_panic_index(i64 %43, i64 %45)
  unreachable
...
bounds.fail.2:
  call void @amrit_panic_index(i64 %54, i64 %56)
  unreachable
