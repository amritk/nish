...
define internal noundef i32 @pick(%struct.amrit_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %xs, i32 noundef %i) #0 {
entry:
  %0 = sext i32 %i to i64
...
entry:
  ...
  %8 = call i32 @pick(%struct.amrit_array* %arr.hdr, i32 2)
  %9 = call i8* @amrit_str_from_i32(i32 %8)
  call void @amrit_print(i8* %9)
  %10 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 0
  store i64 3, i64* %10, align 8, !alias.scope !3, !noalias !4
  %11 = getelementptr inbounds %struct.amrit_array, %struct.amrit_array* %arr.hdr.1, i64 0, i32 1
  ...
  %18 = call i32 @pick(%struct.amrit_array* %arr.hdr.1, i32 5)
