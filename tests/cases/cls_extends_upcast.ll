...
define internal noundef i32 @sumIds(%struct.nish_array* noundef nonnull align 8 dereferenceable(24) readonly nocapture %items) #1 {
entry:
...
forof.body:
  %4 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %items, i64 0, i32 2
...
entry:
  ...
  %items.addr = alloca %struct.nish_array*, align 8
  ...
  %17 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %arr.hdr, i64 0, i32 1
  ...
  store %struct.nish_array* %arr.hdr, %struct.nish_array** %items.addr, align 8
  %23 = load %struct.nish_array*, %struct.nish_array** %items.addr, align 8
  %24 = call i8* @nish_alloc_struct(i64 8)
  ...
  %27 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %23, i64 0, i32 0
  %28 = load i64, i64* %27, align 8, !alias.scope !3, !noalias !4
  %29 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %23, i64 0, i32 1
...
push.store:
  %32 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %23, i64 0, i32 2
  ...
  %38 = load %struct.nish_array*, %struct.nish_array** %items.addr, align 8
  %39 = call i8* @nish_alloc_struct(i64 8)
  ...
  %42 = getelementptr inbounds %struct.nish_array, %struct.nish_array* %38, i64 0, i32 0
...
bounds.ok:
  ...
  %49 = load %struct.nish_array*, %struct.nish_array** %items.addr, align 8
  %50 = call i32 @sumIds(%struct.nish_array* %49)
